  ...
  try {
    ...
    window.popup = {
      create: function (options) {
        console.log(
          "[InitAPI] popup.create called",
          options ? JSON.stringify(options) : "no options",
        );
        return {
          show: function () {
            console.log("[InitAPI] popup.show called");
            return this;
          },
          hide: function () {
            console.log("[InitAPI] popup.hide called");
            return this;
          },
          update: function (content) {
            console.log("[InitAPI] popup.update called", content);
            return this;
          },
          on: function (event, callback) {
            console.log("[InitAPI] popup.on called:", event);
            return { off: function () {} };
          },
          trigger: function (event) {
            console.log("[InitAPI] popup.trigger called:", event);
            return this;
          },
        };
      },
      ...
      update: function (content) {
        console.log("[InitAPI] popup.update called");
        return this;
      },
      on: function (event, callback) {
        console.log("[InitAPI] popup.on called:", event);
      ...
      window.chrome.runtime = {
        ...
        onMessage: {
          addListener: function (callback) {
            console.log(
              "[InitAPI] chrome.runtime.onMessage.addListener called",
            );
          },
          removeListener: function (callback) {
            console.log(
              "[InitAPI] chrome.runtime.onMessage.removeListener called",
            );
          },
        },
      };
    ...
    setTimeout(function () {
      if (!window.popup || typeof window.popup.create !== "function") {
        console.warn(
          "[InitAPI] popup.create not available in delayed check, restoring",
        );
        if (!window.popup) window.popup = {};

        window.popup.create = function (options) {
          console.log(
            "[InitAPI] Delayed fallback popup.create called",
            options,
          );
          return {
            show: function () {
