...
(function () {
  ...
  function testExpandableElements() {
    ...
    console.log(
      `[ClickTest] Found ${expandableElements.length} expandable elements`,
    );
    ...
    expandableElements.forEach((element, index) => {
      ...
      element.addEventListener(
        ...
        true,
      ); // Use capture phase to get event before stopPropagation
      ...
      if (element) {
        ...
        setTimeout(() => {
          try {
            ...
            clickCount++;
            console.log(
              `[ClickTest] Simulated click ${clickCount}/${maxClicks}`,
            );
          } catch (error) {
  ...
  console.log(
    "[ClickTest] Diagnostics complete. Use window.ClickTest.diagnose() to re-run tests.",
  );
  console.log(
    "[ClickTest] Use window.ClickTest.simulate() to simulate clicks on expandable elements.",
  );
  console.log(
    "[ClickTest] Use window.ClickTest.suggestFixes() to get recommendations for issues.",
  );
  console.log(
    "[ClickTest] Use window.ClickTest.fixAll() to attempt automatic fixes for common issues.",
  );
})();
