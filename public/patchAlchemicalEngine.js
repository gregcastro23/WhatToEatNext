  ...
  try {
    ...
    window.getElementRanking = function (element_object, rank) {
      try {
        ...
        console.warn(
          "[PatchAlchemicalEngine] Error in getElementRanking:",
          error,
        );
    ...
    window.combineElementObjects =
      window.combineElementObjects ||
      function (element_object_1, element_object_2) {
        const combined_object = window.createElementObject();
        combined_object.Fire =
          (element_object_1?.Fire || 0) + (element_object_2?.Fire || 0);
        combined_object.Water =
          (element_object_1?.Water || 0) + (element_object_2?.Water || 0);
        combined_object.Air =
          (element_object_1?.Air || 0) + (element_object_2?.Air || 0);
        combined_object.Earth =
          (element_object_1?.Earth || 0) + (element_object_2?.Earth || 0);
