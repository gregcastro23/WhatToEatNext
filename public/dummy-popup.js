...
(function() {
  ...
  try {
    ...
    window.popup.create = window.popup.create || function(options) {
    ...
    window.popup.show = window.popup.show || function() { 
      console.log('[DummyPopup] window.popup.show() called');
      return this; 
    };
    
    window.popup.hide = window.popup.hide || function() { 
      console.log('[DummyPopup] window.popup.hide() called');
      return this; 
    };
    
    window.popup.update = window.popup.update || function(options) { 
      console.log('[DummyPopup] window.popup.update() called with:', options);
      return this; 
    };
    
    window.popup.on = window.popup.on || function(event, handler) { 
    ...
    window.popup.trigger = window.popup.trigger || function(event, data) { 
    ...
    window.harden = window.harden || function(obj) {
      return obj;
    };
