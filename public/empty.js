...
(function() {
  try {
    ...
    window.popup.show = window.popup.show || function() { return this; };
    window.popup.hide = window.popup.hide || function() { return this; };
    window.popup.update = window.popup.update || function() { return this; };
    window.popup.on = window.popup.on || function() { return { off: function() {} }; };
    window.popup.trigger = window.popup.trigger || function() { return this; };
