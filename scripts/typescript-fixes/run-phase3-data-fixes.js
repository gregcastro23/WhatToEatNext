...
console.log(`${colors.bright}${colors.cyan}= TypeScript Phase 3 Data Fixes Script =${colors.reset}`);
console.log(`${colors.bright}${colors.cyan}=======================================${colors.reset}`);
...
async function runAllFixes() {
  ...
  if (dryRun) {
    ...
    console.log(`\n${colors.green}All data model fixes were applied successfully!${colors.reset}`);
    console.log(`${colors.green}You can now proceed to the next phase of the TypeScript fix plan.${colors.reset}`);
  } else {
