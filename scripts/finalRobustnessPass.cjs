...
const FINAL_FIXES = [
  {
    ...
    profile: { rulingPlanets: ['Moon', 'Venus'], favorableZodiac: ['Cancer', 'Taurus', 'Pisces'], seasonalAffinity: ['summer'] }
  },
  {
    file: 'src/data/ingredients/proteins/eggs.ts',
    ingredient: 'quail_egg',
    profile: { rulingPlanets: ['Moon', 'Mercury'], favorableZodiac: ['Cancer', 'Gemini', 'Virgo'], seasonalAffinity: ['spring', 'summer'] }
  },
  {
    file: 'src/data/ingredients/vegetables/rootVegetables.ts',
    ingredient: 'beet',
    profile: { rulingPlanets: ['Saturn', 'Mars'], favorableZodiac: ['Capricorn', 'Aries', 'Scorpio'], seasonalAffinity: ['autumn', 'winter'] }
  },
  {
    file: 'src/data/ingredients/vegetables/rootVegetables.ts',
    ingredient: 'turnip',
    profile: { rulingPlanets: ['Saturn', 'Moon'], favorableZodiac: ['Capricorn', 'Cancer', 'Taurus'], seasonalAffinity: ['autumn', 'winter'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'balsamic_vinegar',
    profile: { rulingPlanets: ['Saturn', 'Venus'], favorableZodiac: ['Capricorn', 'Libra', 'Taurus'], seasonalAffinity: ['all'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'red_wine_vinegar',
    profile: { rulingPlanets: ['Mars', 'Saturn'], favorableZodiac: ['Aries', 'Scorpio', 'Capricorn'], seasonalAffinity: ['all'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'sherry_vinegar',
    profile: { rulingPlanets: ['Saturn', 'Jupiter'], favorableZodiac: ['Capricorn', 'Sagittarius'], seasonalAffinity: ['all'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'white_wine_vinegar',
    profile: { rulingPlanets: ['Mercury', 'Saturn'], favorableZodiac: ['Gemini', 'Virgo', 'Capricorn'], seasonalAffinity: ['all'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'champagne_vinegar',
    profile: { rulingPlanets: ['Venus', 'Mercury'], favorableZodiac: ['Libra', 'Gemini', 'Aquarius'], seasonalAffinity: ['all'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'malt_vinegar',
    profile: { rulingPlanets: ['Saturn', 'Mars'], favorableZodiac: ['Capricorn', 'Aries'], seasonalAffinity: ['all'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'coconut_vinegar',
    profile: { rulingPlanets: ['Moon', 'Jupiter'], favorableZodiac: ['Cancer', 'Sagittarius'], seasonalAffinity: ['all'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'cane_vinegar',
    profile: { rulingPlanets: ['Sun', 'Jupiter'], favorableZodiac: ['Leo', 'Sagittarius'], seasonalAffinity: ['all'] }
  },
  {
    file: 'src/data/ingredients/vinegars/vinegars.ts',
    ingredient: 'fruit_vinegar',
    profile: { rulingPlanets: ['Venus', 'Moon'], favorableZodiac: ['Taurus', 'Cancer', 'Libra'], seasonalAffinity: ['all'] }
  }
];
