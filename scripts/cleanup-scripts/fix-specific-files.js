...
export const elements = {
  'ariesAries': 'Fire',
  'leoLeo': 'Fire',
  'sagittariusSagittarius': 'Fire',
  'taurusTaurus': 'Earth',
  'virgoVirgo': 'Earth',
  'capricornCapricorn': 'Earth',
  'geminiGemini': 'Air',
  'libraLibra': 'Air',
  'aquariusAquarius': 'Air',
  'cancerCancer': 'Water',
  'scorpioScorpio': 'Water',
  'piscesPisces': 'Water'
};
...
export const planetaryRulers = {
  'ariesAries': 'Mars',
  'taurusTaurus': 'Venus',
  'geminiGemini': 'Mercury',
  'cancerCancer': 'Moon',
  'leoLeo': 'Sun',
  'virgoVirgo': 'Mercury',
  'libraLibra': 'Venus',
  'scorpioScorpio': 'Pluto',
  'sagittariusSagittarius': 'Jupiter',
  'capricornCapricorn': 'Saturn',
  'aquariusAquarius': 'Uranus',
  'piscesPisces': 'Neptune'
};
