...
exports.decidePreservation =
  exports.classifyFileKind =
  exports.isTestFile =
  exports.isServiceLayerFile =
  exports.isCoreCalculationFile =
  exports.isHighImpactFile =
    void 0;
...
const TEST_CONTEXT_FILE_REGEX =
  /\/(?:__tests__|tests?|__mocks__|mocks|__fixtures__|fixtures)\//i;
...
function isTestFile(filePath) {
  return (
    TEST_CONTEXT_FILE_REGEX.test(filePath) ||
    /\.(spec|test)\.[tj]sx?$/.test(filePath)
  );
}
