...
async function testExternalAPI() {
  ...
  try {
    ...
    if (celestialBodies) {
      ...
      console.log(
        `🌙  Moon: ${celestialBodies.Moonmoon?.Sign?.label} ${celestialBodies.Moonmoon?.ChartPosition?.Ecliptic?.ArcDegrees?.degrees}°`,
      );
      console.log(
        `☿   Mercury: ${celestialBodies.Mercurymercury?.Sign?.label} ${celestialBodies.Mercurymercury?.ChartPosition?.Ecliptic?.ArcDegrees?.degrees}°`,
      );
    }
...
async function testLocalAPI() {
  ...
  try {
    ...
    if (celestialBodies) {
      ...
      console.log(
        `♀   Venus: ${celestialBodies.Venusvenus?.Sign?.label} ${celestialBodies.Venusvenus?.ChartPosition?.Ecliptic?.ArcDegrees?.degrees}°`,
      );
      console.log(
        `♂   Mars: ${celestialBodies.Marsmars?.Sign?.label} ${celestialBodies.Marsmars?.ChartPosition?.Ecliptic?.ArcDegrees?.degrees}°`,
      );
    }
