      ...
      .mockResolvedValueOnce(
        response({
          ...
          yield: {
            ...
            breakdown: {
              spirit: { natalRatio: 0.25, transitRatio: 0.25, antiGlutFactor: 1, finalYield: 1 },
              essence: { natalRatio: 0.25, transitRatio: 0.25, antiGlutFactor: 1, finalYield: 1 },
              matter: { natalRatio: 0.25, transitRatio: 0.25, antiGlutFactor: 1, finalYield: 1 },
              substance: { natalRatio: 0.25, transitRatio: 0.25, antiGlutFactor: 1, finalYield: 1 },
            },
