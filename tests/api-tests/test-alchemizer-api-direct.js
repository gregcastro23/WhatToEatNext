    ...
    if (response.astrology_info) {
      ...
      if (response.astrology_info.horoscope_parameters) {
        ...
        if (response.astrology_info.horoscope_parameters.planets) {
          ...
          log(
            "✅ Successfully extracted planetary positions from API",
            "green",
          );
          ...
          log("\n📋 Next Steps:", "cyan");
          log(
            "1. Use the extracted-planetary-positions.json file in your app",
            "cyan",
          );
          log(
            "2. Import the alchemize function in your TypeScript environment",
            "cyan",
          );
