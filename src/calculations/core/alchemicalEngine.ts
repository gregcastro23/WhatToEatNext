...
export class AlchemicalEngine {
   ...
   */
  calculateElementalCompatibility(properties1: ElementalProperties,
    _properties2: ElementalProperties): number {
  ...
  combineElementObjects(elementObject1: ElementalProperties,
