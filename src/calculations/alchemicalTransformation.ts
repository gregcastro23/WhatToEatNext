import { ElementalCharacter, ZodiacSign, LunarPhaseWithSpaces } from '@/types/alchemy';
...
const applyElementalInfluences = (
  ...
  originalProperties: Record<ElementalCharacter, number>,
  planetaryBoost: number = 1.0): void => {
  try {
...
;
    ...
    transformedProperties.Fire += airInfluence * (((originalProperties as any)?.Fire || 0) * 0.2)
