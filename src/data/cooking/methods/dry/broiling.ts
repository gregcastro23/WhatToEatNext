...
export const broiling: CookingMethodData = {
  ...
  ingredientPreparation: {
    ...
    fruits:
      "Sprinkle with sugar for better caramelization. Cut to uniform sizes for even cooking.",
    bread:
      "Slightly dry bread works better than very fresh. Apply thin layer of fat to prevent burning.",
  },
  timingConsiderations: {
    "thin cuts":
      "About 3-5 minutes per side. Look for sizzling and browning before flipping.",
    "thick cuts":
      "5-8 minutes per side. Use thermometer to check doneness rather than time alone.",
    vegetables: "2-4 minutes per side, looking for slight char and tenderness.",
    "finishing dishes":
      "1-3 minutes total, watching constantly for desired browning level.",
    "delicate items":
      "As little as 1-2 minutes total. Position further from heat element.",
  },
  doneness_indicators: {
    "visual cues":
      "Surface browning, bubbling, caramelization, or slight charring on edges.",
    "textural signs":
      "Firm exterior with give when pressed. Visible juices for meats.",
  ...
  ingredientInteractions: {
    sugars:
      "Caramelize quickly and can burn easily add sweet glazes in final minutes only.",
    proteins:
      "Form a protective barrier when heated quickly, sealing moisture inside.",
    fats: "Render out and may cause flare-ups, trim excess fat or score fat cap on meats.",
    marinades:
      "High sugar content marinades can burn, wipe excess marinade before broiling.",
    herbs:
      "Fresh herbs may burn, use in compound butters or apply after cooking.",
    acids:
      "Can denature proteins before cooking, limit marinating time for acidic marinades.",
  },
  technicalNotes: {
    "equipment variations": {
      "gas broilers":
        "More consistent heat distribution but typically less intense than electric.",
      "electric broilers":
        "More intense heat, may have hot spots that require repositioning food.",
      "salamander broilers":
    ...
    "distance effects": {
      "close positioning":
        "Faster cooking, more external browning, less interior cooking.",
      "distant positioning":
        "Slower cooking, more even heating throughout the food.",
      "variable positioning":
        "Moving food closer or further during cooking allows for controlled browning.",
    },
    "surface treatments": {
      "oil application":
        "Thin layer conducts heat better and prevents sticking.",
      "dry rubs": "Apply before cooking, high sugar content rubs may burn.",
      "wet marinades":
        "Pat dry before broiling to prevent steaming instead of browning.",
