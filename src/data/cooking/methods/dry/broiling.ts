...
export const broiling: CookingMethodData = {
  ...
  suitable_for: ['steaks', 'chops', 'fish', 'chicken', 'shellfish', 'vegetables', 'flatbreads', 'casserole toppings', 'fruit desserts'],
  benefits: ['creates crisp exterior', 'seals in juices', 'quick cooking', 'browns food surface', 'develops flavor', 'minimal equipment needed', 'melts and browns toppings'],
  ...
  thermodynamicProperties: {
    ...
    entropy: 0.70,    // Significant surface transformation
    reactivity: 0.80, // High chemical reactivity on food surface
    gregsEnergy: 0.95 - (0.70 * 0.80)      // Calculated using heat - (entropy * reactivity)
  ...
  sustainabilityRating: 0.70, // Generally energy efficient due to short cooking times
  
  equipmentComplexity: 0.30, // Very simple, uses existing oven equipment
  ...
  ingredientPreparation: {
    'meats': 'Bring to room temperature for 30 minutes before broiling. Season generously. Pat dry for better browning.',
    ...
    'cheese dishes': 'Apply cheese in final minutes of cooking. Use cheeses with good melting properties.',
  ...
  doneness_indicators: {
    ...
    'temperature readings': 'For meats, follow standard temperature guidelines (e.g., 135°F for medium-rare steak).',
    'timing benchmarks': 'Thin items (≤1/2 inch): 2-4 minutes total; Medium items (1 inch): 8-10 minutes total; Thick items (>1 inch): 12-15 minutes total.'
  },
  ...
  technicalNotes: {
    'equipment variations': {
      ...
      'salamander broilers': 'Professional equipment allowing precise control and higher temperatures.',
