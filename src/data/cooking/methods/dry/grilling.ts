...
export const grilling: CookingMethodData = {
  ...
  benefits: ['imparts smoky flavor', 'creates appealing char marks', 'renders fat', 'quick cooking', 'caramelizes exterior', 'develops umami'],
  ...
  nutrientRetention: {
    ...
    vitamins: 0.70, 
    minerals: 0.90,
    fats: 0.60  // Some lost through dripping
  },
  optimalTemperatures: {
    'steak': 450,
    'chicken': 375,
  ...
  // Additional metadata
  history: 'Grilling is among humanity\'s oldest cooking methods, dating back to the discovery of fire around 1.8 million years ago. Every culture has developed variation of cooking over direct flame, from the South American asado to the Japanese yakitori, making it a universally significant culinary technique.',
  ...
  equipmentComplexity: 0.50, // Relatively simple but requires technique and attention
