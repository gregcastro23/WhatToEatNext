...
export const poaching: CookingMethodData = {
  ...
  alchemicalAspects: {
    ...
    pillarNumber: 5,
    alchemicalProcess:
      "Gentle transformation of substances through submersion in nurturing liquid",
    effects: {
  ...
  timingConsiderations: {
    ...
    chicken_breasts:
      "Start in cold liquid15-20 minutes at 170°F until 165°F internal",
    ...
    vegetables:
      "Asparagus: 3-5 minutes, Artichokes: 20-30 minutes, test with knife",
  },
  doneness_indicators: {
    ...
    delicate_vegetables:
      "Bright color, tender-crisp texture, slight resistance when bitten",
    custards:
      "Set around edges but slight jiggle in center, knife inserted comes out clean",
    meat: "Reaches target internal temperature but remains juicy and tender",
  },
  poaching_liquids: {
    court_bouillon:
      "Classic aromatic liquid with wine/vinegar, mirepoix, herbs, and spices",
    ...
    water:
      "Pure, clean medium that preserves natural flavor of delicate ingredients",
    fruit_juice:
      "Sweet medium for fruit poaching, often mixed with wine or water",
    tea: "Adds tannins and aromatics, excellent for fish and fruit",
    infused_water:
      "Simple water base enhanced with aromatics (herbs, citrus, spices)",
  ...
  presentation_techniques: {
    ...
    layered_composition:
      "Building vertical presentations with poached item as centerpiece",
    nage_service:
      "Serving poached item in small amount of its aromatic cooking liquid",
    aspic_presentation:
      "Traditional preparation using clarified, gelled poaching liquid",
    sauce_mirror: "Refined poaching liquid as base for plated presentation",
    fluid_gel_technique:
      "Modern application using poaching liquid as textural element",
    paired_temperatures:
      "Contrasting warm poached item with cool accompaniments",
    negative_space: "Contemporary plating with poached item as focal point",
    herb_garnish:
      "Fresh herbs that echo poaching aromatics for visual and flavor connection",
  },
