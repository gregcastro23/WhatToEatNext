...
export const stewing: CookingMethodData = {
  ...
  sustainabilityRating: 0.90, // Very high - efficient, utilizes tough cuts, one-pot cooking
  ...
  doneness_indicators: {
    'protein_texture': 'Properly stewed meat should retain its structure but separate easily with gentle pressure. Collagen-rich cuts develop spoon-tender quality. Poultry separates cleanly from bone. Fish and seafood maintain discrete flakes without becoming mushy. Meat fibers should separate easily but not disintegrate completely. Fork should penetrate with minimal resistance. In long-cooked stews, well-rendered fat integrates with liquid instead of pooling separately. Overcooked proteins appear dry despite liquid environment and may become stringy or mealy in texture.',
  ...
  technicalNotes: {
    'heat_management': {
      'temperature_stability': 'Stewing operates ideally between 160-190°F (71-88°C), below simmering point. Temperature fluctuations negatively impact texture development—stable heat source critical. Heavy-bottomed vessels provide thermal mass for stability. Heat diffusers useful on direct flame for maintaining low temperatures. Oven stewing (275-325°F/135-163°C) provides excellent temperature stability with even heat distribution. Gentle bubbling (1-2 bubbles per second breaking surface) indicates proper temperature. Digital thermometers can verify liquid temperature for precision.',
