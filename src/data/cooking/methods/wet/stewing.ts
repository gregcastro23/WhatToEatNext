...
export const stewing: CookingMethodData = {
  ...
  thermodynamicProperties: {
    ...
    gregsEnergy: 0.35 - 0.6 * 0.45, // Calculated gregsEnergy: heat - (entropy * reactivity)
  ...
  technicalNotes: {
    ...
    flavor_chemistry: {
      ...
      precursor_interactions:
        'Initial flavor compounds serve as precursors for secondary and tertiary reactions. Thiols, furans, pyrazines from browning interact with aromatics creating multi-layered flavor. Amino acid-sugar interactions continue at low rates even during slow cooking. Fat-soluble flavor compounds concentrate as moisture reduces. Volatile compound retention varies by molecular weight and polarity. Temperature control critical for optimal reaction pathways—too high creates bitter compounds, too low limits beneficial reactions.',
      taste_perception:
