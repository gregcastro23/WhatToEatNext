...
export const braising: CookingMethodData = {
  ...
  nutrientRetention: {
    ...
    vitamins: 0.60, // Some loss of water-soluble vitamins but retained in sauce
    proteins: 0.90, // Very good protein preservation
    fat_soluble_nutrients: 0.85, // Good retention in fat emulsion
    water_soluble_vitamins: 0.75, // Preserved in cooking liquid
    antioxidants: 0.80, // Many extracted and preserved in liquid
    amino_acids: 0.92, // Excellent preservation with enhanced bioavailability
    phenolics: 0.70  // Moderate retention of plant compounds
  },
  optimalTemperatures: {
  ...
  regionalVariations: {
    ...
    jewish: [
      ...
      'tzimmes (sweet stew with carrots)'
    ],
    american: [
      'pot roast',
      'yankee pot roast',
  ...
  thermodynamicProperties: {
    ...
    gregsEnergy: 0.55 - (0.75 * 0.60)  // Calculated gregsEnergy: heat - (entropy * reactivity)
