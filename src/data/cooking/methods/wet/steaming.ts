...
export const steaming: CookingMethodData = {
  ...
  suitable_for: ['vegetables', 'fish', 'shellfish', 'dumplings', 'rice', 'custards', 'puddings', 'breads', 'buns', 'cakes', 'eggs', 'poultry', 'meat', 'tofu', 'seitan', 'tempeh'],
  benefits: ['nutrient retention', 'preserves color', 'maintains moisture', 'gentle cooking', 'no added fat', 'prevents oxidation', 'preserves delicate textures', 'natural flavor enhancement', 'reduced risk of overcooking', 'consistent results'],
  ...
  nutrientRetention: {
    ...
    phytochemicals: 0.90 // Beneficial plant compounds mostly intact
  },
  optimalTemperatures: {
  ...
  regionalVariations: {
    ...
    southeast_asian: ['banana leaf wrapping (Malaysian otak-otak, Thai hor mok)', 'sticky rice steaming in cone-shaped baskets', 'Vietnamese banh cuon (rice rolls)', 'Indonesian tumpeng rice cones'],
    nordic: ['fish steaming with herbs (dill, fennel)', 'root vegetable steam-roasting', 'steamed berry puddings'],
    japanese: ['chawanmushi (savory egg custard)', 'mushimono technique', 'rice cake steaming', 'tea-steamed fish', 'koimo steamed taro'],
    indian: ['idli (fermented rice cakes)', 'dhokla (fermented gram flour cakes)', 'patra (colocasia leaf rolls)', 'momo dumplings'],
    middle_eastern: ['couscous steaming', 'stuffed vegetable steaming', 'fish with aromatic herbs'],
    south_american: ['tamales in corn husks', 'humitas (fresh corn dumplings)', 'Chilean curanto (pit steaming)']
  },
  chemicalChanges: {
  ...
  equipmentComplexity: 0.30, // Basic equipment with some specialized options
  ...
  ingredientPreparation: {
    'vegetables': 'Clean thoroughly; cut into uniform sizes (smaller for dense vegetables, larger for tender ones); arrange with space between pieces for steam circulation',
  ...
  timingConsiderations: {
    'preheating': 'Always preheat the steamer with lid on until vigorous steam appears before adding food (usually 5-8 minutes)',
  ...
  ingredientInteractions: {
    'stacking_effects': 'Flavors from upper layers can drip onto lower items; arrange complementary flavors together or use barriers',
