...
export const steaming: CookingMethodData = {
  ...
  regionalVariations: {
    ...
    middle_eastern: [
      "couscous steaming",
      "stuffed vegetable steaming",
      "fish with aromatic herbs",
    ],
    south_american: [
  ...
  doneness_indicators: {
    ...
    chicken:
      "No pink remains; juices run clear internal temperature 165°F at thickest part",
    ...
    custards:
      "Edges set but center retains slight jiggle knife inserted comes out clean",
    green_vegetables:
      "Bright vibrant color; crisp-tender texture slight resistance when bitten",
    root_vegetables:
