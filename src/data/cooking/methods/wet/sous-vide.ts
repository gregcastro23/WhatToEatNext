 ...
 */
export const sousVide: CookingMethodData = {
  name: 'sous_vide',
  ...
  nutrientRetention: {
    ...
    vitamins: 0.90,  // Very good retention of water-soluble vitamins
  ...
  equipmentComplexity: 0.70, // Requires specialized equipment but simple operation
