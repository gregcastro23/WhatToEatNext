...
export const fermentation: CookingMethodData = {
  ...
  thermodynamicProperties: {
    heat: 0.20,       // Low heat, often ambient temperature
    entropy: 0.70,    // High transformation through biological activity
    reactivity: 0.65, // Significant biochemical reactions
    gregsEnergy: 0.20 - (0.70 * 0.65)      // Calculated using heat - (entropy * reactivity)
  ...
  equipmentComplexity: 0.40, // Basic equipment needed but knowledge is critical
  ...
  ingredientPreparation: {
    'vegetables': 'For lacto-fermentation, shred finely for sauerkraut-style or cut into uniform pieces for pickles. Remove cores, stems, and damaged areas. Salt at 2-2.5% by vegetable weight. Massage salt into vegetables until enough brine is released to submerge. For harder vegetables, consider pre-slicing or grating to increase surface area. Add 1 cabbage leaf on top to keep smaller pieces submerged.',
  ...
  timingConsiderations: {
    'vegetable_ferments': 'Sauerkraut: 1-4 weeks at 65-72°F (18-22°C); kimchi: 3-7 days at room temperature then refrigerate; pickles: 1-2 weeks. Monitor daily at first, less frequently after pH drops below 4.0. Warmer temperatures accelerate acid production but may develop less complex flavors. Full flavor development often takes months in cool storage.',
  ...
  doneness_indicators: {
    'taste_profile': 'Balance of acid, sweetness, salt, and umami; absence of yeasty, putrid, or overly alcoholic notes; complexity rather than one-dimensional flavor. Development of desired aromatic compounds specific to the ferment type.',
  ...
  ingredientInteractions: {
    ...
    'sugar_concentration': 'Provides food for microbes, influencing rate of fermentation and final product. Higher concentrations (above 55%) become preservative, inhibiting most microbial activity. In vegetable ferments, natural sugars are converted to acids; in beverages, determines potential alcohol content.',
