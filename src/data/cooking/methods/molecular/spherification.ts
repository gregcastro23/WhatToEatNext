...
export const spherification: CookingMethodData = {
  ...
  regionalVariations: {
    ...
    middle_eastern: [
      "aromatic tea spheres",
      "rosewater pearls",
      "tahini-based applications",
    ],
  },
  chemicalChanges: {
  ...
  technicalNotes: {
    ...
    requiredAdditives: {
      sodium_alginate:
        "0.5-1% by weight of liquid (higher % = firmer membrane)",
      ...
      calcium_lactate:
        "0.5-1% alternative to calcium chloride with less bitter taste",
    ...
    pHRequirements: {
      ...
      acidicSolutions:
        "May require sodium citrate to adjust pH, test with pH meter",
      alcoholicSolutions:
        "May require xanthan gum stabilizer (0.1-0.2%) to prevent separation",
      highCalciumLiquids:
  ...
  doneness_indicators: {
    ...
    caviar:
      "Individual spheres remain separate and don't merge, bounce slightly when dropped.",
    large_spheres:
      "Surface tension creates slight resistance when touched, membrane is continuous with no weak spots.",
    over_gelled:
      "Sphere feels firm throughout with reduced liquid center, membrane too thick.",
    under_gelled:
      "Membrane breaks easily when handled, sphere loses shape outside of liquid.",
  },
  ingredientInteractions: {
    ...
    salts_and_gelation:
      "High salt content slows gelation process, may require longer bath times.",
    sugar_and_alginate:
