...
export const gelification: CookingMethodData = {
  ...
  nutrientRetention: {
    ...
    carotenoids: 0.80, // Some degradation during processing
  ...
  ingredientPreparation: {
    ...
    'gelatin': 'Bloom in cold water for 5-10 minutes before dissolving in warm liquid (104-140°F/40-60°C). Never boil. Use 0.5-2.5% for soft gels, 2.5-5% for firm gels. Sets at 59-77°F (15-25°C), melts near body temperature. Requires refrigeration to maintain structure. Pre-grind sheet gelatin for faster blooming.',
  ...
  timingConsiderations: {
    'hydration_period': 'Most powdered hydrocolloids require 20-30 minutes for full hydration; sheet gelatin requires 5-10 minutes in cold water. Methylcellulose requires 3-4 hours for complete hydration in cold liquid. Pre-hydration impacts final texture significantly.',
  ...
  doneness_indicators: {
    'proper_hydration': 'Solution becomes visibly clear; viscosity increases noticeably; no visible particles remain suspended. For gelatin, complete dissolution results in transparent solution with no visible granules or sheets.',
    ...
    'gel_completion': 'For soft gels, slight wobble when container is tapped; for firm gels, no movement when container is inverted. Clean separation from container edges indicates complete setting. Clear gels show distinct refraction of light when fully set.',
  ...
  technicalNotes: {
    'hydrocolloid_properties': {
      'gelatin': 'Protein-based, melts at body temperature, thermoreversible, requires refrigeration. Bloom strength (measured in "Bloom" units) indicates gel strength - professional applications typically use 180-220 Bloom gelatin.',
    ...
    'physical_properties': {
      'gel_strength': 'Measured in grams (bloom strength for gelatin) or compression force. Affected by concentration, temperature history, and ion availability. Can be measured precisely with texture analyzer or estimated with penetrometer.',
    ...
    'advanced_techniques': {
      'fluid_gels': 'Created by shearing gel during setting phase, producing partially connected polymer network with controlled flow properties. Used for sauce-like applications with suspended particles. Typically utilize agar or gellan gum at 0.3-0.8%.',
    ...
    'equipment_specifications': {
      'temperature_control': 'Precise control within ±1°F (0.5°C) essential for reproducible results. Water baths and precision immersion circulators preferred over direct heat application.',
