...
class PlanetaryHourCalculator {
  constructor(latitude, longitude) {
    this.planetaryRulers = ['Sun', 'Moon', 'Mars', 'Mercury', 'Jupiter', 'Venus', 'Saturn'];
    this.coordinates = {
      latitude: 40.7128,
      longitude: -74.006,
    };
  ...
  /**
   * Get the planet ruling the current day
  ...
  getPlanetaryHour(date) {
    ...
    const times = suncalc_1.default.getTimes(
...
PlanetaryHourCalculator.dayNames = [
  'Sunday',
  'Monday',
  'Tuesday',
  'Wednesday',
...
PlanetaryHourCalculator.dayRulers = [
  'Sun',
  'Moon',
  'Mars',
  'Mercury',
...
PlanetaryHourCalculator.minuteRulers = [
  'Sun',
  'Venus',
  'Mercury',
  'Moon',
