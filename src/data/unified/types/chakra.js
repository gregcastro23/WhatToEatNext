...
exports.updateChakraEnergy =
  exports.getChakraEnergy =
  exports.createChakraEnergies =
  exports.isChakraEnergies =
  exports.isChakraPosition =
...
function isChakraEnergies(value) {
  ...
  return requiredProperties.every(
    prop => prop in obj && (typeof obj[prop] === 'number' || obj[prop] === undefined),
  );
}
