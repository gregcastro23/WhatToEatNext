...
exports.getSpiceConversionRatio =
  exports.getTraditionalBlends =
  exports.getSpicesByPreparationMethod =
  exports.getSubstitutions =
  exports.getCompatibleSpices =
  exports.getSpiceBlendComponents =
  exports.getSpicesByElementalProperty =
  exports.getSpicesByOrigin =
  exports.getSpicesBySubCategory =
  exports.spiceBlends =
  exports.groundSpices =
  exports.wholeSpices =
  exports.spices =
  exports.addHeatLevels =
    void 0;
...
Object.defineProperty(exports, 'wholeSpices', {
  enumerable: true,
  get: function () {
    return wholespices_1.wholeSpices;
  },
});
const groundspices_1 = require('./groundspices');
Object.defineProperty(exports, 'groundSpices', {
  enumerable: true,
  get: function () {
    return groundspices_1.groundSpices;
  },
});
const spiceBlends_1 = require('./spiceBlends');
Object.defineProperty(exports, 'spiceBlends', {
  enumerable: true,
  get: function () {
    return spiceBlends_1.spiceBlends;
  },
});
...
exports.spices = {
  ...
  cumin: {
    name: 'cumin',
    elementalProperties: (0, elementalUtils_1.createElementalProperties)({
      Fire: 0.25,
      Water: 0.25,
      Earth: 0.25,
      Air: 0.25,
...
const getSpicesByOrigin = origin => {
  return Object.entries(exports.spices)
    .filter(([_, value]) =>
      Array.isArray(value.origin) ? value.origin.includes(origin) : value.origin === origin,
    )
    .reduce((acc, [key, value]) => ({ ...acc, [key]: value }), {});
};
