...
exports.greenOnion = exports.leek = exports.onion = exports.garlic = exports.alliums = void 0;
...
const rawAlliums = {
    ...
    'onion': {
        ...
        astrologicalProfile: {
            ...
            lunarPhaseModifiers: {
                newmoon: {
                    elementalBoost: (0, elementalUtils_2.createElementalProperties)({ Fire: 0.2 }),
                ...
                waningGibbous: {
                    elementalBoost: (0, elementalUtils_2.createElementalProperties)({ Earth: 0.2 }),
    ...
    'leek': {
        ...
        astrologicalProfile: {
            ...
            lunarPhaseModifiers: {
                fullmoon: {
                    elementalBoost: (0, elementalUtils_2.createElementalProperties)({ Water: 0.2 }),
                    preparationTips: ['Enhanced sweetness', 'Good for creamy preparations']
                }
            }
        },
        qualities: ['grounding', 'nourishing', 'gentle', 'versatile', 'subtle'],
        season: ['fall', 'winter', 'early spring'],
        category: 'vegetable',
        subCategory: 'allium',
        affinities: ['potato', 'cream', 'thyme', 'butter', 'parmesan', 'bacon', 'mustard', 'white wine'],
    ...
    'shallot': {
        ...
        category: 'vegetable',
        subCategory: 'allium',
        affinities: ['vinegar', 'butter', 'white wine', 'tarragon', 'thyme', 'mustard', 'cream', 'mushrooms'],
    ...
    "scallion": {
        name: "scallion",
        elementalProperties: { Fire: 0.35, Earth: 0.15, Air: 0.3,
            Water: 0.2
        },
        astrologicalProfile: {
            rulingPlanets: ['Mercury', 'Mars'],
...
exports.alliums = (0, elementalUtils_1.fixIngredientMappings)(rawAlliums);
// Export individual alliums for direct access
exports.garlic = exports.alliums.garlic;
exports.onion = exports.alliums.onion;
exports.leek = exports.alliums.leek;
exports.greenOnion = exports.alliums.green_onion;
// Default export
exports.default = exports.alliums;
