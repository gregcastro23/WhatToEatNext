...
const rawCruciferous = {
    'cauliflower': {
        ...
        affinities: ['cumin', 'turmeric', 'garlic', 'tahini', 'lemon', 'nutritional yeast', 'curry spices'],
    ...
    'brussels sprouts': {
        ...
        category: 'vegetable',
        subCategory: 'cruciferous',
        affinities: ['bacon', 'balsamic', 'garlic', 'mustard', 'pine nuts', 'maple', 'apple', 'blue cheese'],
    ...
    'bok choy': {
        ...
        category: 'vegetable',
        subCategory: 'cruciferous',
        affinities: ['ginger', 'garlic', 'sesame oil', 'soy sauce', 'shiitake', 'scallion', 'oyster sauce'],
