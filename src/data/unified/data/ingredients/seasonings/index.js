...
exports.getSeasoningsByElementalBoost =
  exports.getSeasoningsByLunarPhase =
  exports.getTraditionalCombinations =
  exports.getSeasoningsByTiming =
  exports.getCompatibleSeasonings =
  exports.getSeasoningsByIntensity =
  exports.getSeasoningsByCategory =
  exports.categorizedSalts =
  exports.aromatics =
  exports.herbs =
  exports.peppers =
  exports.salts =
...
Object.defineProperty(exports, 'spices', {
  enumerable: true,
  get: function () {
    return spices_1.spices;
  },
});
const salts_1 = require('./salts');
Object.defineProperty(exports, 'salts', {
  enumerable: true,
  get: function () {
    return salts_1.salts;
  },
});
const peppers_1 = require('./peppers');
Object.defineProperty(exports, 'peppers', {
  enumerable: true,
  get: function () {
    return peppers_1.peppers;
  },
});
const herbs_1 = require('../herbs');
Object.defineProperty(exports, 'herbs', {
  enumerable: true,
  get: function () {
    return herbs_1.herbs;
  },
});
const aromatics_1 = require('./aromatics');
Object.defineProperty(exports, 'aromatics', {
  enumerable: true,
  get: function () {
    return aromatics_1.aromatics;
  },
});
...
const updateSaltCategory = salts => {
  return Object.entries(salts).reduce((acc, [key, value]) => {
    acc[key] = {
      ...value,
      category: 'seasoning',
      subCategory: 'salt',
...
const getTraditionalCombinations = cuisine => {
  const combinations = {};
  Object.entries(exports.seasonings).forEach(([key, value]) => {
    ...
    .filter(
      ([_, value]) =>
        ...
        Object.values(value.astrologicalProfile.lunarPhaseModifiers).some(
          modifier => modifier.elementalBoost[element],
        ),
    )
    .reduce((acc, [key, value]) => ({ ...acc, [key]: value }), {});
};
