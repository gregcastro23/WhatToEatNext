...
export const mexican = {
    ...
    dishes: {
        ...
        lunch: {
            all: [{
                    ...
                    ingredients: [
                        { name: "whole chicken", amount: "1", unit: "large", category: "protein", swaps: ["chickpeas"] },
            ...
            winter: [
                {
                    ...
                    ingredients: [
                        ...
                        { name: "pork shoulder", amount: "1", unit: "kg", category: "protein", swaps: ["mushrooms"] },
            ...
            all: [
                {
                    ...
                    ingredients: [
                        ...
                        { name: "turkey", amount: "2", unit: "kg", category: "protein", swaps: ["chicken", "mushrooms"] },
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "ground pork", amount: "500", unit: "g", category: "protein", swaps: ["plant-based meat"] },
                        { name: "walnuts", amount: "250", unit: "g", category: "nut" },
                        { name: "pomegranate seeds", amount: "1", unit: "cup", category: "fruit" },
                        { name: "Mexican cream", amount: "1", unit: "cup", category: "dAiry", swaps: ["cashew cream"] },
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "sour orange juice", amount: "2", unit: "cups", category: "citrus", swaps: ["lime + orange juice"] },
                        { name: "banana leaves", amount: "4", unit: "large", category: "wrapper", swaps: ["parchment paper"] },
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "goat or beef", amount: "2", unit: "kg", category: "protein", swaps: ["jackfruit"] },
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "lard", amount: "500", unit: "g", category: "fat", swaps: ["vegetable shortening"] },
    ...
    traditionalSauces: {
        mole: {
            ...
            culinaryUses: ["sauce for poultry", "special occasion dishes", "enchilada topping", "flavor base"],
        ...
        salsaVerde: {
            ...
            variants: ["Cruda (raw)", "Cocida (cooked)", "Asada (roasted)", "Cremosa (creamy with avocado)"],
            elementalProperties: { Fire: 0.25, Water: 0.25, Earth: 0.25, Air: 0.25
            },
    ...
    sauceRecommender: {
        forProtein: {
            ...
            seafood: ["salsa veracruzana", "salsa verde cruda", "mojo de ajo", "salsa diabla", "aguachile dressing"],
        ...
        forVegetable: {
            ...
            cactus: ["salsa cruda", "chile lime dressing", "salsa mexicana", "adobo", "tomatillo dressing"],
            corn: ["crema mexicana", "chile lime butter", "cotija cream", "salsa macha", "epazote butter"]
        },
        forCookingMethod: {
            grilling: ["salsa roja asada", "chimichurri mexicano", "adobo", "mojo de ajo", "salsa borracha"],
            simmering: ["mole", "tinga sauce", "chile colorado", "salsa verde cocida", "guisado base"],
            frying: ["salsa mexicana", "chipotle mayonnaise", "crema ácida", "valentina cream", "habanero sauce"],
            steaming: ["salsa verde", "chimichurri", "lime-cilantro sauce", "salsa marisquera", "mojo de ajo"],
            raw: ["aguachile", "leche de tigre mexicana", "salsa bandera", "pico de gallo", "salsa cruda"]
        },
        byAstrological: { Fire: ["salsa macha", "habanero-based sauces", "chile de árbol salsa", "adobo picante", "chipotle salsas"],
            ...
            Air: ["pico de gallo", "salsa bandera", "lime-cilantro dressing", "chimichurri mexicano", "citrus salsas"]
        },
        byRegion: {
            oaxaca: ["mole negro", "mole coloradito", "salsa de chicatana", "chile pasilla mixe", "chilhuacle sauce"],
            yucatan: ["recado rojo", "xnipec", "chiltomate", "habanero salsas", "recado negro"],
            north: ["salsa roja norteña", "machaca sauce", "chile colorado", "chimichurri norteño", "salsa tatemada"],
            centralMexico: ["borracha sauce", "salsa de pulque", "adobo de Toluca", "mole verde", "salsa ranchera"],
    ...
    cookingTechniques: [
        {
            ...
            toolsRequired: ["large pot", "calcium hydroxide (cal)", "wooden spoon", "grinding stone or mill"],
