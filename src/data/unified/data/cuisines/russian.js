...
exports.russian = {
            ...
            all: [
                {
                    ...
                    season: ["all"],
                    mealType: ["breakfast"],
                    elementalProperties: { Fire: 0.20, Water: 0.20, Earth: 0.40, Air: 0.20 }
                },
                {
                    name: "Kasha",
                ...
                },
                {
                    ...
                    elementalProperties: { Fire: 0.20, Water: 0.20, Earth: 0.20, Air: 0.40 }
                },
                {
                    name: "Oladi",
                    ...
                    season: ["all"],
                    mealType: ["breakfast"],
                    elementalProperties: { Fire: 0.10, Water: 0.20, Earth: 0.30, Air: 0.40 }
                }
            ]
        },
        lunch: {
            all: [
                {
                    ...
                    elementalProperties: { Fire: 0.20, Water: 0.40, Earth: 0.30, Air: 0.10 }
                },
                {
                    name: "Pelmeni",
        ...
        dinner: {
            all: [
                ...
                },
                {
                    ...
                    season: ["all"],
                    mealType: ["dinner"],
                    elementalProperties: { Fire: 0.30, Water: 0.10, Earth: 0.50, Air: 0.10 }
                },
                {
                    name: "Olivier Salad",
    ...
    sauceRecommender: {
        ...
        byAstrological: { Fire: ["adjika", "hot mustard", "pepper sauce", "horseradish cream", "spicy tomato"],
