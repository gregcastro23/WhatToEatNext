export const african = {
    ...
    traditionalSauces: {
        ...
        chermoula: {
            ...
            base: "fresh herbs",
            keyIngredients: ["cilantro", "parsley", "olive oil", "lemon juice", "garlic", "cumin", "paprika", "coriander", "preserved lemon"],
            culinaryUses: ["fish marinades", "tagine seasoning", "grilled meats", "roasted vegetables", "couscous dishes"],
            variants: ["Red Chermoula (with paprika)", "Spicy Chermoula (with harissa)", "Preserved Lemon Chermoula"],
            elementalProperties: { Fire: 0.25, Water: 0.25, Earth: 0.25, Air: 0.25
            },
    ...
    sauceRecommender: {
        ...
        byAstrological: { Fire: ["berbere", "harissa", "pili pili"],
