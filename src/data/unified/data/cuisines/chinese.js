...
exports.chinese = {
    ...
    traditionalSauces: {
        ...
        xo: {
            ...
            base: "dried seafood",
            keyIngredients: ["dried scallops", "dried shrimp", "Jinhua ham", "chili", "garlic", "shallots"],
    ...
    sauceRecommender: {
        ...
        byAstrological: { Fire: ["chili oil", "spicy bean paste", "XO sauce"],
            ...
            all: [
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "vegetable oil", amount: "3", unit: "cups", category: "oil", swaps: ["peanut oil"] }
                    ],
                    substitutions: {
            ...
            all: [
                {
                    ...
                    ingredients: [
                        { name: "wheat noodles", amount: "400", unit: "g", category: "noodle", swaps: ["rice noodles"] },
                        { name: "ground pork", amount: "250", unit: "g", category: "protein", swaps: ["ground chicken", "firm tofu"] },
                        { name: "Sichuan peppercorns", amount: "2", unit: "tsp", category: "spice" },
                        { name: "chili oil", amount: "3", unit: "tbsp", category: "oil" },
                        { name: "sui mi ya cai", amount: "2", unit: "tbsp", category: "vegetable", swaps: ["preserved mustard greens"] },
                        { name: "sesame paste", amount: "2", unit: "tbsp", category: "sauce", swaps: ["tahini"] }
                    ],
                    substitutions: {
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "ground pork", amount: "150", unit: "g", category: "protein", swaps: ["beef", "mushrooms"] },
                        ...
                        { name: "fermented black beans", amount: "1", unit: "tbsp", category: "sauce", optional: true }
                    ],
                    substitutions: {
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "har gow (shrimp dumplings)", amount: "4", unit: "pieces", category: "dumpling" },
                        { name: "siu mai (pork dumplings)", amount: "4", unit: "pieces", category: "dumpling" },
                        { name: "char siu bao", amount: "2", unit: "pieces", category: "bun" },
                        { name: "cheong fun (rice noodle rolls)", amount: "1", unit: "plate", category: "noodle" },
        ...
        dinner: {
            all: [
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "chicken thighs", amount: "500", unit: "g", category: "protein", swaps: ["tofu", "tempeh"] },
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "ground pork", amount: "300", unit: "g", category: "protein", swaps: ["ground chicken"] },
                        ...
                        { name: "Shaoxing wine", amount: "1", unit: "tbsp", category: "wine", swaps: ["dry sherry"] },
            ...
            all: [
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "dried fruits", amount: "1", unit: "cup", category: "fruit", notes: "various types" },
                        { name: "nuts", amount: "1/2", unit: "cup", category: "nut", notes: "various types" },
                        { name: "sugar", amount: "1/4", unit: "cup", category: "sweetener" },
                        { name: "lard", amount: "2", unit: "tbsp", category: "fat", swaps: ["vegetable shortening"] }
                    ],
                    substitutions: {
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "pomelo", amount: "1/2", unit: "medium", category: "fruit", swaps: ["grapefruit"] },
                        { name: "sago pearls", amount: "1/4", unit: "cup", category: "grain", swaps: ["tapioca pearls"] },
                        { name: "coconut milk", amount: "1", unit: "cup", category: "liquid" },
                        { name: "sugar", amount: "3", unit: "tbsp", category: "sweetener" },
                        { name: "condensed milk", amount: "2", unit: "tbsp", category: "dAiry", optional: true }
                    ],
                    substitutions: {
