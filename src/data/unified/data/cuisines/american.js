export const american = {
        ...
        breakfast: {
            all: [
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "whole grain bread", amount: "2", unit: "slices", category: "grain", element: 'Earth' },
                        ...
                        { name: "red pepper flakes", amount: "1/4", unit: "tsp", category: "spice", element: 'Fire' },
                        { name: "microgreens", amount: "1/4", unit: "cup", category: "vegetable", element: "Air" }
                    ],
                    substitutions: {
            ...
            spring: [
                {
                    ...
                    ingredients: [
                        ...
                        { name: "asparagus", amount: "1", unit: "bunch", category: "vegetable", element: "Air" },
                        { name: "fresh peas", amount: "1", unit: "cup", category: "vegetable", element: 'Earth' },
                        { name: "green onions", amount: "4", unit: "stalks", category: "vegetable", element: "Air" },
            ...
            summer: [
                {
                    ...
                    ingredients: [
                        { name: "mixed berries", amount: "2", unit: "cups", category: "fruit", element: 'Water' },
            ...
            autumn: [
                {
                    ...
                    ingredients: [
                        { name: "steel-cut oats", amount: "1", unit: "cup", category: "grain", element: 'Earth' },
                        { name: "pumpkin puree", amount: "1/2", unit: "cup", category: "vegetable", element: 'Earth' },
                        { name: "cinnamon", amount: "1", unit: "tsp", category: "spice", element: 'Fire' },
                        { name: "nutmeg", amount: "1/4", unit: "tsp", category: "spice", element: 'Fire' },
                        { name: "maple syrup", amount: "2", unit: "tbsp", category: "sweetener", element: 'Water' },
            ...
            all: [
                {
                    ...
                    ingredients: [
                        ...
                        { name: "hamburger buns", amount: "4", unit: "buns", category: "grain", element: 'Earth' },
                        { name: "cheddar cheese", amount: "4", unit: "slices", category: "dAiry", element: 'Earth' },
                        { name: "lettuce", amount: "4", unit: "leaves", category: "vegetable", element: 'Water' },
                        { name: "tomato", amount: "1", unit: "medium", category: "vegetable", element: 'Water' },
                        { name: "onion", amount: "1/2", unit: "medium", category: "vegetable", element: 'Fire' },
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "romaine lettuce", amount: "1", unit: "head", category: "vegetable", element: 'Water' },
                        { name: "grilled chicken", amount: "2", unit: "breasts", category: "protein", element: 'Fire' },
                        { name: "bacon", amount: "6", unit: "slices", category: "protein", element: 'Fire' },
                        { name: "hard-boiled eggs", amount: "3", unit: "large", category: "protein", element: 'Water' },
                        { name: "avocado", amount: "1", unit: "medium", category: "fruit", element: 'Earth' },
                        { name: "blue cheese", amount: "1/2", unit: "cup", category: "dAiry", element: 'Earth' },
                        { name: "cherry tomatoes", amount: "1", unit: "cup", category: "vegetable", element: 'Water' },
                        { name: "red wine vinaigrette", amount: "1/2", unit: "cup", category: "dressing", element: 'Water' }
                    ],
                    substitutions: {
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "potatoes", amount: "2", unit: "large", category: "vegetable", element: 'Earth' },
                        { name: "onion", amount: "1", unit: "medium", category: "vegetable", element: 'Fire' },
                        { name: "celery", amount: "2", unit: "stalks", category: "vegetable", element: 'Water' },
            ...
            summer: [
                {
                    ...
                    ingredients: [
                        { name: "lobster meat", amount: "1", unit: "pound", category: "seafood", element: 'Water' },
                        { name: "mayonnaise", amount: "1/4", unit: "cup", category: "condiment", element: 'Water' },
                        { name: "celery", amount: "1", unit: "stalk", category: "vegetable", element: 'Water' },
                        { name: "split-top buns", amount: "4", unit: "rolls", category: "grain", element: 'Earth' },
            ...
            autumn: [
                {
                    ...
                    ingredients: [
                        ...
                        { name: "cranberry sauce", amount: "4", unit: "tbsp", category: "condiment", element: 'Water' },
                        { name: "stuffing", amount: "1/2", unit: "cup", category: "grain", element: 'Earth' },
                        { name: "whole grain bread", amount: "4", unit: "slices", category: "grain", element: 'Earth' },
                        { name: "mayonnaise", amount: "2", unit: "tbsp", category: "condiment", element: 'Water' },
            ...
            winter: [
                {
                    ...
                    ingredients: [
                        { name: "russet potatoes", amount: "2", unit: "pounds", category: "vegetable", element: 'Earth' },
                        { name: "bacon", amount: "6", unit: "slices", category: "protein", element: 'Fire' },
                        { name: "milk", amount: "2", unit: "cups", category: "dAiry", element: 'Water' },
                        { name: "cheddar cheese", amount: "1", unit: "cup", category: "dAiry", element: 'Earth' },
            ...
            all: [
                {
                    ...
                    ingredients: [
                        ...
                        { name: "brown sugar", amount: "1/4", unit: "cup", category: "sweetener", element: 'Earth' },
                        { name: "paprika", amount: "2", unit: "tbsp", category: "spice", element: 'Fire' },
                        { name: "garlic powder", amount: "1", unit: "tbsp", category: "spice", element: 'Fire' },
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "ground beef", amount: "2", unit: "pounds", category: "protein", element: 'Fire' },
                        ...
                        { name: "russet potatoes", amount: "3", unit: "pounds", category: "vegetable", element: 'Earth' },
                        { name: "butter", amount: "1/2", unit: "cup", category: "fat", element: 'Earth' },
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "chicken pieces", amount: "3", unit: "pounds", category: "protein", element: 'Fire' },
                        { name: "buttermilk", amount: "2", unit: "cups", category: "dAiry", element: 'Water' },
                        { name: "all-purpose flour", amount: "3", unit: "cups", category: "grain", element: 'Earth' },
                        { name: "paprika", amount: "2", unit: "tbsp", category: "spice", element: 'Fire' },
                        { name: "garlic powder", amount: "1", unit: "tbsp", category: "spice", element: 'Fire' },
            ...
            spring: [
                {
                    ...
                    ingredients: [
                        { name: "arborio rice", amount: "2", unit: "cups", category: "grain", element: 'Earth' },
                        { name: "fresh peas", amount: "2", unit: "cups", category: "vegetable", element: 'Earth' },
                        { name: "lamb chops", amount: "8", unit: "chops", category: "protein", element: 'Fire' },
                        { name: "fresh mint", amount: "1/4", unit: "cup", category: "herb", element: "Air" },
                        { name: "white wine", amount: "1/2", unit: "cup", category: "alcohol", element: 'Water' },
            ...
            summer: [
                {
                    ...
                    ingredients: [
                        { name: "salmon fillet", amount: "2", unit: "pounds", category: "protein", element: 'Water' },
                        { name: "cedar plank", amount: "1", unit: "plank", category: "equipment", element: 'Earth' },
                        { name: "corn on the cob", amount: "4", unit: "ears", category: "vegetable", element: 'Earth' },
                        { name: "zucchini", amount: "2", unit: "medium", category: "vegetable", element: 'Water' },
                        { name: "bell peppers", amount: "2", unit: "large", category: "vegetable", element: 'Fire' },
            ...
            autumn: [
                {
                    ...
                    ingredients: [
                        { name: "beef chuck roast", amount: "3", unit: "pounds", category: "protein", element: 'Fire' },
                        { name: "carrots", amount: "1", unit: "pound", category: "vegetable", element: 'Earth' },
                        { name: "parsnips", amount: "1/2", unit: "pound", category: "vegetable", element: 'Earth' },
            ...
            winter: [
                {
                    ...
                    ingredients: [
                        { name: "whole turkey", amount: "12", unit: "pounds", category: "protein", element: "Air" },
                        { name: "cranberries", amount: "12", unit: "oz", category: "fruit", element: 'Water' },
                        { name: "bread stuffing", amount: "8", unit: "cups", category: "grain", element: 'Earth' },
                        { name: "butter", amount: "1/2", unit: "pound", category: "fat", element: 'Earth' },
                        { name: "fresh sage", amount: "2", unit: "tbsp", category: "herb", element: "Air" },
                        { name: "turkey stock", amount: "4", unit: "cups", category: "broth", element: 'Water' }
                    ],
                    nutrition: {
                        calories: 620,
                        protein: 48,
            ...
            all: [
                {
                    ...
                    ingredients: [
                        { name: "all-purpose flour", amount: "2.5", unit: "cups", category: "grain", element: 'Earth' },
                ...
                },
                {
                    ...
                    ingredients: [
                        { name: "all-purpose flour", amount: "2.25", unit: "cups", category: "grain", element: 'Earth' },
                        { name: "butter", amount: "1", unit: "cup", category: "fat", element: 'Earth' },
                        { name: "brown sugar", amount: "1", unit: "cup", category: "sweetener", element: 'Earth' },
                        { name: "white sugar", amount: "1/2", unit: "cup", category: "sweetener", element: 'Earth' },
                        { name: "eggs", amount: "2", unit: "large", category: "protein", element: 'Water' },
                        { name: "chocolate chips", amount: "2", unit: "cups", category: "chocolate", element: 'Fire' }
                    ],
                    substitutions: {
                ...
                },
                {
                    ...
                    ingredients: [
                        ...
                        { name: "graham crackers", amount: "2", unit: "cups", category: "grain", element: 'Earth' },
                        { name: "butter", amount: "6", unit: "tbsp", category: "fat", element: 'Earth' },
                        { name: "vanilla extract", amount: "1", unit: "tbsp", category: "flavoring", element: "Air" }
                    ],
                    substitutions: {
            ...
            spring: [
                {
                    ...
                    ingredients: [
                        { name: "all-purpose flour", amount: "2", unit: "cups", category: "grain", element: 'Earth' },
                        { name: "fresh strawberries", amount: "1", unit: "quart", category: "fruit", element: 'Water' },
            ...
            summer: [
                {
                    ...
                    ingredients: [
                        { name: "graham crackers", amount: "2", unit: "cups", category: "grain", element: 'Earth' },
                        { name: "chocolate ice cream", amount: "1.5", unit: "quarts", category: "dAiry", element: 'Water' },
                        { name: "marshmallows", amount: "3", unit: "cups", category: "candy", element: "Air" },
                        { name: "butter", amount: "6", unit: "tbsp", category: "fat", element: 'Earth' },
                        { name: "chocolate sauce", amount: "1/4", unit: "cup", category: "topping", element: 'Earth' },
                        { name: "sea salt", amount: "1/4", unit: "tsp", category: "seasoning", element: 'Earth' }
                    ],
                    nutrition: {
                        calories: 440,
                        protein: 5,
            ...
            autumn: [
                {
                    ...
                    ingredients: [
                        { name: "pumpkin puree", amount: "15", unit: "oz", category: "vegetable", element: 'Earth' },
                        { name: "pie crust", amount: "1", unit: "crust", category: "dough", element: 'Earth' },
                        { name: "evaporated milk", amount: "12", unit: "oz", category: "dAiry", element: 'Water' },
                        { name: "eggs", amount: "2", unit: "large", category: "protein", element: 'Water' },
            ...
            winter: [
                {
                    ...
                    ingredients: [
                        { name: "all-purpose flour", amount: "3", unit: "cups", category: "grain", element: 'Earth' },
                        { name: "molasses", amount: "2/3", unit: "cup", category: "sweetener", element: 'Earth' },
                        { name: "ginger", amount: "1", unit: "tbsp", category: "spice", element: 'Fire' },
                        { name: "cinnamon", amount: "1", unit: "tbsp", category: "spice", element: 'Fire' },
                        { name: "butter", amount: "3/4", unit: "cup", category: "fat", element: 'Earth' },
                        { name: "brown sugar", amount: "3/4", unit: "cup", category: "sweetener", element: 'Earth' }
                    ],
                    nutrition: {
                        calories: 180,
                        protein: 2,
    ...
    traditionalSauces: {
        bbqSauce: {
            ...
            base: "tomato",
            keyIngredients: ["tomato paste", "vinegar", "molasses", "brown sugar", "smoke flavor", "spices"],
            culinaryUses: ["marinade", "basting sauce", "dipping sauce", "flavor base"],
            variants: ["Kansas City (sweet)", "Carolina (vinegar-based)", "Texas (spicy)", "Alabama (white)"],
            elementalProperties: { Fire: 0.25, Water: 0.25, Earth: 0.25, Air: 0.25
            },
        ...
        gravySauce: {
            ...
            culinaryUses: ["sauce for meats", "topping for potatoes", "biscuit accompaniment", "casserole base"],
        ...
        mapleGlaze: {
            ...
            culinaryUses: ["topping for pancakes", "glaze for ham", "dessert sauce", "marinade component"],
    ...
    sauceRecommender: {
        ...
        forVegetable: {
            greens: ["ranchDressing", "balsamic vinaigrette", "blue cheese dressing", "lemon vinaigrette"],
        ...
        byAstrological: { Fire: ["hotSauce", "bbqSauce", "spicy aioli", "chipotle sauce"],
        ...
        byDietary: {
            ...
            glutenFree: ["corn-thickened sauces", "reduction sauces", "pureed vegetable sauces", "egg-based sauces"],
