...
exports.getMajorArcanaForSeason =
  exports.getMinorArcanaForSeason =
  exports.getTarotRecommendationsForSeason =
  exports.getSeasonalUsageData =
  exports.getRecommendedCookingMethodByTarotCard =
  exports.getSeasonalIngredientsByTarotCard =
  exports.getTarotInfluenceForSeason =
  exports.seasonalUsage =
  exports.seasonalPatterns =
  exports.getSeasonalRecommendations =
  exports.isInSeason =
  exports.getSeasonalData =
  exports.getSeasonalScore =
  exports.getCurrentSeason =
  exports.unifiedSeasonalSystem =
  exports.UnifiedSeasonalSystem =
...
class UnifiedSeasonalSystem {
  ...
  getSeasonalIngredientProfile(ingredientName, season = this.getCurrentSeason()) {
    ...
    if (seasonProfile.growing.includes(ingredientName)) traditionalUse.push('growing');
    if (seasonProfile.herbs.includes(ingredientName)) traditionalUse.push('culinary herb');
  ...
  getSeasonalOptimalCookingMethods(season, targetMonica) {
    ...
    if (targetMonica !== undefined) {
      const monicaCompatibleMethods = (0, alchemicalPillars_js_1.getMonicaCompatibleCookingMethods)(
        targetMonica,
        0.3,
      );
  ...
  blendMonicaModifiers(from, to, progress) {
    return {
      ...
      timingAdjustment:
        from.timingAdjustment + (to.timingAdjustment - from.timingAdjustment) * progress,
      intensityModifier: progress < 0.5 ? from.intensityModifier : to.intensityModifier,
      planetaryAlignment:
        from.planetaryAlignment + (to.planetaryAlignment - from.planetaryAlignment) * progress,
      lunarPhaseBonus:
  ...
  getTransitionalIngredients(fromSeason, toSeason, progress) {
    const fromIngredients = this.getSeasonalCompatibleIngredients(
      fromSeason,
      exports.unifiedSeasonalProfiles[fromSeason].kalchmRange,
    );
    const toIngredients = this.getSeasonalCompatibleIngredients(
      toSeason,
      exports.unifiedSeasonalProfiles[toSeason].kalchmRange,
    );
...
const getSeasonalScore = (ingredientName, season) =>
  exports.unifiedSeasonalSystem.getSeasonalScore(ingredientName, season);
exports.getSeasonalScore = getSeasonalScore;
const getSeasonalData = (ingredientName, season) =>
  exports.unifiedSeasonalSystem.getSeasonalIngredientProfile(ingredientName, season);
exports.getSeasonalData = getSeasonalData;
const isInSeason = (ingredientName, threshold) =>
  exports.unifiedSeasonalSystem.isInSeason(ingredientName, threshold);
exports.isInSeason = isInSeason;
const getSeasonalRecommendations = (season, targetMonica, kalchmRange) =>
  exports.unifiedSeasonalSystem.getSeasonalRecommendations(season, targetMonica, kalchmRange);
exports.getSeasonalRecommendations = getSeasonalRecommendations;
// Export consolidated data for backward compatibility
exports.seasonalPatterns = Object.fromEntries(
  Object.entries(exports.unifiedSeasonalProfiles).map(([season, profile]) => [
    season,
    {
      ...profile.ingredients,
...
exports.seasonalUsage = Object.fromEntries(
  Object.entries(exports.unifiedSeasonalProfiles).map(([season, profile]) => [
    season,
    {
...
function getSeasonalIngredientsByTarotCard(season, cardKey) {
  const tarotInfluence =
    exports.unifiedSeasonalProfiles[season]?.tarotProfile.tarotInfluences[cardKey];
