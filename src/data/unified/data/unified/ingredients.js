...
exports.findComplementaryIngredients =
  exports.getIngredientsByMonicaRange =
  exports.getHighKalchmIngredients =
  exports.getUnifiedIngredientsBySubcategory =
  exports.getUnifiedIngredientsByCategory =
  exports.getUnifiedIngredient =
...
function enhanceIngredient(ingredient, sourceCategory) {
  ...
  const thermodynamics = ingredient.thermodynamicProperties ||
    ingredient.energyValues || { heat: 0.5, entropy: 0.5, reactivity: 0.5, energy: 0.5 };
  // Calculate Monica value
  ...
  return {
    ...
    // Existing properties
    elementalProperties:
      ingredient.elementalProperties || (0, elementalUtils_1.createElementalProperties)(),
...
function getUnifiedIngredient(name) {
  ...
  return Object.values(exports.unifiedIngredients).find(
...
function getUnifiedIngredientsByCategory(category) {
  return Object.values(exports.unifiedIngredients).filter(
