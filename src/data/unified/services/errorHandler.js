...
exports.logTypeError =
  exports.trackExecution =
  exports.safeExecuteWithContext =
  exports.safePropertyAccess =
  exports.safeValue =
...
class ErrorHandlerService {
  ...
  warnNullValue(variableName, context, value) {
    logWarning(`Potential null / undefined value: ${variableName} in ${context}`, {
      value,
      timestamp: new Date().toISOString(),
    });
  }
