...
exports.getDominantElement =
  exports.calculateElementalCompatibility =
  exports.scaleElementalProperties =
  exports.mergeElementalProperties =
  exports.getElementalProperty =
  exports.isElementalProperties =
  exports.createElementalProperties =
    void 0;
/**
...
function scaleElementalProperties(props, factor) {
  if (!props) return createElementalProperties();
  return createElementalProperties({
...
function getDominantElement(properties) {
  return Object.entries(properties).reduce(
    (max, [element, value]) => (value > max.value ? { element: element, value } : max),
