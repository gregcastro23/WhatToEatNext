 ...
 */
export function createElementalProperties(props) {
    return { 
        Fire: props?.Fire ?? 0, 
        Water: props?.Water ?? 0, 
        Earth: props?.Earth ?? 0, 
 ...
 */
export function getElementalProperty(props, element) {
    if (!props)
        return 0;
 ...
 */
export function mergeElementalProperties(base, override) {
 ...
 */
export function scaleElementalProperties(props, factor) {
    if (!props)
        return createElementalProperties();
    return createElementalProperties({ 
 ...
 */
export function calculateElementalCompatibility(source, target) {
 ...
 */
export function getDominantElement(properties) {
