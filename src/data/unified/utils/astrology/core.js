...
exports.calculateAspects =
  exports.calculateElementalProfile =
  exports.calculateDominantElement =
  exports.calculateElementalCompatibility =
  exports.getZodiacElementalInfluence =
  exports.getPlanetaryElementalInfluence =
  exports.getCurrentAstrologicalState =
  exports.getZodiacSign =
  exports.longitudeToZodiacPosition =
  exports.getDefaultPlanetaryPositions =
  exports.calculatePlanetaryPositions =
  exports.calculatemoonSign =
  exports.calculateSunSign =
  exports.getmoonIllumination =
  exports.getLunarPhaseName =
  exports.calculateLunarPhase =
  exports.getZodiacElement =
  exports.getLunarPhaseModifier =
...
async function getCurrentAstrologicalState(date = new Date()) {
  try {
    ...
    const _timeFactors = {
      ...
      hourPlanet: new PlanetaryHourCalculator_1.PlanetaryHourCalculator().getPlanetaryHour(date)
        .planet,
