...
exports.fixIngredientMappings = exports.enhanceOilProperties = exports.enhanceVegetableTransformations = exports.getStrengtheningElement = exports.getComplementaryElement = exports.normalizeElementalValues = exports.transformItemsWithPlanetaryPositions = exports.elementalUtils = exports.getMissingElements = exports.validateElementalRequirements = exports.standardizeRecipeElements = exports.normalizeProperties = exports.validateElementalProperties = void 0;
...
const normalizeProperties = (properties) => {
    ...
    const completeProperties = { Fire: properties.Fire ?? elementalCore_1.DEFAULT_ELEMENTAL_PROPERTIES.Fire, Water: properties.Water ?? elementalCore_1.DEFAULT_ELEMENTAL_PROPERTIES.Water, Earth: properties.Earth ?? elementalCore_1.DEFAULT_ELEMENTAL_PROPERTIES.Earth, Air: properties.Air ?? elementalCore_1.DEFAULT_ELEMENTAL_PROPERTIES.Air,
    };
    ...
    return items.map(item => {
        ...
        Object.entries(planetaryPositions).forEach(([planet, position]) => {
            if (typeof position === 'object' && position && 'sign' in position) {
                const planetBoost = (0, planetaryFoodAssociations_1.calculatePlanetaryBoost)(planet, position.sign, isDaytime);
