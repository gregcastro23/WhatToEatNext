...
const rawMedicinalHerbs = {
  echinacea: {
    ...
    varieties: {
      purpurea: {
        ...
        characteristics:
          "Most common variety, purple coneflower with fibrous roots",
    ...
    preparationMethods: {
      tincture: {
        ...
        notes:
          "Alcohol extracts alkylamides effectively, produces characteristic tingling",
      },
      decoction: {
        name: "Decoction",
        parts_used: ["roots primarily"],
      ...
      glycerite: {
        ...
        notes:
          "Alcohol-free alternative, suitable for children and those avoiding alcohol",
      },
      salve: {
        name: "Salve",
    ...
    culturalContext: {
      ...
      modern_western: {
        historical_adoption:
          "Introduced to American Eclectic physicians in late 1800s",
        commercial_impact:
          "One of the top-selling herbs in North America and Europe",
        research_interest:
          "Extensively studied for immunomodulating properties",
      },
    },
    sustainability: {
      conservation_status: {
      ...
      ethical_harvesting: {
        wild_crafting:
          "Harvest no more than 1 / (3 || 1) of a stand, leave roots from some plants",
        regenerative_practices: "Plant seeds when harvesting wild populations",
      },
      growing_guides: {
        cultivation:
          "Well-drained soil, full sun, drought tolerant once established",
        propagation:
          "Seed stratification helpful, division for established plants",
        companion_planting:
          "Grows well with yarrow, butterfly weed, and native grasses",
      },
    },
    affinity: {
      enhanced_by: [
  ...
  chamomile: {
    ...
    properties: {
      ...
      sensoryProfile: { taste: { sweet: 0.1, salty: 0.0, sour: 0.0, bitter: 0.2, umami: 0.0, spicy: 0.0 }, aroma: { herbaceous: 0.9, grassy: 0.5, floral: 0.3 }, texture: { tender: 0.6, delicate: 0.5 } },
      nutritionalProfile: { serving_size: "1 cup brewed (240g)", calories: 2, macros: { protein: 0, carbs: 0.5, fat: 0, fiber: 0 }, vitamins: { folate: 0.01 }, minerals: { potassium: 0.01, magnesium: 0.01 }, source: "USDA FoodData Central" },
      culinaryProfile: { flavorProfile: { primary: ["herbaceous"], secondary: ["grassy", "bright"], notes: "Add fresh herbs at the end of cooking to preserve volatile oils; dried herbs go in early." }, cookingMethods: ["raw", "infuse", "finish", "chiffonade"], cuisineAffinity: ["Mediterranean", "French", "Middle-Eastern", "Asian"], preparationTips: ["Chop with a sharp knife to avoid bruising.", "Add fresh at service, dried during simmer."] },
      pairingRecommendations: { complementary: ["olive oil", "lemon", "garlic", "butter", "tomato"], contrasting: ["chili", "vinegar", "citrus zest"], toAvoid: [] },
      storage: { refrigerated: "Wrap in damp paper towel, bag loosely — 5-7 days.", notes: "Hardy herbs (rosemary, thyme) freeze well; tender herbs (basil, cilantro) wilt fast." }
},
