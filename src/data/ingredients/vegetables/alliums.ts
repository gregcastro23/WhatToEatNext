...
const rawAlliums: Record<string, Partial<IngredientMapping>> = {
  garlic: {
    ...
    scaledElemental: { Fire: 0.58, Air: 0.21, Earth: 0.11, Water: 0.1 }, // Scaled for harmony
    ...
    kineticsImpact: { thermalDirection: 0.3, forceMagnitude: 1.25 }, // Strong warming, high force
    astrologicalProfile: {
    ...
    culinaryProfile: {
      ...
      preparationTips: [
        "Crush or chop to release flavor",
...
export const _alliums: Record<string, IngredientMapping> =
