...
const rawRefinedGrains = {
  ...
  semolina: {
    ...
    preparation: {
      pasta_making: {
        ...
        tips: [
          "rest dough for at least 30 minutes",
          "dust surface with additional semolina",
        ],
      },
      couscous: {
        ...
        tips: [
          "fluff with fork between steaming",
          "adds lightness to finished dish",
        ],
      },
      halva: {
  ...
  polished_farro: {
    ...
    varieties: {
      ...
      semi_pearled: {
        characteristics:
          "partially refined, balanced nutrition and cooking time",
        cooking_ratio: "1:2.5 farro to water",
    ...
    lunarPhaseModifiers: {
      ...
      waningGibbous: {
        ...
        preparationTips: [
          ...
          "Textural qualities highlighted",
        ],
      },
    },
  },
