...
const rawOils: Record<string, Partial<IngredientMapping>> = {
    ...
    'walnut_oil': {
        ...
        culinaryApplications: {
            finishing: { 
                notes: ["Distinctive nutty flavor enhances cooked dishes", "Not ideal for high heat cooking"],
    ...
    'sunflower_oil': {
        ...
        culinaryApplications: {
            frying: { 
                notes: ["High smoke point makes it ideal for frying", "Neutral flavor won't compete with food"],
    ...
    'peanut_oil': {
        ...
        culinaryApplications: {
            deepfrying: { 
                notes: ["High smoke point ideal for deep frying", "Can be reused multiple times", "Traditional for Asian cuisine"],
    ...
    'rice_bran_oil': {
        ...
        culinaryApplications: {
            frying: { 
                notes: ["High smoke point makes it excellent for frying", "Neutral flavor won't overpower foods"],
    ...
    'mustard_oil': {
        ...
        culinaryApplications: {
            indian: { 
                ...
                techniques: ["Sometimes heated until smoking then cooled before use", "Used raw for sharp flavor"],
    ...
    'macadamia_oil': {
        ...
        culinaryApplications: {
            finishing: { 
                notes: ["Delicate, buttery flavor perfect for finishing dishes", "Adds luxurious mouthfeel"],
