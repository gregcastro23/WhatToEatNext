...
const rawSalts = {
  ...
  himalayan_salt: {
    ...
    astrologicalProfile: {
      ...
      lunarPhaseModifiers: {
        new: {
          ...
          culinaryTip:
            "Use for preserving during new moon for enhanced shelf life",
        },
        full: {
          elementalBoost: { Water: 0.1 },
          culinaryTip:
            "Solutions prepared during full moon enhance mineral absorption",
        },
      },
    },
    qualities: [
    ...
    geologicalFormation: {
      ...
      process:
        "Ancient sea evaporation followed by tectonic activity and mineral infusion",
    ...
    varieties: {
      ...
      blocks: {
        ...
        culinary_uses:
          "Cooking surface, cold food presentation, salt plate cooking",
    ...
    culinaryApplications: {
      ...
      finishing: {
        name: "Finishing Salt",
        methods: [
          "Sprinkled over completed dishes",
          "Visual garnish",
          "Textural element",
        ],
        ideal_pairings: [
        ...
        notes:
          "Use coarse grind or flakes for maximum visual and textural impact",
      },
      salt_block_cooking: {
    ...
    flavor: {
      ...
      comparison_to_regular_salt:
        "Less sharp, more rounded flavor profile with mineral complexity",
    },
    nutritionalConsiderations: {
      mineral_content: "Higher in trace minerals than refined salt",
      sodium_content:
        "Approximately 98% sodium chloride, similar to table salt",
      health_claims: {
        regulated:
          "No clinically proven therapeutic differences from regular salt",
        traditional: [
      ...
      dietary_considerations: {
        sodium_restriction:
          "Should still be limited by those on sodium-restricted diets",
        iodine_content:
          "Contains some natural iodine but less than iodized salt",
        additives:
          "Free from anti-caking agents and additives found in table salt",
      },
    },
    traditionalUses: {
      ayurvedic: {
    ...
    sustainability: {
      mining_practices: {
        traditional:
          "Uses room and pillar mining techniques dating back centuries",
