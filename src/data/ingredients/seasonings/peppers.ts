...
const rawPeppers = {
  black_pepper: {
    ...
    nutritionalProfile: {
      ...
      calories: 6,
      macros: { protein: 0.2, carbs: 1.5, fat: 0.1, fiber: 0.6, saturatedFat: 0, sugar: 0, potassium: 31, sodium: 0 },
      vitamins: { K: 0.02 },
  ...
  white_pepper: {
    ...
    nutritionalProfile: {
      ...
      calories: 7,
      macros: { protein: 0.3, carbs: 1.6, fat: 0.1, fiber: 0.6, saturatedFat: 0, sugar: 0, potassium: 2, sodium: 0 },
      vitamins: {},
  ...
  pink_peppercorn: {
    ...
    nutritionalProfile: {
      ...
      calories: 4,
      macros: { protein: 0.1, carbs: 1.0, fat: 0.1, fiber: 0.2, saturatedFat: 0, sugar: 0, potassium: 8, sodium: 0 },
      vitamins: {},
  ...
  szechuan_peppercorn: {
    ...
    nutritionalProfile: {
      serving_size: "1 tsp (2g)",
      calories: 6,
      macros: { protein: 0.2, carbs: 1.2, fat: 0.1, fiber: 0.4, saturatedFat: 0, sugar: 0, potassium: 22, sodium: 1 },
      vitamins: {},
  ...
  long_pepper: {
    ...
    nutritionalProfile: {
      serving_size: "1 tsp (2g)",
      calories: 5,
      macros: { protein: 0.2, carbs: 1.2, fat: 0.1, fiber: 0.3, saturatedFat: 0, sugar: 0, potassium: 18, sodium: 1 },
      vitamins: {},
