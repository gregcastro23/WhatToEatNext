...
const rawVinegars = {
  rice_vinegar: createIngredientMapping("rice_vinegar", {
    ...
    storage: {
      ...
      signs_of_spoilage: {
        visual:
          "cloudiness, sediment (though some varieties naturally have this)",
  ...
  balsamic_vinegar: createIngredientMapping("balsamic_vinegar", {
    ...
    varieties: {
      Commercial: {
        ...
        processing:
          "mix of wine vinegar and grape must, may contain caramel color",
    ...
    storage: {
      ...
      notes:
        "Does not require refrigeration, may develop sediment with age which is normal",
    },
  }),
    ...
    culinaryApplications: {
      health_tonics: {
        ...
        ratios: {
          ...
          fire_cider:
            "steep with garlic, onion, ginger, horseradish, and citrus",
          // Removed excessive sensoryProfile nesting
          // Removed nested content
          // Removed nested content
          // Removed nested content
        ...
        cautions:
          "may erode tooth enamel if not diluted, rinse mouth after consuming",
      },
    },
    storage: {
      temperature: "room temperature",
...
export const vinegars: Record<string, IngredientMapping> =
  fixIngredientMappings(rawVinegars);
