...
const rawMelons = {
  ...
  'honeydew': {
    ...
    preparation: {
      ...
      tips: ['One of the hardest melons to select when ripe', 'Benefit from day at room temp before eating']
    },
  ...
  'persian_melon': {
    ...
    preparation: {
      ...
      cutting: 'Halve, remove seeds, then slice or cube',
      storage: 'Room temperature until ripe, then refrigerated for up to a week',
      tips: ['Allow to ripen at room temperature for best flavor', 'Subtle floral notes are distinctive']
    },
  ...
  'winter_melon': {
    ...
    preparation: {
      ...
      tips: ['Young melons can be used with skin', 'Mature melons need peeling', 'Can be dried for later use']
    },
    pairings: ['ginger', 'garlic', 'chinese_ham', 'shiitake_mushrooms', 'pork', 'scallions', 'star_anise'],
...
export const melons: Record<string, IngredientMapping> = fixIngredientMappings(rawMelons as Record<string, Partial<IngredientMapping>>); 