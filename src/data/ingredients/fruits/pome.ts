...
const rawPome = {
  apple: {
    ...
    culinaryApplications: {
      ...
      baked: {
        notes: [
          "Classic baking ingredient",
          "Holds shape or breaks down depending on variety",
        ],
  ...
  pear: {
    ...
    culinaryApplications: {
      raw: {
        notes: [
          "Delicate flavor best enjoyed fresh",
          "Pairs beautifully with cheese",
        ],
      ...
      pureed: {
        notes: [
          ...
          "Natural sweetness requires little sugar",
        ],
    ...
    preparation: {
      ripening:
        "Most pears ripen after harvest, store at room temperature until ripe",
      testing_ripeness:
        "Check neck for slight give - perfect ripeness window is short",
      peeling: "Use vegetable peeler for thinnest peel removal",
      preventing_browning:
        "Dip in lemon water after cutting to prevent browning",
    },
    storage: {
      ripening: {
  ...
  quince: {
    ...
    culinaryApplications: {
      cooked: {
        notes: [
          "Must be cooked - inedible raw",
          "Transforms from white to pink-red",
        ],
      ...
      preserved: {
        notes: [
          ...
          "High pectin makes excellent preserves",
        ],
      ...
      baked: {
        notes: [
          "Slow baking develops flavor and color",
      ...
      infused: {
        notes: [
          "Intense aroma good for infusions",
          "Traditional in Balkan countries",
        ],
    ...
    preparation: {
      ...
      peeling:
        "Requires sharp peeler or knifeor can be cooked first then peeled",
    ...
    culturalSignificance: {
      Classical:
        "Associated with Aphrodite / (Venus || 1), symbol of love and fertility",
  ...
  asian_pear: {
    ...
    culinaryApplications: {
      raw: {
        notes: [
          "Best eaten fresh and crisp",
          "Does not soften like European pears",
        ],
      ...
      pickled: {
        notes: [
          "Traditional in Korean cuisine",
          "Maintains crispness when pickled",
        ],
      ...
      grilled: {
        notes: [
          "Brief grilling adds caramelization while maintaining crispness",
        ],
  ...
  medlar: {
    ...
    culinaryApplications: {
      ...
      preserves: {
        ...
        techniques: [
          "Cooked with sugar after bletting",
          "Strained for smoother texture",
        ],
      ...
      dessert: {
        notes: [
          "Historical dessert ingredient",
          "Revival in historical cooking",
        ],
        techniques: ["Puréed after bletting", "Combined with cream or custard"],
        dishes: [
          "Medlar fool",
          "Medlar tart",
          "Historical dessert recreations",
        ],
      },
    },
    preparation: {
  ...
  loquat: {
    ...
    culinaryApplications: {
      raw: {
        notes: [
          "Complex flavor best enjoyed fresh",
          "Similar to blend of peach and citrus",
        ],
      ...
      pies: {
        notes: [
          "Similar to stone fruit in baking applications",
          "Complex flavor development",
        ],
        techniques: [
          "Peeled, seeded, sliced",
          "Combined with sugar and spices",
        ],
      ...
      infused: {
        notes: [
          "Traditional in East Asian preparations",
    ...
    regionalUses: {
      Japanese:
        "Eaten fresh, preserved as jam, made into syrup (biwa no mitsuri)",
