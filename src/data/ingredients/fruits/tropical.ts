...
const rawTropicalFruits: Record<string, Partial<IngredientMapping>> = {
  mango: {
      image_url: "ingredients/mango.png",
  ...
  pineapple: {
      image_url: "ingredients/pineapple.png",
  ...
  papaya: {
      image_url: "ingredients/papaya.png",
  ...
  passion_fruit: {
      image_url: "ingredients/passion_fruit.png",
  ...
  guava: {
      image_url: "ingredients/guava.png",
  ...
  dragon_fruit: {
      image_url: "ingredients/dragon_fruit.png",
  ...
  lychee: {
      image_url: "ingredients/lychee.png",
  ...
  rambutan: {
      image_url: "ingredients/rambutan.png",
  ...
  longan: {
      image_url: "ingredients/longan.png",
  ...
  starfruit: {
      image_url: "ingredients/starfruit.png",
  ...
  persimmon: {
      image_url: "ingredients/persimmon.png",
  ...
  kiwi: {
      image_url: "ingredients/kiwi.png",
  ...
  durian: {
      image_url: "ingredients/durian.png",
  ...
  coconut: {
      image_url: "ingredients/coconut.png",
  ...
  banana: {
    ...
    nutritionalProfile: {
      ...
      antioxidants: ["dopamine", "catechin", "resistant starch"],
      notes:
        "Dopamine moderate - not crossing blood-brain barrier but antioxidant; " +
        "catechin moderate; " +
        "resistant starch high in green bananas - prebiotic benefits",
      source: "USDA FoodData Central",
    },
    sensoryProfile: {
      taste: {
    ...
    pairingRecommendations: {
      complementary: ["citrus", "honey", "vanilla", "dairy", "mint"],
      contrasting: ["chili", "salt", "vinegar"],
      toAvoid: [],
    },
    ...
    storage: {
      countertop: "Until ripe, then refrigerate.",
      notes: "Ethylene-producers (apple, banana) ripen neighbors faster — separate if delaying ripening.",
    ...
    culinaryProfile: {
      flavorProfile: {
        primary: ["sweet"],
        secondary: ["acidic", "aromatic"],
        notes: "Ripeness drives use: firm/underripe for savory, ripe for desserts, overripe for purees.",
      },
      cookingMethods: ["raw", "roast", "poach", "jam", "dehydrate"],
      cuisineAffinity: ["Mediterranean", "tropical", "European", "Asian"],
      preparationTips: [
        "Taste for ripeness before committing to a technique.",
        "Acid balances sweetness; salt amplifies both.",
      ],
    },
  },
  ...
  avocado: {
    ...
    nutritionalProfile: {
      ...
      antioxidants: ["lutein zeaxanthin", "beta sitosterol", "glutathione"],
      notes:
        "Lutein zeaxanthin high - eye health; " +
        "beta sitosterol high - may lower cholesterol; " +
