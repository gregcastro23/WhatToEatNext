      ...
      all: [
        {
          ...
          tools: ['large stock pot', 'strainer', 'ladle', 'serving bowls', 'chopsticks'],
          preparationSteps: [
        ...
        }
        {
          ...
          tools: ['steamer', 'non-stick pan', 'spatula', 'mixing bowls', 'serving plates'],
          preparationSteps: [
            'Make rice batter',
            'Prepare filling',
            'Steam thin layers',
      ...
      all: [
        {
          ...
          tools: ['grill or grill pan', 'knife', 'cutting board', 'mixing bowls', 'mandoline'],
          preparationSteps: [
            'Marinate pork',
    ...
    dinner: {
      all: [
        ...
        }
        {
          ...
          tools: ['grill', 'rice cooker', 'frying pan', 'mixing bowls', 'serving plates'],
          preparationSteps: [
            'Marinate pork chops',
            'Cook broken rice',
            'Grill pork chops',
      ...
      all: [
        {
          ...
          tools: ['saucepans', 'strainer', 'tall glasses', 'measuring cups', 'spoons'],
          preparationSteps: [
            'Cook red beans',
            'Prepare mung beans',
            'Make pandan jelly',
