...
export const cuisine: Cuisine = {
  ...
  motherSauces: {
    exampleSauce: {
      ...
      astrologicalInfluences: ["astrological influence1", "astrological influence2", "astrological influence3"],
      ...
      all: [
        {
          ...
          ingredients: [
            ...
            { name: "ingredient5", amount: "1/4", unit: "cup", category: "vegetable", element: "Air" }
          ],
          substitutions: {
