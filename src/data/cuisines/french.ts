...
export const french: Cuisine = {
  ...
  motherSauces: {
    bechamel: {
      ...
      technicalTips:
        "For a smoother sauce, heat the milk before adding it to the roux.",
      difficulty: "medium",
      storageInstructions:
    ...
    veloute: {
      ...
      seasonality: "all",
      preparationNotes:
        "The stock must be relatively clear and the roux cooked to a blonde stage.",
      technicalTips:
        "Choose the stock type based on the protein it will accompany.",
      difficulty: "medium",
      storageInstructions:
        "Refrigerate up to 2 days, reheat gently while whisking",
      yield: "2 cups",
    },
    espagnole: {
      ...
      preparationNotes:
        "The roux must be browned correctly to develop the deep color and flavor.",
    ...
    hollandaise: {
      name: "Hollandaise",
      description:
        "An emulsion of butter and lemon juice using egg yolks as the emulsifier",
      ...
      preparationNotes:
        "Temperature control is critical to prevent curdling or breaking.",
      technicalTips:
        "Use a double boiler or bain-marie and add butter gradually.",
      difficulty: "hard",
      storageInstructions:
        "Best served immediately, can hold warm for up to 1 hour in bain-marie",
      yield: "1 cup",
    },
    tomato: {
      name: "Tomato Sauce",
      description:
        "A sauce based on tomatoes, with aromatic vegetables and stock",
      base: "tomatoes",
      ...
      preparationNotes:
        "Can be smooth or chunky depending on the preparation method.",
  ...
  cookingTechniques: [
    ...
    },
    {
      name: "Sous Vide",
      description:
        "Cooking vacuum-sealed food in a temperature-controlled water bath",
  ...
  regionalCuisines: {
    ...
    burgundy: {
      ...
      description:
        "Wine-centric cuisine known for slow-cooked dishes, mustard, and escargot",
      signature: [
        "beef bourguignon",
        "coq au vin",
    ...
    alsace: {
      ...
      description:
        "German-influenced cuisine featuring charcuterie, sauerkraut, and white wines",
      signature: [
        "choucroute garnie",
        "tarte flambée",
        "baeckeoffe",
