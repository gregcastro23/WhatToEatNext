        ...
        all: [
          {
            ...
            description: "Traditional Burgundian chicken braised in wine",
            cuisine: "French",
            ingredients: [
              { name: "coq fermier", amount: "1.5", unit: "kg", category: "protein", swaps: ["seitan"] },
              { name: "vin rouge de Bourgogne", amount: "750", unit: "ml", category: "wine" },
              { name: "lardons fumés", amount: "200", unit: "g", category: "protein", swaps: ["champignons fumés"] },
              { name: "champignons de Paris", amount: "300", unit: "g", category: "vegetable" },
              { name: "oignons grelots", amount: "250", unit: "g", category: "vegetable" },
              { name: "carottes", amount: "200", unit: "g", category: "vegetable" },
              { name: "bouquet garni", amount: "1", unit: "piece", category: "herb" },
              { name: "beurre", amount: "50", unit: "g", category: "dairy", swaps: ["huile d'olive"] },
              { name: "cognac", amount: "50", unit: "ml", category: "spirit" }
            ],
            nutrition: {
              calories: 580,
              protein: 45,
          ...
          },
          {
            ...
            description: "Traditional Provençal fish stew with rouille",
            cuisine: "French",
            ingredients: [
              { name: "poisson de roche", amount: "800", unit: "g", category: "protein", swaps: ["légumes racines"] },
              { name: "lotte", amount: "300", unit: "g", category: "protein" },
              { name: "rascasse", amount: "300", unit: "g", category: "protein" },
              { name: "moules", amount: "500", unit: "g", category: "seafood", swaps: ["champignons king"] },
              { name: "fenouil", amount: "2", unit: "bulbs", category: "vegetable" },
              { name: "tomates", amount: "4", unit: "large", category: "vegetable" },
              { name: "safran", amount: "1", unit: "pinch", category: "spice" },
              { name: "rouille", amount: "200", unit: "g", category: "sauce" },
              { name: "pain de campagne", amount: "1", unit: "loaf", category: "bread", swaps: ["pain sans gluten"] }
            ],
            nutrition: {
              calories: 480,
              protein: 52,
          ...
          },
          {
            ...
            description: "Classic duck with orange sauce and bitter orange zest",
            cuisine: "French",
            ingredients: [
              { name: "canard", amount: "1", unit: "whole", category: "protein", swaps: ["seitan au canard"] },
              { name: "oranges", amount: "4", unit: "whole", category: "fruit" },
              { name: "oranges amères", amount: "2", unit: "whole", category: "fruit" },
              { name: "fond de veau", amount: "500", unit: "ml", category: "stock", swaps: ["fond végétal"] },
              { name: "sucre", amount: "100", unit: "g", category: "sweetener" },
              { name: "vinaigre de vin", amount: "50", unit: "ml", category: "vinegar" },
              { name: "échalotes", amount: "2", unit: "whole", category: "vegetable" },
              { name: "cognac", amount: "60", unit: "ml", category: "spirit" }
            ],
            nutrition: {
              calories: 620,
              protein: 42,
