...
export const italian: Cuisine = {
  ...
  motherSauces: {
    ...
    semifreddo: {
      ...
      description: "Light Italian frozen dessert with lemon and cream",
      cuisine: "Italian",
      cookingMethods: [
        {
          name: "whipping",
      ...
      tools: ["stand mixer", "loaf pan", "spatula", "zester"],
      preparationSteps: [
      ...
      ingredients: [
        ...
        { name: "eggs", amount: "4", unit: "large", category: "protein" },
        { name: "sugar", amount: "3/4", unit: "cup", category: "sweetener" },
        { name: "lemons", amount: "3", unit: "medium", category: "fruit" },
        { name: "limoncello", amount: "2", unit: "tbsp", category: "alcohol" },
      ],
      substitutions: {
        "limoncello": ["lemon extract"],
        "lemons": ["Meyer lemons"],
      },
      servingSize: 8,
      allergens: ["dairy", "eggs"],
      prepTime: "25 minutes",
      cookTime: "0 minutes (4 hours freezing)",
      culturalNotes: "A lighter alternative to gelato, perfect for summer entertaining on the Italian Riviera",
      pairingSuggestions: ["biscotti", "fresh berries", "espresso"],
      dietaryInfo: ["vegetarian"],
      spiceLevel: "none",
      nutrition: {
        calories: 280,
