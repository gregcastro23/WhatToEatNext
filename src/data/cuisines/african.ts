...
export const african = {
  ...
  traditionalSauces: {
    ...
    chermoula: {
      name: "Chermoula",
      description: "Moroccan herb sauce with cilantro, parsley, olive oil, and spices",
      base: "fresh herbs",
      keyIngredients: ["cilantro", "parsley", "olive oil", "lemon juice", "garlic", "cumin"],
      culinaryUses: ["fish marinades", "meat dishes", "vegetable dishes", "stews"],
      variants: ["Red Chermoula (with paprika)", "Spicy Chermoula", "Preserved Lemon Chermoula"],
      elementalProperties: {
        Water: 0.4,
        Earth: 0.3,
        Air: 0.2,
      ...
      preparationNotes: "Best made fresh, but can be stored for up to a week refrigerated.",
      technicalTips: "Blanch herbs briefly to maintain vibrant green color."
    },
    peanut: {
  ...
  sauceRecommender: {
    forProtein: {
      chicken: ["peanut sauce", "chermoula", "berbere"],
      ...
      all: [
        {
          ...
          ingredients: [
            ...
            { name: "coconut milk", amount: "1", unit: "cup", category: "dairy", swaps: ["regular milk"] },
        ...
        },
        {
          ...
          ingredients: [
            ...
            { name: "bell peppers", amount: "2", unit: "medium", category: "vegetable", swaps: ["roasted red peppers"] },
        ...
        },
        {
          ...
          ingredients: [
            { name: "fava beans", amount: "2", unit: "cups", category: "legume", swaps: ["canned fava beans"] },
            { name: "olive oil", amount: "3", unit: "tbsp", category: "oil", swaps: ["vegetable oil"] },
      ...
      all: [
        {
          ...
          ingredients: [
            ...
            { name: "chicken broth", amount: "4", unit: "cups", category: "broth", swaps: ["vegetable broth"] }
          ],
          substitutions: {
        ...
        },
        {
          ...
          ingredients: [
            { name: "chicken legs", amount: "1", unit: "kg", category: "protein", swaps: ["chicken thighs"] },
            { name: "berbere spice", amount: "1/4", unit: "cup", category: "spice", swaps: ["mild paprika + cayenne"] },
            ...
            { name: "niter kibbeh", amount: "1/2", unit: "cup", category: "fat", swaps: ["ghee", "butter"] }
          ],
          substitutions: {
        ...
        },
        {
          ...
          ingredients: [
            { name: "chicken", amount: "1", unit: "whole", category: "protein", swaps: ["chicken pieces"] },
            { name: "onions", amount: "4", unit: "large", category: "vegetable" },
            { name: "lemon juice", amount: "1/2", unit: "cup", category: "acid" },
            { name: "dijon mustard", amount: "2", unit: "tbsp", category: "condiment", swaps: ["yellow mustard"] },
      ...
      all: [
        {
          ...
          ingredients: [
            { name: "ground lamb", amount: "500", unit: "g", category: "protein", swaps: ["ground beef"] },
            { name: "bread", amount: "2", unit: "slices", category: "grain", swaps: ["gluten-free bread"] },
        ...
        },
        {
          ...
          ingredients: [
            { name: "bitter leaves", amount: "500", unit: "g", category: "vegetable", swaps: ["collard greens"] },
            { name: "beef", amount: "500", unit: "g", category: "protein" },
            { name: "raw peanuts", amount: "2", unit: "cups", category: "protein" },
            { name: "dried shrimp", amount: "100", unit: "g", category: "seafood", swaps: ["shrimp paste"] },
      ...
      all: [
        {
          ...
          ingredients: [
            ...
            { name: "apricot jam", amount: "1/2", unit: "cup", category: "spread", swaps: ["peach jam"] },
        ...
        },
        {
          ...
          ingredients: [
            ...
            { name: "coconut", amount: "1", unit: "cup", category: "nut", swaps: ["desiccated coconut"] },
