    ...
    dessert: {
      ...
      summer: [
...

        {
          name: "Pani Puri",
          description:
            "Crispy hollow puris filled with spiced potato and tangy tamarind water",
          cuisine: "Indian (Street Food)",
          cookingMethods: [
            {
              name: "deep-frying",
          ...
          cookTime: "20 minutes",
          culturalNotes:
            "India's most beloved street food, eating pani puri is a social experience best enjoyed standing at roadside stalls",
