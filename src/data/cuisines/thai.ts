    ...
    breakfast: {
      all: [
        ...
        }
        {
          ...
          tools: ['deep fryer', 'mixing bowls', 'whisk', 'saucepan', 'thermometer', 'strainer'],
          preparationSteps: [
            'Make yeast dough',
            'Let dough rise',
        ...
        }
        {
          ...
          cuisine: 'Thai',
          cookingMethods: ['simmering', 'boiling'],
          tools: ['large pot', 'ladle', 'knife', 'cutting board', 'small bowls for garnishes'],
          preparationSteps: [
      ...
      all: [
        {
          ...
          tools: ['wok', 'mortar and pestle', 'spatula', 'knife', 'cutting board'],
          preparationSteps: [
        ...
        }
        {
          ...
          tools: ['mortar and pestle', 'grater', 'knife', 'cutting board', 'lime squeezer'],
          preparationSteps: [
            'Shred green papaya',
      ...
      all: [
        {
          ...
          tools: ['wok', 'spatula', 'strainer', 'small bowls for prep', 'measuring spoons'],
          preparationSteps: [
            'Soak rice noodles',
            'Prepare sauce',
            'Stir-fry aromatics',
        ...
        }
        {
          ...
          tools: ['steamer', 'mortar and pestle', 'serving plate', 'knife', 'cutting board'],
          preparationSteps: [
      ...
      summer: [
        {
          ...
          tools: ['ice shaver', 'saucepans', 'strainer', 'serving bowls', 'measuring cups'],
          preparationSteps: [
      ...
      winter: [
        {
          ...
          tools: ['large pot', 'wooden spoon', 'knife', 'cutting board', 'measuring spoons'],
          preparationSteps: [
            'Brown beef chunks',
            'Fry curry paste',
            'Add coconut milk',
        ...
        }
        {
          ...
          tools: ['wok or large pot', 'wooden spoon', 'knife', 'cutting board', 'measuring spoons'],
          preparationSteps: [
            'Heat coconut cream',
            'Fry curry paste',
    ...
    dessert: {
      all: [
        ...
        }
        {
          ...
          tools: ['sharp knife', 'saucepan', 'strainer', 'mixing bowls', 'serving glasses'],
          preparationSteps: [
        ...
        }
        {
          ...
          tools: ['mixing bowls', 'saucepan', 'slotted spoon', 'measuring cups', 'whisk'],
          preparationSteps: [
        ...
        }
        {
          ...
          tools: ['steamer', 'mixing bowls', 'whisk', 'knife', 'measuring cups'],
          preparationSteps: [
            'Prepare pumpkin',
      ...
      all: [
        {
          ...
          tools: ['deep fryer or wok', 'mixing bowls', 'whisk', 'spider strainer', 'paper towels'],
          preparationSteps: [
            'Prepare batter',
            'Coat bananas',
            'Heat oil',
