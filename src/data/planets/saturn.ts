...
const saturnData: PlanetData = {
  ...
  AstronomicalData: {
    ...
    PhysicalCharacteristics: {
      Surface:
        "Gas giant with no solid surface, characterized by subtle bands and periodic storms",
  ...
  PlanetSpecific: {
    ZodiacTransit: {
      capricorn: {
        FoodFocus:
          "Traditional, structured dishes with aged ingredients and earthy flavors",
        Elements: {
          Fire: 0.1,
          Earth: 0.9,
          Air: 0.2,
      ...
      libra: {
        FoodFocus:
          "Balanced traditional dishes with careful attention to structure and proportion",
        Elements: {
          Fire: 0.1,
          Earth: 0.4,
          Air: 0.7,
