...
const uranusData: PlanetData = {
  ...
  AstronomicalData: {
    ...
    PhysicalCharacteristics: {
      ...
      NotableFeatures:
        "Extreme axial tilt, complex ring system, unusual sideways rotation",
    },
  },
  ...
  ElementalConnections: {
    ...
    ElementalBridges: [
      ...
      "Electrical conduction through moisture",
    ],
    SharedElements: {
      Neptune: ["Water"],
      Mercury: ["Air"],
  ...
  PlanetSpecific: {
    ZodiacTransit: {
      ...
      scorpio: {
        ...
        FlavorCombinations:
          "Intense contrasts, transformed flavors, deep unexpected harmonies",
      },
      gemini: {
        FoodFocus:
