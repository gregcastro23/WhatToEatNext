...
const marsData: PlanetData = {
  ...
  PlanetSpecific: {
    ZodiacTransit: {
      aries: {
        FoodFocus:
          "Bold, spicy dishes with intense flavors and quick cooking methods",
        Elements: {
          Fire: 0.9,
          Earth: 0.1,
          Air: 0.2,
      ...
      taurus: {
        FoodFocus:
          "Rich, hearty dishes with profound flavor intensity and substantial texture",
        Elements: {
          Fire: 0.5,
          Earth: 0.7,
          Air: 0.1,
      ...
      gemini: {
        FoodFocus:
          "Dual cooking methods, contrasting spice levels, quick-shifting flavor profiles",
        Elements: {
          Fire: 0.6,
          Earth: 0.1,
          Air: 0.7,
      ...
      leo: {
        FoodFocus:
          "Dramatic, fiery presentations, bold centerpiece dishes, primal cooking methods",
        Elements: {
          Fire: 0.9,
          Earth: 0.2,
          Air: 0.3,
      ...
      capricorn: {
        FoodFocus:
          "Traditional cooking with disciplined heat, achievement-oriented complexity",
        Elements: {
          Fire: 0.4,
          Earth: 0.8,
          Air: 0.1,
    ...
    Retrograde: {
      ...
      HerbalShift:
        "Emphasis on dried herbs and spices, concentrated extracts, intensified flavors",
    },
    TransitDates: {
    ...
    MealTypes: {
      ...
      Snacks: {
        ...
        Recommendations: [
          ...
          "jerky",
          "bold finger foods",
          "intense flavored crisps",
        ],
      },
    },
    LunarConnection:
      "Antagonistic water interaction but complementary with Moon in fire signs",
    CulinaryTemperament: {
      FireMars: {
        FoodFocus:
          "Explosive flavor combinations, primal cooking techniques, bold presentations",
        Recommendations: [
          "Open flame cooking",
          "Flash searing",
          "Spicy marinades",
