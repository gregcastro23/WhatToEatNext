  ...
  PlanetSpecific: {
    Mercury: {
      ...
      ZodiacInfluence: {
        gemini: {
          CulinaryEffect:
            "Enhances versatility in cooking, good for fusion cuisine",
        ...
        virgo: {
          CulinaryEffect:
            "Increases precision and attention to detail in cooking",
          RecommendedTechniques: [
            "detailed garnishing",
            "precise baking",
        ...
        pisces: {
          CulinaryEffect:
            "Can cause confusion in recipes, but increases intuitive cooking",
          RecommendedTechniques: [
            "infusions",
            "seafood preparation",
      ...
      RetrogradeCycle: {
        PreShadow: {
          Duration: "2 weeks",
          CulinaryEffect:
            "Begin simplifying recipes, check ingredients carefully",
          Recommendation: "Start preparing make-ahead meals and batch cooking",
        },
        Retrograde: {
          Duration: "3 weeks",
          CulinaryEffect:
            "Communication breakdowns affect recipe following, unexpected results",
          Recommendation:
            "Use tried and true recipes, avoid complex new techniques",
        },
        PostShadow: {
          Duration: "2 weeks",
          CulinaryEffect:
            "Gradually return to normal cooking patterns, integrate lessons learned",
          Recommendation:
            "Revisit and perfect recipes that had issues during retrograde",
        },
      },
    },
    ZodiacTransit: {
      gemini: {
        FoodFocus:
          "Diverse, light dishes with multiple flavor notes and interesting combinations",
        Elements: {
          Fire: 0.2,
          Earth: 0.1,
          Air: 0.9,
      ...
      cancer: {
        FoodFocus:
          "Thoughtful comfort food with precise seasoning and nostalgic elements",
        Elements: {
          Fire: 0.1,
          Earth: 0.2,
          Air: 0.4,
    ...
    TransitDates: {
      RetrogradePhases: {
        ...
        Retrograde2024Q4: {
          ...
          CulinaryEffect:
            "Reassess traditional holiday recipes, reconnect with food heritage",
        },
        Retrograde2025Q1: {
          ...
          Signs: ["Aries", "Pisces"],
          CulinaryEffect:
            "Balance impulsive cooking urges, revisit intuitive cooking approaches",
        },
      },
      DirectPhasesQ2_2024: {
