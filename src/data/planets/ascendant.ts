...
const ascendantData: PlanetData = {
  ...
  PlanetSpecific: {
    SignInfluence: {
      ...
      taurus: {
        FoodFocus:
          "Sensual eating experiences, rich foods, appreciation for quality ingredients",
        Elements: {
          Fire: 0.2,
          Earth: 0.8,
          Air: 0.1,
      ...
      gemini: {
        FoodFocus:
          "Variety in meals, interest in food knowledge, enjoyment of food conversation",
        Elements: {
          Fire: 0.3,
          Earth: 0.1,
          Air: 0.8,
      ...
      cancer: {
        FoodFocus:
          "Emotional connection to food, nurturing meals, traditional family recipes",
        Elements: {
          Fire: 0.1,
          Earth: 0.3,
          Air: 0.1,
      ...
      leo: {
        FoodFocus:
          "Dramatic presentations, generous portions, celebratory dining experiences",
        Elements: {
          Fire: 0.8,
          Earth: 0.2,
          Air: 0.3,
      ...
      libra: {
        FoodFocus:
          "Beautiful presentation, balanced flavors, social dining experiences",
        Elements: {
          Fire: 0.2,
          Earth: 0.2,
          Air: 0.8,
      ...
      scorpio: {
        FoodFocus:
          "Intense flavors, mysterious ingredients, transformative cooking methods",
        Elements: {
          Fire: 0.3,
          Earth: 0.2,
          Air: 0.1,
      ...
      sagittarius: {
        FoodFocus:
          "International cuisines, adventurous eating, philosophical approach to food",
        Elements: {
          Fire: 0.8,
          Earth: 0.1,
          Air: 0.4,
      ...
      capricorn: {
        FoodFocus:
          "Traditional recipes, disciplined approach to meals, quality over quantity",
        Elements: {
          Fire: 0.1,
          Earth: 0.8,
          Air: 0.2,
      ...
      pisces: {
        FoodFocus:
          "Intuitive cooking, creative presentations, ethereal flavors and experiences",
        Elements: {
          Fire: 0.1,
          Earth: 0.1,
          Air: 0.2,
