import { ZodiacAffinity, createZodiacAffinity, ZODIAC_MODALITIES, _Modality } from '@/types/zodiacAffinity';
 ...
 */
export const zodiacCulinaryPreferences: Record<ZodiacSign, {
  ...
  aries: {
    ...
    favoredIngredients: ['chili peppers', 'garlic', 'ginger', 'red meat', 'tomatoes', 'onions', 'lamb', 'cinnamon', 'cayenne'],
    favoredFlavors: ['spicy', 'bold', 'tangy', 'smoky', 'pungent', 'intense'],
    favoredCookingMethods: ['grilling', 'roasting', 'frying', 'broiling', 'high-heat searing', 'flambéing'],
  ...
  taurus: {
    favoredCuisines: ['Italian', 'French', 'Greek', 'Swiss', 'Argentinian', 'Provençal', 'Southern American'],
    favoredIngredients: ['cheese', 'butter', 'root vegetables', 'beef', 'mushrooms', 'bread', 'potatoes', 'truffles', 'chocolate', 'cream'],
    favoredFlavors: ['rich', 'sweet', 'earthy', 'umami', 'creamy', 'buttery', 'savory'],
    favoredCookingMethods: ['slow cooking', 'baking', 'braising', 'roasting', 'confit', 'caramelizing'],
    seasonalPreferences: ['autumn', 'harvest foods', 'aged delicacies', 'traditional seasonal staples'],
  ...
  gemini: {
    favoredCuisines: ['Fusion', 'Vietnamese', 'Spanish', 'Tapas', 'Street food', 'Korean-Mexican', 'California cuisine'],
    favoredIngredients: ['fresh herbs', 'citrus', 'vegetables', 'seafood', 'berries', 'sprouts', 'unusual combinations', 'edible flowers'],
    favoredFlavors: ['light', 'varied', 'bright', 'complex', 'layered', 'contrasting', 'surprising'],
    favoredCookingMethods: ['stir-frying', 'steaming', 'raw preparations', 'quick sautéing', 'mixing methods', 'pickling'],
  ...
  cancer: {
    favoredCuisines: ['Japanese', 'American', 'Homestyle', 'Coastal', 'Polish', 'Irish', 'Southern comfort food'],
    favoredIngredients: ['seafood', 'dairy', 'comfort foods', 'rice', 'potatoes', 'broths', 'heritage grains', 'family recipes'],
    favoredFlavors: ['comforting', 'traditional', 'subtle', 'nostalgic', 'soothing', 'familiar'],
    favoredCookingMethods: ['steaming', 'boiling', 'slow cooking', 'simmering', 'poaching', 'baking'],
  ...
  leo: {
    favoredCuisines: ['Mediterranean', 'Moroccan', 'Brazilian', 'French fine dining', 'Peruvian', 'Lebanese', 'Luxury fusion'],
    favoredIngredients: ['expensive cuts', 'saffron', 'honey', 'gold leaf', 'truffles', 'wagyu beef', 'foie gras', 'champagne'],
    favoredFlavors: ['rich', 'indulgent', 'exotic', 'vibrant', 'memorable', 'impressive'],
    favoredCookingMethods: ['grilling', 'roasting', 'flambé', 'tableside preparation', 'showcase techniques', 'artistic plating'],
  ...
  virgo: {
    favoredCuisines: ['Japanese', 'Korean', 'Farm-to-table', 'Nordic', 'German', 'Vegan', 'Health-focused'],
    favoredIngredients: ['whole grains', 'fresh vegetables', 'herbs', 'lean proteins', 'seeds', 'fermented foods', 'precise ingredients'],
    favoredFlavors: ['clean', 'precise', 'balanced', 'pure', 'refined', 'subtle'],
    favoredCookingMethods: ['steaming', 'fermentation', 'precision cooking', 'sous vide', 'dehydrating', 'proper technique'],
    seasonalPreferences: ['late summer', 'harvest', 'precision seasonal eating'],
    nutritionalFocus: ['digestive health', 'balanced nutrition', 'medicinal foods', 'precise macronutrients'],
  ...
  libra: {
    favoredCuisines: ['French', 'Thai', 'California Cuisine', 'New American', 'Venetian', 'Contemporary', 'Balanced fusion'],
    favoredIngredients: ['artfully presented foods', 'balanced flavors', 'wine pairings', 'edible flowers', 'artisanal ingredients', 'harmonious combinations'],
    favoredFlavors: ['balanced', 'elegant', 'harmonious', 'complementary', 'sophisticated', 'refined'],
    favoredCookingMethods: ['sous vide', 'careful sautéing', 'artful plating', 'balanced techniques', 'color-conscious preparation'],
  ...
  scorpio: {
    favoredCuisines: ['Mexican', 'Korean', 'Cajun', 'North African', 'Indonesian', 'Caribbean', 'Scottish'],
    favoredIngredients: ['fermented foods', 'dark chocolate', 'seafood', 'mushrooms', 'game meats', 'offal', 'blood sausage', 'intense spices'],
    favoredFlavors: ['intense', 'complex', 'mysterious', 'deep', 'transformative', 'fermented', 'aged'],
    favoredCookingMethods: ['smoking', 'fermenting', 'slow cooking', 'curing', 'aging', 'sous vide', 'charring'],
  ...
  sagittarius: {
    favoredCuisines: ['Indian', 'Middle Eastern', 'Caribbean', 'Ethiopian', 'Polynesian', 'South American', 'Adventurous fusion'],
    favoredIngredients: ['exotic spices', 'game meats', 'international ingredients', 'unusual fruits', 'rare herbs', 'diverse grains', 'global discoveries'],
    favoredFlavors: ['bold', 'adventurous', 'varied', 'global', 'spiced', 'expansive', 'cross-cultural'],
    favoredCookingMethods: ['grilling', 'open fire cooking', 'experimental techniques', 'foreign methods', 'high-adventure cooking'],
    seasonalPreferences: ['global seasonal variations', 'cross-cultural seasonal celebrations'],
    nutritionalFocus: ['diverse nutrients', 'superfoods', 'travel-supporting nutrition', 'adaptogenic herbs'],
  ...
  capricorn: {
    favoredCuisines: ['Traditional French', 'German', 'Classic American', 'British', 'Alpine', 'Russian', 'Classic steakhouse'],
    favoredIngredients: ['root vegetables', 'aged meats', 'hearty grains', 'traditional herbs', 'quality staples', 'bone broths', 'traditional preserves'],
    favoredFlavors: ['traditional', 'rich', 'substantial', 'time-tested', 'authentic', 'structured', 'classic'],
    favoredCookingMethods: ['slow cooking', 'baking', 'traditional methods', 'braising', 'classic techniques', 'aging'],
  ...
  aquarius: {
    favoredCuisines: ['Modernist', 'Fusion', 'Plant-based', 'Molecular', 'Future foods', 'Sustainable cuisine', 'Technological food'],
    favoredIngredients: ['unusual ingredients', 'ancient grains', 'molecular components', 'sustainable proteins', 'innovative substitutes', 'food tech', 'rare plant varieties'],
    favoredFlavors: ['unexpected', 'innovative', 'unconventional', 'futuristic', 'progressive', 'idealistic', 'cerebral'],
    favoredCookingMethods: ['molecular gastronomy', 'innovative techniques', 'unconventional pairings', 'technological cooking', 'scientific methods'],
    seasonalPreferences: ['future foods', 'climate-adaptive ingredients', 'sustainable options'],
    nutritionalFocus: ['cognitive function', 'innovative supplements', 'sustainability', 'ethical nutrition'],
  ...
  pisces: {
    favoredCuisines: ['Coastal', 'Nordic', 'Asian', 'Island', 'Scandinavian', 'Pacific Rim', 'Seafood-focused'],
    favoredIngredients: ['seafood', 'delicate herbs', 'subtle flavors', 'exotic teas', 'edible flowers', 'seaweed', 'ethereal textures', 'aromatic wines'],
    favoredFlavors: ['subtle', 'ethereal', 'dreamy', 'delicate', 'mystical', 'flowing', 'intuitive'],
    favoredCookingMethods: ['poaching', 'steaming', 'gentle cooking methods', 'infusing', 'marinating', 'aromatic cooking'],
 ...
 */
export const modalityIngredientPreferences: Record<Modality, {
  proteins: string[];
  vegetables: string[];
  fruits: string[];
  herbs: string[];
  ...
  mutable: {
    ...
    preparations: ['multiple techniques', 'fusion methods', 'variable cooking times', 'adaptive recipes']
  }
};
 ...
 */
export const zodiacSeasonalAffinities: Record<ZodiacSign, {
  spring: number;
  summer: number;
  autumn: number;
  winter: number;
  ...
  aries: {
    ...
    autumn: 0.4,
    winter: 0.3,
    bestSeasonalIngredients: ['spring lambs', 'asparagus', 'radishes', 'spring onions', 'fresh herbs']
  },
  taurus: {
    spring: 0.7,
    summer: 0.6,
    autumn: 0.9,
    winter: 0.5,
    bestSeasonalIngredients: ['spring vegetables', 'strawberries', 'fresh cheeses', 'early root vegetables']
  },
  gemini: {
    spring: 0.8,
    summer: 0.7,
  ...
  leo: {
    ...
    autumn: 0.6,
    winter: 0.3,
    bestSeasonalIngredients: ['summer berries', 'stone fruits', 'heirloom tomatoes', 'grilling vegetables']
  },
  virgo: {
    spring: 0.5,
    summer: 0.7,
    autumn: 0.9,
    winter: 0.4,
    bestSeasonalIngredients: ['harvest grains', 'late summer vegetables', 'early apples', 'herbs at peak']
  },
  libra: {
    spring: 0.5,
    summer: 0.6,
  ...
  sagittarius: {
    ...
    autumn: 0.7,
    winter: 0.9,
    bestSeasonalIngredients: ['winter spices', 'exotic imports', 'hearty vegetables', 'aged ingredients']
  },
  capricorn: {
    spring: 0.3,
    summer: 0.4,
    autumn: 0.7,
    winter: 0.9,
    bestSeasonalIngredients: ['winter roots', 'preserved items', 'hearty greens', 'stored harvest goods']
  },
  aquarius: {
    spring: 0.5,
    summer: 0.3,
    autumn: 0.6,
    winter: 0.9,
    bestSeasonalIngredients: ['winter citrus', 'greenhouse innovations', 'stored technology foods', 'preserved rarities']
  },
  pisces: {
    spring: 0.8,
    summer: 0.5,
    autumn: 0.4,
    winter: 0.7,
    bestSeasonalIngredients: ['early spring seafood', 'snow peas', 'delicate greens', 'transition seasonal items']
  }
};
...
export const modalityCookingTechniques: Record<Modality, string[]> = {
  cardinal: ['grilling', 'searing', 'stir-frying', 'quick cooking techniques', 'blanching', 'broiling', 'direct heat methods', 'initiative cooking'],
  fixed: ['slow roasting', 'braising', 'sous vide', 'consistent temperature techniques', 'smoking', 'fermenting', 'aging', 'preserving', 'endurance cooking'],
  mutable: ['steaming', 'poaching', 'adaptable cooking', 'fusion techniques', 'variable methods', 'combination cooking', 'multi-step preparations', 'flexible timing']
};

/**
 * Get recommended cooking techniques based on zodiac sign
 */
export function getCookingTechniquesForSign(sign: ZodiacSign): string[] {
 ...
 */
export const zodiacMealTimingPreferences: Record<ZodiacSign, {
  breakfast: number;
  lunch: number;
  dinner: number;
  snacking: number;
  ...
  aries: { breakfast: 0.8, lunch: 0.6, dinner: 0.7, snacking: 0.4, idealEatingHours: 'Early morning and midday when energy is highest' },
  taurus: { breakfast: 0.6, lunch: 0.7, dinner: 0.9, snacking: 0.8, idealEatingHours: 'Leisurely evening meals, appreciating dinner fully' },
  gemini: { breakfast: 0.5, lunch: 0.7, dinner: 0.6, snacking: 0.9, idealEatingHours: 'Multiple small meals throughout the day' },
  cancer: { breakfast: 0.7, lunch: 0.6, dinner: 0.9, snacking: 0.7, idealEatingHours: 'Evening family meals, breakfast comfort foods' },
  leo: { breakfast: 0.5, lunch: 0.7, dinner: 0.9, snacking: 0.6, idealEatingHours: 'Prime dinner time when attention can be focused' },
  virgo: { breakfast: 0.8, lunch: 0.7, dinner: 0.6, snacking: 0.5, idealEatingHours: 'Regular, precisely timed meals throughout day' },
  libra: { breakfast: 0.6, lunch: 0.8, dinner: 0.9, snacking: 0.5, idealEatingHours: 'Social lunch and dinner times with company' },
  scorpio: { breakfast: 0.4, lunch: 0.6, dinner: 0.9, snacking: 0.7, idealEatingHours: 'Evening and late night when atmosphere is intense' },
  sagittarius: { breakfast: 0.7, lunch: 0.8, dinner: 0.7, snacking: 0.8, idealEatingHours: 'Varied meal times, adaptable to adventure' },
  capricorn: { breakfast: 0.8, lunch: 0.7, dinner: 0.8, snacking: 0.3, idealEatingHours: 'Traditional meal times adhered to strictly' },
  aquarius: { breakfast: 0.6, lunch: 0.5, dinner: 0.7, snacking: 0.8, idealEatingHours: 'Unconventional eating schedule, meal timing experiments' },
  pisces: { breakfast: 0.5, lunch: 0.6, dinner: 0.8, snacking: 0.7, idealEatingHours: 'Flowing meal times that follow intuition rather than clock' }
};
 ...
 */
export function calculateRecipeZodiacCompatibility(mainIngredientSign: ZodiacSign, preparationMethodSign: ZodiacSign): number {
  // Get modalities
