import type { ElementalAffinity, Season } from "@/types/alchemy";
...
export const _seasonalData = {
  ...
  getSeasonalElement: (season: Season) =>
    seasonalElements[season].primary || "Air",
  getSeasonalStrength: (season: Season) =>
    seasonalElements[season].strength || 0.5,
  getSeasonalCompatibility: (season: Season) =>
    seasonalElements[season].compatibility || {
      Fire: 0.7,
      Water: 0.7,
      Earth: 0.7,
      Air: 0.7,
