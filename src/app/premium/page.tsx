 ...
 * and a feature comparison table across tiers.
 *
...
const TIER_ORDER: SubscriptionTier[] = ["starter", "premium", "cosmic"];
...
> = {
  ...
  cosmic: {
    ...
    badge: "bg-gradient-to-r from-amber-200 to-yellow-200 text-amber-900",
    glow: "ring-2 ring-amber-300 shadow-lg shadow-amber-100",
  },
};
...
export default function PremiumPage() {
  ...
  useEffect(() => {
    ...
    if (checkoutStatus === "success") {
      setCheckoutMessage("Your subscription is now active! Welcome aboard.");
      refresh();
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 font-medium">Loading your cosmic plan...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-amber-50">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-black mb-3 bg-gradient-to-r from-purple-600 via-pink-600 to-amber-600 bg-clip-text text-transparent">
            Alchm Kitchen Premium
          </h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Unlock the full power of cosmic culinary alchemy. Choose the plan that
            aligns with your celestial appetite.
          </p>
        </div>
              ...
              <div>
                ...
                <p className="text-slate-500">
                  {tier === "starter"
                    ...
                    : `${TIER_LIMITS[tier].price}/month - Full cosmic access`}
                </p>
              </div>
          ...
          {TIER_ORDER.map((t) => {
            ...
            return (
              ...
              >
                ...
                {t === "cosmic" && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-bold uppercase tracking-wider rounded-full">
                    Best Value
                  </div>
                )}
                ...
                {isCurrent ? (
                  ...
                  >
                    {t === "starter" ? "Downgrade" : "Upgrade"}
                  </button>
                ) : (
                  <a
                    href="/login"
                    className="block w-full py-3 rounded-xl bg-slate-700 text-white font-bold text-center hover:bg-slate-800 transition-all"
                  >
