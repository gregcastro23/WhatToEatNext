...
const alchemicalEngine = {
  alchemize: (
    ...
    try {
      ...
      const extendedHoroscope = {
        ...
        tropical: {
          CelestialBodies:
            tropical?.CelestialBodies ||
            (horoscopeDict as any).CelestialBodies ||
            {},
          Ascendant:
            tropical?.Ascendant || (horoscopeDict as any).Ascendant || {},
      ...
      if (
        ...
        error.message.includes("Assignment to constant")
      ) {
  ...
  calculateCurrentPlanetaryPositions: async (): Promise<
