...
export default function CookingMethodsDemoPage() {
  ...
  const formatMethodsForComponent = (
    methodsObj: Record<string, unknown>,
    prefix: string
  ) => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Typography variant="body1" paragraph align="center" sx={{ mb: 5 }}>
        This page demonstrates the CookingMethodsSection component with updated
        styling to match the ingredient recommender.
      </Typography>
