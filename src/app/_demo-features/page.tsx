...
const PlanetaryHourDisplay = dynamic(() => import('@/components/PlanetaryHourDisplay').then(mod => mod.PlanetaryHourDisplay), { ssr: false });
const EnhancedRecommendationEngine = dynamic(() => import('@/components/EnhancedRecommendationEngine').then(mod => mod.EnhancedRecommendationEngine), { ssr: false });
const EnergyVisualization = dynamic(() => import('@/components/EnergyVisualization').then(mod => mod.EnergyVisualization), { ssr: false });
const CelestialEventNotifications = dynamic(() => import('@/components/CelestialEventNotifications').then(mod => mod.CelestialEventNotifications), { ssr: false });
