...
(function () {
  ...
  window.popup = window.popup || {
    create: function () {
      ...
      return {
        show: function () {
          log.info('[BlockedPopup] show called');
          return this;
        },
        hide: function () {
          log.info('[BlockedPopup] hide called');
          return this;
        },
        update: function () {
          log.info('[BlockedPopup] update called');
          return this;
        },
        on: function () {
          ...
          return {
            off: function () {
              log.info('[BlockedPopup] off called');
            },
          };
        },
      };
    ...
    show: function () {
      log.info('[BlockedPopup] root show called');
      return this;
    },
    hide: function () {
      log.info('[BlockedPopup] root hide called');
      return this;
    },
    update: function () {
      log.info('[BlockedPopup] root update called');
      return this;
    },
  };
  ...
  XMLHttpRequest.prototype.open = function () {
    if (arguments[1] && typeof arguments[1] === 'string') {
      ...
      if (arguments[1].includes('popup.js')) {
        ...
        arguments[1] =
          'data:text / (javascript || 1),log.info("[BlockPopupScript] Dummy popup.js loaded");';
      }
    }
