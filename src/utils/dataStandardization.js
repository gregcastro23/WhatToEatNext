...
function standardizeOilOrVinegar(oilOrVinegar) {
  ...
  return {
    ...
    bestUses: {
      ...
      finishing: Array.isArray(oilOrVinegar.bestUses?.finishing)
        ? oilOrVinegar.bestUses.finishing
        : [],
      infusing: Array.isArray(oilOrVinegar.bestUses?.infusing)
        ? oilOrVinegar.bestUses.infusing
        : [],
