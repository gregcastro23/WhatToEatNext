...
export function getTechnicalTips(methodName: string): string[] {
  ...
  switch (methodLower) {
    ...
    case "hand_pounding":
      ...
      tips.push(
        "Add ingredients gradually in small batches, working from driest to most moist",
      );
      tips.push(
    ...
    case "simmering":
      ...
      tips.push(
        "Position tougher ingredients at the bottom where heat is more concentrated",
      );
      tips.push(
        "Periodically skim surface impurities for clearer, cleaner-tasting results",
      );
      tips.push(
    ...
    case "clay pot cooking":
      ...
      tips.push(
        "Always start with low heat and gradually increase to prevent thermal shock",
      );
      tips.push(
    ...
    case "grilling":
      ...
      tips.push(
        "Allow charcoal to develop white ash coating before cooking for consistent heat",
      );
      tips.push(
      ...
      tips.push(
        "For longer cooks, arrange coals in a ring around the perimeter for indirect heat",
      );
      tips.push(
        "Use the hand test to gauge, temperature: 3 seconds (high), 5 seconds (medium), 7 seconds (low)",
      );
      tips.push(
        "Oil the food not the grill to prevent sticking and reduce flare-ups",
      );
      break;
    ...
    case "fermenting":
      ...
      tips.push(
        "Maintain consistent temperature (65-75°F/18-24°C for most vegetable ferments)",
      );
      tips.push(
        "Use appropriate salt concentration (2-3% by weight) for vegetable fermentation",
      );
      tips.push(
        "Keep fermenting foods submerged under brine using weights to prevent mold",
      );
      tips.push(
    ...
    case "steaming":
      tips.push(
        "Ensure water doesn't touch the food - keep water level below the steamer basket",
      );
      tips.push(
        "Add herbs, citrus peel or spices to the steaming water for aromatic infusion",
      );
      tips.push(
        "Arrange foods with longest cooking times at the bottom of multi-tier steamers",
      );
      tips.push("Leave space between food pieces for steam circulation");
      tips.push(
        "Monitor water level to prevent boiling dry, adding more hot water as needed",
      );
      tips.push(
    ...
    case "stir-frying":
      ...
      tips.push(
        "Use high smoke-point oils like peanut, avocado, or refined coconut oil",
      );
      tips.push(
    ...
    case "fire cooking":
      ...
      tips.push(
        "Rotate food frequently for even cooking, especially when using direct heat",
      );
      tips.push(
        "For basting, apply flavored liquids during final stages to prevent burning",
      );
      tips.push(
        "Use hardwoods (oak, maple, hickory) for longer burning coals and minimal smoke",
      );
      break;
    ...
    case "sous_vide":
      ...
      tips.push(
        "Pat proteins completely dry before post-cooking sear to ensure proper browning",
      );
      tips.push(
    ...
    case "smoking":
      ...
      tips.push(
        "Allow properly smoked meats to rest wrapped in butcher paper before serving",
      );
      tips.push(
    ...
    case "pressure_cooking":
      tips.push(
        "Brown proteins and sauté aromatics before sealing for deeper flavor development",
      );
      tips.push(
        "Respect the maximum fill line—overfilling can block pressure release valves",
      );
      tips.push(
        "For quick-release recipes, point steam release away from cabinets and people",
      );
      tips.push(
        "Calculate liquid needed based on cooking time—longer cooks need more liquid",
      );
      tips.push(
    ...
    case "dutch oven cooking":
      ...
      tips.push(
        "When baking bread, preheat the dutch oven and lid separately for 30-45 minutes",
      );
      tips.push(
    ...
    case "baking":
      ...
      tips.push(
        "Room temperature ingredients incorporate more evenly and provide better texture",
      );
      tips.push(
        "Weigh ingredients rather than measuring by volume for consistent results",
      );
      tips.push(
        "Rotate baking sheets halfway through cooking for even browning",
      );
      tips.push(
        "For bread and pastry, create steam in the oven by using a water pan or ice cubes",
      );
      tips.push(
    ...
    case "boiling":
      ...
      tips.push(
        "For pasta and rice, use ample water (4-6 quarts per pound) to prevent sticking",
      );
      tips.push(
        "Start with cold water for stocks and when cooking food to temperature rather than time",
      );
      tips.push(
        "Start with hot water when blanching vegetables to minimize nutrient loss",
      );
      tips.push(
        "For eggs, reduce to a bare simmer after reaching boil to prevent cracking",
      );
      tips.push(
        "Blanch green vegetables briefly (30-90 seconds), then shock in ice water to preserve color",
      );
      tips.push(
        "Skim foam from stocks and broths regularly for clearer, cleaner final results",
      );
      break;
    ...
    case "frying":
      ...
      tips.push(
        "Maintain oil temperature between 350-375°F (175-190°C) for optimal results",
      );
      tips.push(
        "Avoid overcrowding the fryer—food should have room to float freely",
      );
      tips.push(
        "Dry food thoroughly before frying to prevent dangerous oil splatter",
      );
      tips.push(
        "Use a spider or slotted spoon to remove food, allowing excess oil to drain back into the pot",
      );
      tips.push(
        "Filter and reuse oil up to 3-4 times, storing away from light and heat",
      );
      tips.push(
        "Use a kitchen thermometer to monitor oil temperature, adjusting heat as needed",
      );
      break;

    case "sauteing":
      tips.push(
        "Use a pan with good heat conductivity and a flat bottom for even cooking",
      );
      tips.push(
        "Heat the pan before adding oil to prevent sticking and ensure proper sear",
      );
      tips.push(
      ...
      tips.push(
        "Finish with butter for rich flavor and glossy sauce (monte au beurre)",
      );
      tips.push(
    ...
    case "poaching":
      ...
      tips.push(
        "Use flavorful liquids (court bouillon, stock, wine) for more complex results",
      );
      tips.push(
      ...
      tips.push(
        "Cover partially to maintain even temperature throughout the cooking process",
      );
      tips.push(
        "Use a shallow poaching method for flat items like fish fillets to ensure even cooking",
      );
      tips.push(
        "For fruits, create a flavored syrup with complementary spices and aromatics",
      );
      break;
    ...
    case "distilling":
      ...
      tips.push(
        "Collect the 'hearts' (middle portion) of the distillation for purest flavor",
      );
      tips.push(
      ...
      tips.push(
        "Keep accurate records of temperature, time, and cuts for reproducible results",
      );
      break;

    case "emulsification":
      tips.push(
        "Ensure all ingredients are at the same temperature for stable emulsions",
      );
      tips.push(
        "Add oil or fat in a slow, thin stream while constantly whisking or blending",
      );
      tips.push(
        "Use natural emulsifiers like egg yolks, mustard, or lecithin to help bind incompatible ingredients",
      );
      tips.push(
        "For cold emulsions like mayonnaise, chill equipment before starting",
      );
      tips.push(
        "If an emulsion begins to break, stop adding oil and incorporate a small amount of water while whisking vigorously",
      );
      tips.push(
        "For maximum stability, use high-speed blending with minimal air incorporation",
      );
      tips.push(
    ...
    case "gelification":
      tips.push(
        "Bloom gelatin in cold liquid for 5-10 minutes before dissolving in hot liquid",
      );
      tips.push(
      ...
      tips.push(
        "For clearer gels, clarify stock or juice using egg whites or freeze-thaw methods",
      );
      tips.push(
    ...
    case "curing":
      ...
      tips.push(
        "Ensure even distribution of cure mixture by massaging thoroughly into protein",
      );
      tips.push(
      ...
      tips.push(
        "For even results, rotate and flip items regularly throughout the curing process",
      );
      break;

    case "infusing":
      tips.push(
        "Toast spices and herbs briefly before infusing to activate volatile oils",
      );
      tips.push(
      ...
      tips.push(
        "Strain through progressively finer filters for perfectly clear results",
      );
      tips.push(
    ...
    case "marinating":
      ...
      tips.push(
        "For even penetration, pierce meat surfaces or butterfly to increase surface area",
      );
      tips.push(
      ...
      tips.push(
        "Reserve a portion of marinade before adding raw protein for later use as a sauce",
      );
      tips.push(
        "Pat marinated items dry before cooking to ensure proper searing and browning",
      );
      break;

    case "dehydrating":
      tips.push(
        "Maintain consistent airflow around all items by using proper spacing on trays",
      );
      tips.push(
        "Control temperature precisely: 135°F/57°C for fruits, 145°F/63°C for vegetables, 160°F/71°C for meats",
      );
      tips.push(
        "Pretreat fruits with ascorbic acid solution to prevent browning",
      );
      tips.push(
    ...
    case "broiling":
      ...
      tips.push(
        "Preheat broiler for at least 5-10 minutes to ensure maximum radiant heat",
      );
      tips.push(
        "Use broiler-safe cookware—avoid glass, non-stick or cookware with wooden components",
      );
      tips.push(
        "For even browning, start with room temperature ingredients whenever possible",
      );
      tips.push(
    ...
    case "spherification":
      ...
      tips.push(
        "Control acidity: pH 4.0-6.0 works best for sodium alginate reactions",
      );
      tips.push(
        "Allow alginate solutions to rest for 24 hours to remove air bubbles before use",
      );
      tips.push(
    ...
    case "cryo cooking":
      tips.push(
        "Use liquid nitrogen only in well-ventilated areas to prevent oxygen displacement",
      );
      tips.push(
        "Always wear insulated cryo-gloves and face shield to prevent freeze burns",
      );
      tips.push(
        "For rapid freezing, keep items small and uniform in size for even results",
      );
      tips.push(
      ...
      tips.push(
        "Allow frozen items to temper slightly before serving to enhance flavor release",
      );
      break;
    ...
    default:
      ...
      try {
        ...
        if (methodObj.expertTips && Array.isArray(methodObj.expertTips)) {
          ...
          tips.push(
            `Maintain appropriate temperature control for ${methodName}`,
          );
          tips.push(`Properly prepare ingredients before ${methodName}`);
          tips.push(
            `Monitor the ${methodName} process consistently for best results`,
          );
...
export function getIdealIngredients(methodName: string): string[] {
  ...
  switch (methodLower) {
    ...
    case "stir-frying":
      ingredients.push(
        "Proteins cut into bite-sized pieces (chicken, beef, pork, tofu)",
      );
    ...
    case "sous_vide":
      ...
      ingredients.push(
        "Vegetables that benefit from precise doneness (carrots, asparagus)",
      );
    ...
    case "baking":
      ingredients.push(
        "Flour (varying protein levels for different applications)",
      );
    ...
    default:
      ...
      try {
        ...
        if (methodObj.suitable_for && Array.isArray(methodObj.suitable_for)) {
          ...
          methodObj.suitable_for.forEach((ingredient: string) =>
