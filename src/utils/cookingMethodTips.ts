...
export function getTechnicalTips(methodName: string): string[] {
  ...
  switch(methodLower) {
    ...
    case 'slow simmering':
    case 'simmering':
      tips.push("Maintain temperature between 180-200°F (82-93°C) with gentle bubbles breaking the surface every few seconds");
      tips.push("Use a heavy-bottomed pot for even heat distribution to prevent hot spots and scorching");
      tips.push("Cover partially to allow some evaporation for flavor concentration while retaining most moisture");
      ...
      tips.push("For maximum flavor extraction, maintain 3-4 hours of gentle simmering for stocks and broths");
      break;
    ...
    case 'grilling':
      ...
      tips.push("Use the hand test to gauge temperature: 3 seconds (high), 5 seconds (medium), 7 seconds (low)");
    ...
    case 'fermenting':
      ...
      tips.push("For optimal fermentation, use filtered water to avoid chlorine which inhibits beneficial bacteria");
      tips.push("Use an airlock system for long fermentations to allow gases to escape while preventing oxygen entry");
      break;
    ...
    case 'steaming':
      ...
      tips.push("For delicate items like fish, line the steamer with parchment paper or cabbage leaves to prevent sticking");
      break;
    ...
    case 'stir-frying':
      ...
      tips.push("Add aromatics (garlic, ginger) briefly at the beginning for 10-15 seconds to flavor the oil");
      tips.push("Incorporate sauces at the final stage, allowing 30 seconds to thicken before serving");
      break;
    ...
    case 'sous_vide':
      ...
      tips.push("For vegetables, higher temperatures (183-185°F/84-85°C) preserve texture while enhancing flavor");
      tips.push("Use an ice bath immediately after cooking if not serving directly to halt the cooking process");
      break;
    ...
    case 'smoking':
      ...
      tips.push("Monitor smoke color: blue-gray smoke is ideal; thick white or black smoke creates bitter flavors");
      tips.push("Use the Texas Crutch (wrapping in foil) to overcome the 'stall' in large meat cuts");
      break;
    ...
    case 'pressure_cooking':
      ...
      tips.push("Allow 10-15 minutes of natural pressure release for large cuts of meat to prevent moisture loss");
      tips.push("When converting traditional recipes, reduce liquid by 25-30% as pressure cooking limits evaporation");
      break;
    ...
    case 'roasting':
      tips.push("Truss larger cuts and poultry to ensure even cooking and an attractive final presentation");
      tips.push("Use a rack to elevate food above drippings for even heat circulation and crisp exteriors");
      tips.push("Start with high heat (425-450°F/220-230°C) to develop crust, then reduce to finish cooking (325-350°F/165-175°C)");
      tips.push("Allow meats to rest at room temperature 30-60 minutes before roasting to ensure even cooking");
      tips.push("Use a digital probe thermometer to monitor internal temperature without opening the oven");
      tips.push("Let roasted meats rest uncovered for at least 20% of the total cooking time before carving");
      tips.push("For vegetables, toss in oil and spread in a single layer without crowding to prevent steaming");
      break;
      
    case 'baking':
      tips.push("Calibrate your oven temperature with a separate thermometer, as most ovens are off by 25-50°F");
      ...
      tips.push("Understand your flour's protein content: higher protein for bread, lower for cakes and pastries");
      tips.push("Always cool baked goods on a wire rack to prevent soggy bottoms from condensation");
      break;
      
    case 'boiling':
      tips.push("Salt water properly (1-2 tablespoons per gallon) to enhance flavors and raise the boiling point");
      tips.push("For pasta and rice, use ample water (4-6 quarts per pound) to prevent sticking");
      tips.push("Start with cold water for stocks and when cooking food to temperature rather than time");
      ...
      tips.push("Blanch green vegetables briefly (30-90 seconds), then shock in ice water to preserve color");
      tips.push("Skim foam from stocks and broths regularly for clearer, cleaner final results");
      break;
      
    case 'frying':
      tips.push("Use oils with high smoke points (peanut, refined safflower, avocado) to prevent off flavors");
      ...
      tips.push("Use a spider or slotted spoon to remove food, allowing excess oil to drain back into the pot");
    ...
    case 'sauteing':
      ...
      tips.push("Pat food dry and allow to reach room temperature before sautéing for even cooking");
      tips.push("For delicate items like fish, use a non-stick pan or ensure pan is properly heated before adding food");
      tips.push("Deglaze the pan with wine, stock, or acid to capture caramelized flavors from the fond");
      tips.push("Finish with butter for rich flavor and glossy sauce (monte au beurre)");
      tips.push("When sautéing multiple items, cook them separately then combine to prevent overcrowding");
      break;
      
    case 'poaching':
      tips.push("Maintain liquid temperature between 160-180°F (71-82°C)—small bubbles should just begin to break the surface");
      tips.push("Use flavorful liquids (court bouillon, stock, wine) for more complex results");
      tips.push("For delicate items like eggs and fish, create a whirlpool in the liquid before adding food");
      tips.push("Add acid (vinegar, lemon juice) when poaching eggs to help proteins coagulate faster");
      tips.push("Cover partially to maintain even temperature throughout the cooking process");
      tips.push("Use a shallow poaching method for flat items like fish fillets to ensure even cooking");
      tips.push("For fruits, create a flavored syrup with complementary spices and aromatics");
      break;
      
    case 'braising':
      tips.push("Deeply brown meat before adding liquid to develop foundational flavors through Maillard reaction");
      tips.push("Keep liquid level at 1/2 to 2/3 the height of the ingredients—braising is not boiling");
      tips.push("Maintain a bare simmer (around 200°F/93°C), never allowing liquid to boil vigorously");
      tips.push("For the best texture, allow braised dishes to cool completely in their liquid, then reheat gently");
      tips.push("Remove the lid during the final 30 minutes to reduce sauce and concentrate flavors");
      tips.push("For vegetable braises, check tenderness frequently as they cook more quickly than meats");
      tips.push("Layer aromatics beneath the main ingredient to create a natural rack and prevent scorching");
      break;
      
    case 'distilling':
      tips.push("Maintain precise temperature control to separate elements accurately by boiling point");
      tips.push("For non-alcoholic distillation, use steam distillation to extract volatile compounds");
      tips.push("Discard the 'heads' (first 30ml per liter of distillate) which contain harmful compounds");
      tips.push("Collect the 'hearts' (middle portion) of the distillation for purest flavor");
      tips.push("Allow distilled products to rest for 1-2 weeks before final use to develop flavor complexity");
      tips.push("When concentrating flavors, use vacuum distillation to lower boiling points and preserve delicate compounds");
    ...
    case 'emulsification':
      ...
      tips.push("Use natural emulsifiers like egg yolks, mustard, or lecithin to help bind incompatible ingredients");
      tips.push("For cold emulsions like mayonnaise, chill equipment before starting");
      tips.push("If an emulsion begins to break, stop adding oil and incorporate a small amount of water while whisking vigorously");
      tips.push("For maximum stability, use high-speed blending with minimal air incorporation");
      tips.push("Optimize ingredient ratios: for aioli/mayonnaise, use 1 egg yolk per 3/4 cup oil for stable results");
      break;
      
    case 'gelification':
      tips.push("Bloom gelatin in cold liquid for 5-10 minutes before dissolving in hot liquid");
      tips.push("For plant-based alternatives, agar sets more firmly than gelatin but can break when frozen");
      tips.push("Calculate gelatin strength precisely: 1 sheet (silver) equals about 1g powdered gelatin");
      tips.push("Be aware that acidic ingredients and some fresh fruits (pineapple, kiwi, papaya) contain enzymes that break down gelatin");
      tips.push("For clearer gels, clarify stock or juice using egg whites or freeze-thaw methods");
      tips.push("Control setting temperature: gelatin sets at refrigerator temperature, agar begins setting at 95°F/35°C");
      tips.push("For layered preparations, allow each layer to partially set before adding the next");
      break;
      
    case 'curing':
      tips.push("Calculate salt precisely: use 2-3% salt by weight for short-term cures, 4-6% for long-term preservation");
      tips.push("Add 0.25% pink curing salt (sodium nitrite) for items requiring protection from botulism");
      tips.push("Ensure even distribution of cure mixture by massaging thoroughly into protein");
      tips.push("Maintain consistent temperature and humidity: 50-60°F (10-15°C) and 65-75% humidity for most cures");
      tips.push("Weigh items regularly during curing—most whole muscle cures are complete at 30-35% weight loss");
      tips.push("Allow proper equilibration time after curing before serving (3-7 days for small items)");
    ...
    case 'infusing':
      ...
      tips.push("For cold infusions, increase infusion time (12-24 hours) but retain more delicate flavors");
      tips.push("With hot infusions, maintain temperature below boiling (160-180°F/71-82°C) to avoid bitter compounds");
      tips.push("Use neutral base ingredients (vodka, light oil, simple syrup) to highlight infused flavors");
      tips.push("Factor in ingredient water content when creating infused syrups to maintain proper sugar concentration");
      tips.push("Strain through progressively finer filters for perfectly clear results");
      tips.push("For fat infusions (oils, butter), cool slightly and strain while still warm but not hot");
      break;
      
    case 'marinating':
      tips.push("Balance marinade components: acid, oil, aromatics, and salt in proper proportions");
      tips.push("Use non-reactive containers (glass, stainless steel, food-grade plastic) to prevent metallic flavors");
      tips.push("For even penetration, pierce meat surfaces or butterfly to increase surface area");
      tips.push("Limit acidic marinades to 2 hours maximum to prevent proteins from becoming mushy");
      tips.push("For enzyme marinades (pineapple, papaya), limit contact to 30-60 minutes to prevent over-tenderizing");
    ...
    case 'dehydrating':
      ...
      tips.push("Control temperature precisely: 135°F/57°C for fruits, 145°F/63°C for vegetables, 160°F/71°C for meats");
      tips.push("Pretreat fruits with ascorbic acid solution to prevent browning");
      tips.push("For meat jerky, slice consistently with the grain for chewy texture or against for more tender results");
      tips.push("Rotate trays every 2-3 hours for even drying, especially in non-commercial dehydrators");
      tips.push("Test for doneness with multiple pieces as thickness variations affect drying time");
      tips.push("Allow proper conditioning time (12-24 hours) in airtight containers before final storage");
      break;
      
    case 'broiling':
      tips.push("Position oven rack 3-4 inches from heating element for smaller items, 5-6 inches for larger cuts");
      tips.push("Preheat broiler for at least 5-10 minutes to ensure maximum radiant heat");
      tips.push("Use broiler-safe cookware—avoid glass, non-stick, or cookware with wooden components");
      tips.push("For even browning, start with room temperature ingredients whenever possible");
      tips.push("Keep oven door slightly ajar when broiling to release steam and maintain high, dry heat");
      tips.push("Rotate food halfway through cooking, checking every 1-2 minutes to prevent burning");
      tips.push("For delicate fish, use a two-temperature method: start with low broiler setting, finish on high");
      break;
      
    case 'raw':
      tips.push("Ensure impeccable ingredient quality and freshness—raw preparation highlights rather than masks flavors");
      tips.push("Maintain strict temperature control for items requiring safe cold chain (below 40°F/4°C)");
      tips.push("Use sharp knives and proper cutting technique to avoid bruising and discoloration");
      tips.push("For vegetable preparations, ice water bath restores crispness before final assembly");
      tips.push("Balance acidity carefully to 'cook' proteins without heat in preparations like ceviche");
      tips.push("Apply heat-mimicking techniques selectively: salting, massaging kale/cabbage, acid marination");
      tips.push("Create textural contrast by combining different cutting techniques in the same dish");
      break;
      
    case 'spherification':
      tips.push("For basic spherification (sodium alginate in liquid, calcium bath), use pure ingredients with no calcium");
      tips.push("For reverse spherification (calcium in liquid, alginate bath), suitable for dairy or calcium-rich items");
      ...
      tips.push("For frozen reverse spherification, freeze liquid into half-sphere molds before dipping in alginate");
      tips.push("Control bath time precisely: 1-3 minutes creates flexible spheres with liquid centers");
      tips.push("Rinse completed spheres in clean water to stop the reaction and remove residual sodium alginate");
      break;
    ...
    case 'cryo cooking':
      ...
      tips.push("When freezing creams for ice cream, agitate constantly to create microscopic ice crystals");
      tips.push("With fruits and vegetables, freeze separately on trays before combining to prevent clumping");
      tips.push("For freeze-fracturing, submerge item completely until frozen solid before shattering");
    ...
    default:
      ...
      try {
        ...
        const methodData = allMethods.find(method => 
          method.toLowerCase() === methodLower || 
          methodName.toLowerCase().includes(method.toLowerCase())
        );
        
        const methodObj = methodData as Record<string, unknown>;
