export function calculateMatchScore(
    ...
    for (const element of ['Fire', 'Water', 'Earth', 'Air']) {
        ...
        if (options?.cuisine) {
            try {
                ...
                import('../data/cuisineFlavorProfiles').then(module => {
    ...
    const rawScore = totalWeight > 0 ? similarityScore / totalWeight : 0.5;
