 ...
 */
async function getPositionsFromAPI(): Promise<Record<
  string,
  CelestialPosition
> | null> {
  try {
 ...
 */
function getPositionsFromTransitFiles(): {
 ...
 */
export async function getPlanetaryPositions(): Promise<
 ...
 */
export function logDataSourceTelemetry(
  source: "api" | "cache" | "transit" | "hardcoded",
): void {
