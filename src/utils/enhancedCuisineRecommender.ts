...
export class EnhancedCuisineRecommender {
   ...
   */
  private calculatePlanetaryHourScore(dish: Dish, planetaryHour: PlanetaryHour): number {
   ...
   */
  private calculateAstrologicalScore(dish: Dish, astroState: AstrologicalState): number {
