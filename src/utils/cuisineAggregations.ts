...
/**
 * Default global averages — fallback values when no cuisine data is provided.
 *
 * Real statistics are generated by `scripts/process-all-cuisines.ts` and consumed
 * via `src/utils/cuisineSignatures.generated.ts`. Use those for production paths.
 *
