 ...
 */
export function getCuisineContinent(
  cuisine: CompleteCuisineType,
): ContinentalCuisineType | string {
 ...
 */
export function isPrimaryCuisine(
  cuisine: CompleteCuisineType,
): cuisine is PrimaryCuisineType {
 ...
 */
export function isRegionalCuisine(
  cuisine: CompleteCuisineType,
): cuisine is RegionalCuisineType {
 ...
 */
export function isFusionCuisine(
  cuisine: CompleteCuisineType,
): cuisine is FusionCuisineType {
 ...
 */
export function isDietaryCuisine(
  cuisine: CompleteCuisineType,
): cuisine is DietaryCuisineType {
 ...
 */
export function getPrimaryCuisineFromRegional(
  _regional: RegionalCuisineType,
): PrimaryCuisineType {
 ...
 */
export function getRegionalCuisinesForPrimary(
  _primary: PrimaryCuisineType,
): RegionalCuisineType[] {
 ...
 */
export function isValidCuisineType(
  cuisine: string,
): cuisine is CompleteCuisineType {
 ...
 */
export function normalizeCuisineName(
  cuisine: string,
): CompleteCuisineType | string {
