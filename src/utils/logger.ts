...
class Logger {
  ...
  private readonly componentLoggers: Set<string> = new Set();
    ...
    return {
      debug: (message: string, ...args: unknown[]): void => {
        try {
          ...
          console.warn(
            `[LOGGER-ERROR] Failed to log debug message for ${component}:`,
            e,
          );
        }
      },
      log: (message: string, ...args: unknown[]): void => {
        try {
          ...
          console.warn(
            `[LOGGER-ERROR] Failed to log message for ${component}:`,
            e,
          );
        }
      },
      info: (message: string, ...args: unknown[]): void => {
        try {
          ...
          console.warn(
            `[LOGGER-ERROR] Failed to log info message for ${component}:`,
            e,
          );
        }
      },
      warn: (message: string, ...args: unknown[]): void => {
        try {
          ...
          console.warn(
            `[LOGGER-ERROR] Failed to log warning for ${component}:`,
            e,
          );
        }
      },
      error: (message: string, ...args: unknown[]): void => {
        try {
          ...
          console.error(
            `[LOGGER-ERROR] Failed to log error for ${component}:`,
            e,
          );
        }
      },
...
export const _infoLog = (message: string, ...args: unknown[]): void =>
  logger.info(message, ...args);
export const _warnLog = (message: string, ...args: unknown[]): void =>
