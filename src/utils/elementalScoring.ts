...
// Helper functions
function calculateBaseElementalScore(recipe: Recipe, targetBalance: ElementalState): number {
...
function applySeasonalModifiers(baseScore: number, seasonalInfluence: number): number {
