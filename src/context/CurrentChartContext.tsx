...
const getDefaultPlanetaryPositions = () => {
  try {
    ...
    } = require('@/utils/reliableAstronomy');
...
export const CurrentChartProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
...
export const useCurrentChart = () => {
  ...
  if (!context) {
    throw new Error(
      'useCurrentChart must be used within a CurrentChartProvider'
    );
  }
