...
import { ElementalProperties, Season, ZodiacSign , Element } from '@/types/alchemy';
...
export const SEASONAL_MODIFIERS: Record<Season, ElementalProperties> = {
  ...
  summer: { Fire: 0.4,   // Dominant - heat, energy, expansion
  ...
  all: { Fire: 0.25,  // Balanced for all-season items
    Air: 0.25,
    Water: 0.25,
    Earth: 0.25
  }
 ...
 */
export const BALANCED_ELEMENTS: ElementalProperties = { Fire: 0.25, Air: 0.25,
  Water: 0.25,
  Earth: 0.25
};
...
export function calculateSeasonalCompatibility(season1: Season, season2: Season): number {
  ...
  if (index1 !== -1 && index2 !== -1) {
    ...
    switch (distance) {
      ...
      case 1: return 0.7;  // Adjacent seasons
      case 2: return 0.4;  // Opposite seasons
