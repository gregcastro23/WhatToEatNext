...
export const CHAKRA_VISUAL_INTELLIGENCE = {
  ...
  generateRecommendations: (analysis: Record<string, unknown>) => {
    ...
    if (
      (analysis as { colorAnalysis?: { colorHarmony?: number } })?.colorAnalysis?.colorHarmony !==
        undefined &&
...
export const CHAKRA_FUNCTIONAL_INTELLIGENCE = {
   ...
   */
  analyzeFunctionalOperations: (_herbs: typeof CHAKRA_HERBS, _sanskritNames: typeof CHAKRA_SANSKRIT_NAMES) => {
