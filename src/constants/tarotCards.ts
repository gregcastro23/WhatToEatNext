export const _TAROT_CARDS = {
  ...
  "7_of_cups": {
    ...
    associatedRecipes: [
      "visually_stunning_food",
      "fusion_cuisine",
      "experimental_cooking",
    ],
  },
  "8_of_cups": {
    name: "8 of Cups",
  ...
  "6_of_swords": {
    ...
    associatedRecipes: [
      "travel_foods",
      "transitional_seasonal_dishes",
      "light_cleansing_meals",
    ],
  },
  "7_of_swords": {
    name: "7 of Swords",
  ...
  "Ace of Swords": {
    ...
    quantum: 1.0,
    description:
      "Represents the pure essence of Matter energy - intellect, clarity, and truth",
  },
  "Page of Swords": {
    name: "Page of Swords",
    element: "Air",
