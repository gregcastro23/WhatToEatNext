...
export class AstrologyService {
  ...
  async getCurrentPlanetaryPositions(
    ...
    try {
      ...
      const rawPositions =
        await positionsModule.planetaryPositionsService.getCurrent();
      ...
      return this.currentState.currentPlanetaryAlignment as Record<
        Planet,
        CelestialPosition
      >;
    }
  ...
  private async refreshAstrologicalState(): Promise<void> {
    ...
    try {
      ...
      try {
        ...
        _logger.warn(
          "Astrologize API failed, using fallback calculations: ",
          apiError,
        );
