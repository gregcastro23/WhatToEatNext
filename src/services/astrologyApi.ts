...
export const _getCurrentCelestialPositions =
...
export const _getCelestialPositionsForDate = async (
  date: Date,
  ...
  try {
    ...
    return {
      ...
      planetaryPositions:
        planetaryPositions as CelestialPosition["planetaryPositions"],
      time: {
        hours: date.getHours(),
...
export const _getElementalInfluence =
    ...
    try {
      ...
      if (astroState) {
        ...
        if (
          ...
          return calculateElementalBalanceFromPositions(
            astroState.currentPlanetaryAlignment,
          );
        }
...
export function calculateElementalBalanceFromPositions(
