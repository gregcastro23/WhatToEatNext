...
export class RecommendationAdapter {
        ...
        this.aspects.forEach((aspect) => {
          ...
          if (planetData1?.AspectsEffect?.[planet2]) {
            ...
            if (aspectEffect) {
              ...
              alchemicalProperties.Substance +=
                planetData1.Alchemy.Substance * boost;
            }
          }
          ...
          if (planetData2?.AspectsEffect?.[planet1]) {
            ...
            if (aspectEffect) {
              ...
              alchemicalProperties.Substance +=
                planetData2.Alchemy.Substance * boost;
            }
          }
        });
      }
  ...
  applyTarotEnergyBoosts(
    ...
    let reactivity =
      (Math.pow(boostedSpirit, 2) +
        ...
        Math.pow(fire, 2) +
        Math.pow(air, 2) +
        Math.pow(water, 2)) / Math.pow(denominatorReactivity, 2);
  ...
  getGregsEnergyIndex(): number | null {
    ...
    if (this.alchemicalResult) {
      const { fire, water, earth, air } =
        this.alchemicalResult.elementalBalance;
