...
describe('DomainContextAnalyzer', () => {
  ...
  describe('Domain-Specific Type Suggestions Method', () => {
    test('returns domain-specific suggestions for astrological domain', () => {
      ...
      const suggestions = analyzer.getDomainSpecificSuggestions(CodeDomain.ASTROLOGICAL, context);
    ...
    test('returns domain-specific suggestions for recipe domain', () => {
      ...
      const suggestions = analyzer.getDomainSpecificSuggestions(CodeDomain.RECIPE, context);
    ...
    test('returns domain-specific suggestions for campaign domain', () => {
      ...
      const suggestions = analyzer.getDomainSpecificSuggestions(CodeDomain.CAMPAIGN, context);
  ...
  describe('Advanced Type Suggestions', () => {
    ...
    describe('Pattern Based Suggestions', () => {
      ...
      test('suggests Promise types for async patterns', () => {
        ...
        const suggestions = analyzer.getDomainSpecificSuggestions(CodeDomain.SERVICE, context);
      ...
      test('suggests function parameter types', () => {
        ...
        const suggestions = analyzer.getDomainSpecificSuggestions(CodeDomain.COMPONENT, context);
    ...
    describe('Contextual Content Analysis', () => {
      ...
      test('detects test mock patterns', () => {
        ...
        const suggestions = analyzer.getDomainSpecificSuggestions(CodeDomain.TEST, context);
