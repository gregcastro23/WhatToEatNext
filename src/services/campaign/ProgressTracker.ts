    ...
    const phases: PhaseReport[] = [
      {
        ...
        status: currentMetrics.typeScriptErrors.current === 0 ? PhaseStatus.COMPLETED : PhaseStatus.IN_PROGRESS,
      ...
      },
      {
        ...
        startTime: new Date(),
        status: currentMetrics.lintingWarnings.current === 0 ? PhaseStatus.COMPLETED : PhaseStatus.IN_PROGRESS,
        metrics: currentMetrics,
