...
describe('UnusedVariablesCleanupSystem', () => {
  ...
  describe('constructor', () => {
    it('should initialize with default configuration', () => {
      const system = new UnusedVariablesCleanupSystem();
  ...
  describe('validatePreConditions', () => {
    it('should validate script exists', async () => {
      ...
      await expect((cleanupSystem as any).validatePreConditions()).rejects.toThrow('Unused variables script not found');
    });

    it('should check git status when git stash is enabled', async () => {
      mockExecSync.mockReturnValue('');
      
      await expect((cleanupSystem as any).validatePreConditions()).resolves.not.toThrow();
  ...
  describe('createSafetyStash', () => {
    it('should create git stash with timestamp', async () => {
      ...
      const stashId = await (cleanupSystem as any).createSafetyStash();
  ...
  describe('executeScript', () => {
    it('should execute script with correct arguments for dry run', async () => {
      ...
      const result = await (system as any).executeScript();
    ...
    it('should handle script execution errors', async () => {
      ...
      const result = await (cleanupSystem as any).executeScript();
  ...
  describe('validateBuild', () => {
    it('should validate build successfully', async () => {
      ...
      const isValid = await (cleanupSystem as any).validateBuild();
  ...
  describe('rollbackFromStash', () => {
    it('should rollback from specified stash', async () => {
      ...
      await (cleanupSystem as any).rollbackFromStash('test-stash-name');
    ...
    it('should handle rollback errors', async () => {
      ...
      await expect((cleanupSystem as any).rollbackFromStash('test-stash')).rejects.toThrow('Rollback failed');
    });
  });
  ...
  describe('estimateFilesWithUnusedVariables', () => {
    it('should return default estimate when analyzer fails', async () => {
      ...
      const estimate = await (cleanupSystem as any).estimateFilesWithUnusedVariables();
  ...
  describe('saveMetrics', () => {
    it('should save metrics to file', async () => {
      ...
      await (cleanupSystem as any).saveMetrics(result);
    ...
    it('should handle save metrics errors gracefully', async () => {
      ...
      await expect((cleanupSystem as any).saveMetrics(result)).resolves.not.toThrow();
    });
  });
});