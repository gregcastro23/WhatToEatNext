...
export interface DomainContext {
  type: 'astrological' | 'campaign' | 'test' | 'script' | 'component' | 'service' | 'utility' | 'config';
  subtype?: string;
...
export class DomainContextDetector {
   ...
   */
  private async detectDomainContext(relativePath: string, absolutePath: string): Promise<DomainContext> {
