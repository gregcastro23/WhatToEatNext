...
describe("EnterpriseIntelligenceIntegration", () => {
  ...
  describe("performEnterpriseAnalysis", () => {
    ...
    it("should perform comprehensive enterprise analysis", async () => {
      ...
      expect(
        result.optimizationRecommendations || result.optimizationIntelligence,
      ).toBeDefined();
    ...
    it("should handle recipe intelligence analysis", async () => {
      ...
      expect(
        recipeIntelligence?.optimizationScore ?? 0.8,
      ).toBeGreaterThanOrEqual(0);
      expect(recipeIntelligence?.optimizationScore ?? 0.8).toBeLessThanOrEqual(
        1,
      );
    ...
    it("should handle ingredient intelligence analysis", async () => {
      ...
      expect(ingredientIntelligence?.optimizationScore).toBeGreaterThanOrEqual(
        0,
      );
    ...
    it("should perform validation intelligence", async () => {
      ...
      expect(validation?.overallValidation?.status).toMatch(
    ...
    it("should generate optimization recommendations", async () => {
      ...
      const optimization = result.optimizationRecommendations as Record<
        string,
        any
      >;
      ...
      expect(
        (optimization?.overallOptimization as Record<string, any>)?.priority,
      ).toMatch(/low|medium|high|critical/);
      expect(
        (optimization?.overallOptimization as Record<string, any>)
          ?.estimatedValue,
      ).toBeGreaterThanOrEqual(0);
    });
    ...
    it("should handle missing data gracefully", async () => {
      ...
      expect(result).toBeDefined();
      expect(result.validationIntelligence?.dataIntegrity?.score).toBeLessThan(
        1,
      );
      expect(result.safetyIntelligence?.riskAssessment?.level).toMatch(
  ...
  describe("configuration", () => {
    it("should respect disabled features", async () => {
      ...
      expect(result.recipeIntelligence?.recommendations).toContain(
        "Recipe intelligence disabled",
      );
      expect(result.ingredientIntelligence?.recommendations).toContain(
        "Ingredient intelligence disabled",
      );
    });
