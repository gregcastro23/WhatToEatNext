...
const mapperPath = path.join(__dirname, './SpoonacularElementalMapper.js');
const { SpoonacularElementalMapper } = require(mapperPath);
...
class SpoonacularService {
  ...
  static async fetchVegetableData(searchVegetableName) {
    try {
