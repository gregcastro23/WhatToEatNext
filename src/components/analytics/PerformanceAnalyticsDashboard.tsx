    ...
    >
      <div className='mb-2 flex items-center justify-between'>
        ...
        {description && (
          ...
          >
            <Info size={16} className='cursor-help text-gray-400' />
            {showTooltip && (
              <div className='absolute right-0 top-6 z-10 whitespace-nowrap rounded bg-gray-800 p-2 text-xs text-white'>
                {description}
              </div>
            )}
          </div>
...
const PerformanceChart: React.FC<{
  ...
  if (data.length === 0) {
    return (
      <div className={`flex items-center justify-center rounded bg-gray-50`} style={{ height }}>
  ...
  return (
    <div className='space-y-2'>
      ...
      <div className={`relative overflow-hidden rounded bg-gray-50`} style={{ height }}>
...
export const PerformanceAnalyticsDashboard: React.FC<PerformanceAnalyticsDashboardProps> = ({
  ...
  const renderDetailedView = () => (
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center space-x-2'>
          <button
            ...
            disabled={refreshing}
            className='flex items-center space-x-1 rounded bg-blue-50 px-3 py-1 text-sm text-blue-700 transition-colors hover:bg-blue-100 disabled:opacity-50'
          >
          ...
          <button
            ...
            className='rounded bg-gray-50 px-3 py-1 text-sm text-gray-700 transition-colors hover:bg-gray-100'
          >
            Clear Data
          </button>
      ...
      {showDetails && !isLoading && (
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
          <div className='rounded-lg border border-gray-200 bg-white p-4'>
            <PerformanceChart
              data={
                ((performanceTrends as Record<string, unknown>).loadTimeTrend as number[]) || []
              }
          ...
          <div className='rounded-lg border border-gray-200 bg-white p-4'>
            <PerformanceChart
              data={
                ((performanceTrends as Record<string, unknown>).cacheHitRateTrend as number[]) || []
              }
      ...
      {showDetails && !isLoading && (
        <div className='rounded-lg border border-gray-200 bg-white p-4'>
          <h4 className='text-md mb-3 font-semibold text-gray-900'>Cache Statistics</h4>
