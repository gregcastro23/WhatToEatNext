  ...
  return (
    <div className={`rounded-lg border bg-white shadow-lg ${className}`}>
      <div className='border-b p-4'>
        <h3 className='mb-3 text-lg font-semibold text-gray-900'>Astrological Code Templates</h3>
      ...
      <div className='grid grid-cols-1 gap-4 p-4 lg:grid-cols-2'>
        ...
        {selectedTemplate && (
          <div className='space-y-4'>
            <div>
              <h4 className='mb-3 font-medium text-gray-900'>Configure Template</h4>
            ...
            <div>
              <h5 className='mb-2 font-medium text-gray-900'>Preview</h5>
