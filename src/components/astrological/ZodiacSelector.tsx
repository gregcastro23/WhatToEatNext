    ...
    <Box>
      ...
      {value && showElement && (
        <Box mt={2}>
          <HStack spacing={2}>
            <Icon
              as={ELEMENT_ICONS[ZODIAC_ELEMENTS[value as keyof typeof ZODIAC_ELEMENTS] as keyof typeof ELEMENT_ICONS]}
              color={`${ELEMENT_COLORS[ZODIAC_ELEMENTS[value as keyof typeof ZODIAC_ELEMENTS] as keyof typeof ELEMENT_COLORS]}.500`}
              boxSize={4}
            />
            <Text fontSize="xs" color="gray.600">
              {value} is a {ZODIAC_ELEMENTS[value as keyof typeof ZODIAC_ELEMENTS]} sign
            </Text>
          </HStack>
        </Box>
      )}
