...
export const IngredientCard: React.FC<IngredientCardProps> = ({ 
  ...
  const getElementIcon = (element: string) => {
    ...
    switch (element.toLowerCase()) {
      case 'fire': return <Flame {...iconProps} style={{ ...iconProps.style, color: '#ef4444' }} />;
      case 'water': return <Droplets {...iconProps} style={{ ...iconProps.style, color: '#3b82f6' }} />;
      case 'earth': return <Mountain {...iconProps} style={{ ...iconProps.style, color: '#10b981' }} />;
      case 'air': return <Wind {...iconProps} style={{ ...iconProps.style, color: '#8b5cf6' }} />;
      default: return null;
    }
  };
  ...
  return (
    <div 
      ...
      style={{
        ...
        boxShadow: isSelected ? '0 8px 25px rgba(59, 130, 246, 0.15)' : '0 2px 8px rgba(0, 0, 0, 0.1)'
      }}
    >
      {/* Card Header */}
      <div style={{
              ...
              {showAstrologicalInfo && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    Optimally aligned with current {currentZodiac || 'cosmic'} energy and {isDaytime ? 'solar' : 'lunar'} influences.
                    {matchScore && ` Match score reflects ${Math.round(matchScore * 100)}% cosmic harmony.`}
                  </div>
                </div>
              )}
            </>
