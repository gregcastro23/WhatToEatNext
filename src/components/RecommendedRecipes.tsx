  ...
  return (
    <Box sx={{ mt: 3, mb: 3 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
        <WbSunny sx={{ mr: 1 }} />
        <Typography variant='h5'>Cosmic Recommendations for {timeFactors.timeOfDay}</Typography>
      </Box>

      <Box sx={{ mb: 2 }}>
        <Typography variant='body1'>
          Based on {timeFactors.planetaryDay.day}'s {timeFactors.planetaryDay.planet} influence and
          the {timeFactors.season} season
        </Typography>
      </Box>
