...
import { Clock, Droplets, Flame, Leaf, Mountain, RefreshCw, Sparkles, Star, ThermometerSnowflake, ThermometerSun, Wind } from 'lucide-react';
...
const FoodRecommender: React.FC = () => {
    ...
    const getDominantElement = (elementalProperties: Record<ElementalCharacter, number>): ElementalCharacter => {
        ...
        if (typeof window !== 'undefined' && window.getDominantElement) {
            window.getDominantElement = ((_obj: import('@/types/alchemy').ElementalProperties) => dominant as unknown as Element) as unknown as (obj: import('@/types/alchemy').ElementalProperties) => Element;
        }
        return dominant;
    };
