...
export const IngredientRecommender: React.FC<IngredientRecommenderProps> = ({
  ...
  const renderIngredientCard = (ingredient: UnifiedIngredient) => {
        ...
        {ingredient.qualities && ingredient.qualities.length > 0 && (
          <div className="mb-2 flex flex-wrap gap-1">
            {ingredient.qualities
              .slice(0, isSelected ? undefined : 3)
              .map((quality, idx) => (
                <span
                  key={idx}
            ...
            {!isSelected && ingredient.qualities.length > 3 && (
              <span className="text-xs text-gray-400">
                +{ingredient.qualities.length - 3} more
              </span>
            )}
          </div>
        )}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {ingredient.seasonality.map((season, idx) => (
                    <span
                      key={idx}
                      className="rounded-md bg-lime-100 px-2 py-1 text-xs text-lime-700 capitalize"
                    >
                      {season}
                    </span>
                  ))}
            ...
            {(ingredient as any).sensoryProfile && (
              <div>
                ...
                {(ingredient as any).sensoryProfile.taste &&
                  Object.keys((ingredient as any).sensoryProfile.taste).length >
                    0 && (
                    <div className="mb-2">
                ...
                {(ingredient as any).sensoryProfile.aroma &&
                  Object.keys((ingredient as any).sensoryProfile.aroma).length >
                    0 && (
                    <div className="mb-2">
                ...
                {(ingredient as any).sensoryProfile.texture &&
                  Object.keys((ingredient as any).sensoryProfile.texture)
                    .length > 0 && (
                    <div>
                ...
                <div className="space-y-1 rounded bg-slate-50 px-2 py-2">
                  ...
                  {(ingredient as any).storage.temperature && (
                    <div className="text-xs">
                      ...
                      <span className="ml-1 text-gray-800">
                        {typeof (ingredient as any).storage.temperature ===
                        "string"
                          ? (ingredient as any).storage.temperature
            ...
            {(ingredient as any).preparation && (
              <div>
                ...
                <div className="space-y-2">
                  {(ingredient as any).preparation.fresh && (
                    <div className="rounded bg-green-50 px-2 py-2">
                      ...
                      <div className="text-xs text-gray-700 space-y-1">
                        <div>
                          Duration:{" "}
                          {(ingredient as any).preparation.fresh.duration}
                        </div>
                        <div>
                          Storage:{" "}
                          {(ingredient as any).preparation.fresh.storage}
                        </div>
                        {(ingredient as any).preparation.fresh.tips && (
                          <div>
                            <div className="font-medium mt-1">Tips:</div>
                            <ul className="list-disc list-inside ml-2">
                              {(ingredient as any).preparation.fresh.tips.map(
                  ...
                  {(ingredient as any).preparation.dried && (
                    <div className="rounded bg-amber-50 px-2 py-2">
                      ...
                      <div className="text-xs text-gray-700 space-y-1">
                        <div>
                          Duration:{" "}
                          {(ingredient as any).preparation.dried.duration}
                        </div>
                        <div>
                          Storage:{" "}
                          {(ingredient as any).preparation.dried.storage}
                        </div>
                        {(ingredient as any).preparation.dried.tips && (
                          <div>
                            <div className="font-medium mt-1">Tips:</div>
                            <ul className="list-disc list-inside ml-2">
                              {(ingredient as any).preparation.dried.tips.map(
                                (tip: string, idx: number) => (
                                  <li key={idx}>{tip}</li>
                                ),
                              )}
                  ...
                  {(ingredient as any).preparation.methods &&
                    (ingredient as any).preparation.methods.length > 0 && (
                      <div>
                        <div className="text-xs text-gray-600 mb-1">
                          Methods:
                        </div>
                        <div className="flex flex-wrap gap-1">
                          {(ingredient as any).preparation.methods.map(
              ...
              <div>
                ...
                <div className="space-y-2">
                    ...
                    (ingredient as any).pairingRecommendations.complementary
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(
                            ingredient as any
                          ).pairingRecommendations.complementary.map(
                    ...
                    (ingredient as any).pairingRecommendations.contrasting
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(
                            ingredient as any
                          ).pairingRecommendations.contrasting.map(
                            (item: string, idx: number) => (
                              <span
                                key={idx}
                                className="rounded-md bg-yellow-100 px-2 py-1 text-xs text-yellow-700"
                              >
                                {item}
                              </span>
                            ),
                  ...
                  {(ingredient as any).pairingRecommendations.toAvoid &&
                    (ingredient as any).pairingRecommendations.toAvoid.length >
                      0 && (
                      <div>
                        <div className="text-xs text-gray-600 mb-1">
                          To Avoid:
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(
                            ingredient as any
                          ).pairingRecommendations.toAvoid.map(
                            (item: string, idx: number) => (
                              <span
                                key={idx}
                  ...
                  <div className="space-y-2">
                    {(ingredient as any).recommendedCookingMethods.map(
                      (method: any, idx: number) => (
                        <div
                          key={idx}
                          className="rounded bg-indigo-50 px-2 py-2"
                        >
                          ...
                          <div className="text-xs text-gray-700">
                            ...
                            {method.cookingTime && (
                              <div className="mt-1">
                                Time: {method.cookingTime.min}-
                                {method.cookingTime.max}{" "}
                                {method.cookingTime.unit}
                              </div>
                            )}
                            {method.temperatures && (
                              <div>
                                Temp: {method.temperatures.min}-
                                {method.temperatures.max}°
                                {method.temperatures.unit === "celsius"
                                  ? "C"
                                  : "F"}
                              </div>
                            )}
              ...
              <div>
                ...
                <div className="space-y-2">
                    ...
                    (ingredient as any).culinaryProperties.cookingMethods
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(
                            ingredient as any
                          ).culinaryProperties.cookingMethods.map(
                            (method: any, idx: number) => (
                              <span
                                key={idx}
                                className="rounded-md bg-sky-100 px-2 py-1 text-xs text-sky-700"
                              >
                  ...
                  {(ingredient as any).culinaryProperties.pairings &&
                    (ingredient as any).culinaryProperties.pairings.length >
                      0 && (
                      <div>
                        <div className="text-xs text-gray-600 mb-1">
                          Pairings:
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(ingredient as any).culinaryProperties.pairings.map(
                            (pairing: string, idx: number) => (
                              <span
                                key={idx}
                                className="rounded-md bg-emerald-100 px-2 py-1 text-xs text-emerald-700"
                              >
                                {pairing}
                              </span>
                            ),
                    ...
                    (ingredient as any).culinaryProperties.substitutions
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(
                            ingredient as any
                          ).culinaryProperties.substitutions.map(
                    ...
                    (ingredient as any).culinaryProperties.preparationMethods
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(
                            ingredient as any
                          ).culinaryProperties.preparationMethods.map(
                            (method: string, idx: number) => (
                              <span
                                key={idx}
                                className="rounded-md bg-cyan-100 px-2 py-1 text-xs text-cyan-700"
                              >
                                {method}
                              </span>
                            ),
            ...
            {(ingredient as any).varieties &&
              Object.keys((ingredient as any).varieties).length > 0 && (
                <div>
                  ...
                  <div className="space-y-2">
                    {Object.entries((ingredient as any).varieties).map(
                      ([name, details]: [string, any], idx: number) => (
                        <div
                          key={idx}
                          className="rounded bg-amber-50 px-2 py-2"
                        >
                          <div className="text-xs font-medium text-amber-800 mb-1 capitalize">
                            {name.replace(/_/g, " ")}
                          </div>
                          <div className="text-xs text-gray-700 space-y-1">
                            {details.appearance && (
                ...
                <div className="rounded bg-red-50 px-2 py-2 space-y-1">
                  {(ingredient as any).safetyThresholds.minimum && (
                    <div className="text-xs">
                      ...
                      <span className="ml-1 text-gray-800">
                        {(ingredient as any).safetyThresholds.minimum.celsius}°C
                        /{" "}
                        {
                          (ingredient as any).safetyThresholds.minimum
                            .fahrenheit
                  ...
                  {(ingredient as any).safetyThresholds.maximum && (
                    <div className="text-xs">
                      ...
                      <span className="ml-1 text-gray-800">
                        {(ingredient as any).safetyThresholds.maximum.celsius}°C
                        /{" "}
                        {
                          (ingredient as any).safetyThresholds.maximum
                            .fahrenheit
