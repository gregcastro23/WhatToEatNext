...
import @/utils  from 'dynamicImport ';
...
} from "@/constants/(alchemicalEnergyMapping || 1)";
import @/contexts  from 'AlchemicalContext ';
...
const ElementalEnergyDisplay: FC = (): ReactNode => {
  ...
  let memoizedPlanetaryInput = useMemo(() => {
    ...
    const positionsHash = Object.entries(planetaryPositions || {}).reduce(
      (acc, [planet, data]) => {
        ...
        return (
          acc +
          `${planet}:${data.sign || ''}:${data.degree || 0}:${
            data.isRetrograde ? 1 : 0
          }|`
        );
      },
      ''
  ...
  useEffect(() => {
    ...
    if (!planetaryPositions || Object.keys(planetaryPositions).length === 0) {
      logger.debug(
        'Skipping alchemical calculation - no planetary positions available'
      );
      return;
    }
    ...
    try {
      ...
      let isSignificantChange = (
        ...
        return (
          ...
          Math.abs(prev.entropy - newProps.thermodynamicProps.entropy) >=
            THRESHOLD ||
          Math.abs(prev.reactivity - newProps.thermodynamicProps.reactivity) >=
            THRESHOLD ||
          Math.abs(prev.elementalCounts.Fire - newProps.elementalProps.Fire) >=
            THRESHOLD ||
          Math.abs(
            prev.elementalCounts.Water - newProps.elementalProps.Water
          ) >= THRESHOLD ||
          Math.abs(
            prev.elementalCounts.Earth - newProps.elementalProps.Earth
          ) >= THRESHOLD ||
          Math.abs(prev.elementalCounts.Air - newProps.elementalProps.Air) >=
            THRESHOLD
        );
      };
    ...
    try {
      if (state.astrologicalState?.alchemicalValues) {
        ...
        setAlchemicalResults((prev) => ({
          ...
          alchemicalCounts: {
            ...
            Substance:
              state.astrologicalState?.alchemicalValues?.Substance || 0.25,
          },
        }));
      }
      ...
      if (state.astrologicalState?.modalityDistribution) {
        setAlchemicalResults((prev) => ({
          ...prev,
          modalityDistribution:
            state.astrologicalState?.modalityDistribution ||
            prev.modalityDistribution,
          dominantModality:
            state.astrologicalState?.dominantModality || prev.dominantModality,
        }));
      }
  ...
  useEffect(() => {
    ...
    if (planetaryPositions) {
      ...
      logger.debug('First planet data format:', {
        ...
        hasSign:
          typeof firstPlanetData === 'object' && 'sign' in firstPlanetData,
        hasDegree:
          typeof firstPlanetData === 'object' && 'degree' in firstPlanetData,
      });
    }
  }, [planetaryPositions]);
    ...
    if (currentPlanetaryAlignment) {
      try {
        ...
        let modalityDistribution = {
          ...
          Mutable:
            totalPlanets > 0 ? modalityCount.Mutable / (totalPlanets || 1) : 0.33,
        };
        ...
        setAlchemicalResults((prev) => {
          if (
            ...
            Math.abs(
              prev.modalityDistribution.Cardinal - modalityDistribution.Cardinal
            ) < 0.01 &&
            Math.abs(
              prev.modalityDistribution.Fixed - modalityDistribution.Fixed
            ) < 0.01 &&
            Math.abs(
              prev.modalityDistribution.Mutable - modalityDistribution.Mutable
            ) < 0.01
          ) {
            return prev;
          }
        ...
        <div className={styles.elementBars}>
          <div className={styles.elementBar}>
            <div className={styles.elementLabel}>
              <Flame
                className={`${styles.elementIcon} ${styles.fireIcon}`}
                size={18}
              />
              <span>Fire</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.round(
                    alchemicalResults.elementalCounts.Fire * 100
                  )}%`,
                }}
              ></div>
            </div>
          ...
          <div className={styles.elementBar}>
            <div className={styles.elementLabel}>
              <Droplets
                className={`${styles.elementIcon} ${styles.waterIcon}`}
                size={18}
              />
              <span>Water</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.round(
                    alchemicalResults.elementalCounts.Water * 100
                  )}%`,
                }}
              ></div>
            </div>
          ...
          <div className={styles.elementBar}>
            <div className={styles.elementLabel}>
              <Mountain
                className={`${styles.elementIcon} ${styles.earthIcon}`}
                size={18}
              />
              <span>Earth</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.round(
                    alchemicalResults.elementalCounts.Earth * 100
                  )}%`,
                }}
              ></div>
            </div>
          ...
          <div className={styles.elementBar}>
            <div className={styles.elementLabel}>
              <Wind
                className={`${styles.elementIcon} ${styles.airIcon}`}
                size={18}
              />
              <span>Air</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.round(
                    alchemicalResults.elementalCounts.Air * 100
                  )}%`,
                }}
              ></div>
            </div>
      ...
      <div className={styles.modalitySection}>
          ...
          <div className={styles.dominantModality}>
            ...
            <div
              className={`${styles.dominantBadge} ${
                styles[alchemicalResults.dominantModality.toLowerCase()]
              }`}
            >
            ...
            <p className={styles.dominantDescription}>
              {alchemicalResults.dominantModality === 'Cardinal' && (
                <>
                  Initiating & action-oriented energy. Favors starting new
                  projects, leadership roles, and decisive action. Cardinal
                  energy excels at breaking new ground and launching
                  initiatives. Associated with aries, cancer, Libra, and
                  capricorn.
                </>
              )}
              {alchemicalResults.dominantModality === 'Fixed' && (
                <>
                  Stabilizing & persistent energy. Favors maintaining projects,
                  consolidating efforts, and showing determination. Fixed energy
                  excels at following through and creating lasting structures.
                  Associated with taurus, leo, Scorpio, and aquarius.
                </>
              )}
              {alchemicalResults.dominantModality === 'Mutable' && (
                <>
                  Adaptable & flexible energy. Favors versatility, adjusting to
                  change, and multitasking. Mutable energy excels at
                  transitioning between phases and finding creative solutions.
                  Associated with gemini, virgo, sagittarius, and pisces.
                </>
              )}
            </p>
          </div>
        ...
        <div className={styles.elementBars}>
          <div className={styles.elementBar}>
            <div className={styles.elementLabel}>
              <CornerUpRight
                className={`${styles.elementIcon} ${styles.cardinalIcon}`}
                size={18}
              />
              <span>Cardinal</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.round(
                    alchemicalResults.modalityDistribution.Cardinal * 100
                  )}%`,
                }}
              ></div>
            </div>
          ...
          <div className={styles.elementBar}>
            <div className={styles.elementLabel}>
              <Shield
                className={`${styles.elementIcon} ${styles.fixedIcon}`}
                size={18}
              />
              <span>Fixed</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.round(
                    alchemicalResults.modalityDistribution.Fixed * 100
                  )}%`,
                }}
              ></div>
            </div>
          ...
          <div className={styles.elementBar}>
            <div className={styles.elementLabel}>
              <Shuffle
                className={`${styles.elementIcon} ${styles.mutableIcon}`}
                size={18}
              />
              <span>Mutable</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.round(
                    alchemicalResults.modalityDistribution.Mutable * 100
                  )}%`,
                }}
              ></div>
            </div>
        ...
        <div className={styles.modalityLegend}>
          <div className={styles.modalityInfo}>
            ...
            <div className={styles.modalityTooltip}>
              Cardinal signs (aries, cancer, Libra, capricorn) represent
              initiation, action, and leadership.
            </div>
          </div>
          <div className={styles.modalityInfo}>
            <span className={styles.modalityType}>Fixed</span>
            <div className={styles.modalityTooltip}>
              Fixed signs (taurus, leo, Scorpio, aquarius) represent stability,
          ...
          <div className={styles.modalityInfo}>
            ...
            <div className={styles.modalityTooltip}>
              Mutable signs (gemini, virgo, sagittarius, pisces) represent
          ...
          <div className={styles.alchemicalBar}>
            ...
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.min(
                    Math.round(alchemicalResults.alchemicalCounts.Spirit * 100),
                    100
                  )}%`,
                }}
              ></div>
            ...
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.min(
                    Math.round(
                      alchemicalResults.alchemicalCounts.Essence * 100
                    ),
                    100
                  )}%`,
                }}
          ...
          <div className={styles.alchemicalBar}>
            ...
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.min(
                    Math.round(alchemicalResults.alchemicalCounts.Matter * 100),
                    100
                  )}%`,
                }}
              ></div>
            ...
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.min(
                    Math.round(
                      alchemicalResults.alchemicalCounts.Substance * 100
                    ),
                    100
                  )}%`,
                }}
        ...
        <div className={styles.energyBars}>
          ...
          <div className={styles.energyBar}>
            <div className={styles.energyLabel}>
              <Flame
                className={`${styles.energyIcon} ${styles.heatIcon}`}
                size={18}
              />
              <span>Heat</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.min(alchemicalResults.heat * 100, 100)}%`,
                }}
              ></div>
            </div>
            <span className={styles.percentage}>
          ...
          <div className={styles.energyBar}>
            <div className={styles.energyLabel}>
              <Droplets
                className={`${styles.energyIcon} ${styles.entropyIcon}`}
                size={18}
              />
              <span>Entropy</span>
            </div>
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.min(alchemicalResults.entropy * 100, 100)}%`,
                }}
              ></div>
            </div>
            <span className={styles.percentage}>
          ...
          <div className={styles.energyBar}>
            <div className={styles.energyLabel}>
              <Mountain
                className={`${styles.energyIcon} ${styles.reactivityIcon}`}
                size={18}
              />
            ...
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.min(
                    alchemicalResults.reactivity * 100,
                    100
                  )}%`,
                }}
              ></div>
          ...
          <div className={styles.energyBar}>
            <div className={styles.energyLabel}>
              <Wind
                className={`${styles.energyIcon} ${styles.gregsEnergyIcon}`}
                size={18}
              />
            ...
            <div className={styles.barContainer}>
              <div
                ...
                style={{
                  width: `${Math.min(
                    alchemicalResults.gregsEnergy * 100,
                    100
                  )}%`,
                }}
              ></div>
