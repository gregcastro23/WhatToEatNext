...
const Footer: React.FC = () => (
  <footer className='border-t border-gray-200 bg-white px-6 py-4'>
    <div className='flex items-center justify-between'>
      <p className='text-sm text-gray-600'>© {new Date().getFullYear()} What To Eat Next</p>

      <div className='flex items-center space-x-4'>
        <span className='text-sm text-gray-600'>Powered by Alchemical Engine</span>
      </div>
    </div>
  </footer>
);
  ...
  <aside className='hidden w-64 border-r border-gray-200 bg-white lg:block'>
    <div className='p-6'>
      ...
      <div className='space-y-6'>
        <div>
          <h3 className='mb-2 text-sm font-medium'>Cuisine Types</h3>
          {/* Add cuisine filters */}
        </div>
        ...
        <div>
          <h3 className='mb-2 text-sm font-medium'>Elemental Balance</h3>
