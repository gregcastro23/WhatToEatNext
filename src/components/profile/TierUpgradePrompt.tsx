  ...
  <div className="relative overflow-hidden rounded-2xl border border-purple-200 bg-gradient-to-r from-purple-50 via-white to-orange-50 p-6">
    ...
    <div className="relative z-10">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-base font-bold text-gray-800">ESMS Token Capabilities</h3>
      </div>
      <p className="text-sm text-gray-600 mb-4">
        Elevate your cosmic culinary journey with live planetary intelligence, synastry, and recipes.
      </p>
      ...
      <Link
        href="/vault"
        className="inline-block px-6 py-2.5 bg-gradient-to-r from-purple-600 to-orange-500 text-white rounded-lg font-semibold text-sm hover:from-purple-700 hover:to-orange-600 transition-all shadow-md hover:shadow-lg"
      >
        Open ESMS Token Vault
      </Link>
    </div>
  </div>
);
