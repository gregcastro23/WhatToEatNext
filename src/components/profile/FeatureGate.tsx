...
function DefaultFallback({ feature: _feature }: { feature: string }) {
  return (
    <div className="relative rounded-2xl border border-dashed border-purple-200 bg-purple-50/50 p-6 text-center">
      ...
      <p className="text-sm text-purple-600 font-medium">Account Feature</p>
      <p className="text-xs text-gray-500 mt-1">Sign in or visit the ESMS Token Vault to unlock this feature.</p>
    </div>
  );
}
