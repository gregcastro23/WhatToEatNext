    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6 rounded-lg">
        ...
        <p className="text-lg opacity-90">
          Experience the comprehensive cuisine-level recommendation system with personalized analysis
        </p>
      </div>

      {/* User Profile Configuration */}
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-semibold mb-4">👤 User Profile Configuration</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              {Object.entries(userProfile.elementalPreferences).map(([element, value]) => (
                <div key={element} className="flex items-center space-x-3">
                  ...
                  <input
                    ...
                    max="100"
                    value={value * 100}
                    onChange={(e) => handleElementalChange(element as keyof ElementalProperties, parseInt(e.target.value))}
                    className="flex-1"
                  />
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium mb-1">Sun Sign</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Moon Sign</label>
                <select
            ...
            {recommendations.map((rec, index) => (
              <div key={index} className="border rounded-lg p-4 bg-gradient-to-r from-green-50 to-blue-50">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800">{rec.cuisine}</h3>
                    <div className="flex items-center space-x-4 mt-1">
                      <span className="text-2xl">
                        {rec.score >= 0.8 ? '🌟' : rec.score >= 0.6 ? '⭐' : '⚡'}
                      </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                  ...
                  <div className="bg-white p-3 rounded border">
                    <div className="text-sm text-gray-600">Planetary Alignment</div>
                ...
                <div className="border-t pt-3">
                  ...
                  <ul className="text-sm text-gray-700 space-y-1">
                    {rec.detailedReasoning.map((reason: string, idx: number) => (
      ...
      {cacheStats && (
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">{Math.round(cacheStats.hitRate * 100)}%</div>
              <div className="text-sm text-gray-600">Hit Rate</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">{cacheStats.totalHits}</div>
              <div className="text-sm text-gray-600">Total Hits</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-red-600">{Math.round(cacheStats.memoryUsage / 1024)}KB</div>
