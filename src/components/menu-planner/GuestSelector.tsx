...
const MOCK_SAVED_CHARTS: NatalChart[] = [
  {
    id: 'chart-1',
    name: 'Greg',
    birthData: { dateTime: '1990-05-21T10:30:00Z', latitude: 40.7128, longitude: -74.0060 },
    planetaryPositions: { Sun: 'gemini', Moon: 'leo', Ascendant: 'virgo', Mercury: 'cancer', Venus: 'taurus', Mars: 'aries', Jupiter: 'pisces', Saturn: 'capricorn', Uranus: 'aquarius', Neptune: 'sagittarius', Pluto: 'scorpio' },
    dominantElement: 'Air',
  ...
  },
  {
    id: 'chart-2',
    name: 'Monica',
    birthData: { dateTime: '1992-11-15T14:00:00Z', latitude: 34.0522, longitude: -118.2437 },
    planetaryPositions: { Sun: 'scorpio', Moon: 'taurus', Ascendant: 'aquarius', Mercury: 'libra', Venus: 'sagittarius', Mars: 'leo', Jupiter: 'virgo', Saturn: 'pisces', Uranus: 'capricorn', Neptune: 'aquarius', Pluto: 'scorpio' },
