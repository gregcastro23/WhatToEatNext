...
export function CookingMethodRecommenderDebug() {
  ...
  const mockMethods = [
    {
      ...
      name: 'Grilling',
      description:
        'High-heat cooking over direct flame or heat source, creating distinctive char and smoky flavors.',
      score: 0.85,
    ...
    },
    {
      ...
      name: 'Steaming',
      description:
        'Gentle cooking using moist heat from boiling water vapor, preserving nutrients and natural flavors.',
      score: 0.75,
  ...
  return (
    <div className='rounded-lg border border-purple-500 p-4'>
      <h4 className='mb-2 text-lg font-bold text-purple-400'>Cooking Method Recommender</h4>
