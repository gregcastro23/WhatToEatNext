    ...
    <div className={`conflict-resolution-panel ${className}`}>
      ...
      <div className='panel-header'>
        ...
        <div className='header-actions'>
          <button className='auto-resolve-btn' onClick={handleAutoResolve} disabled={loading}>
        ...
        <div className='summary-stats'>
          ...
          <div className='stat'>
            <span className='stat-value'>
              {
                conflicts.filter(c => c.status === 'detected' || c.status === 'pending_resolution')
                  .length
              }
            </span>
        ...
        <div className='conflict-details-overlay'>
          <div className='conflict-details-modal'>
            <div className='modal-header'>
              ...
              <button className='close-btn' onClick={() => setSelectedConflict(null)}>
                ×
              </button>
            </div>
        ...
        <div className='manual-override-overlay'>
          <div className='manual-override-modal'>
            <div className='modal-header'>
              ...
              <button className='close-btn' onClick={() => setShowManualOverride(false)}>
                ×
              </button>
            </div>
    ...
    <div className='conflict-card' onClick={onSelect}>
      <div className='conflict-header'>
        <div className='conflict-badges'>
          <span className='type-badge' style={{ backgroundColor: getTypeColor(conflict.type) }}>
        ...
        <div className='conflict-time'>{conflict.detectedAt.toLocaleString()}</div>
      </div>
      ...
      <div className='conflict-info'>
        ...
        <div className='info-grid'>
          <div className='info-item'>
            ...
            <span className='info-badge' style={{ backgroundColor: getTypeColor(conflict.type) }}>
              {conflict.type.replace('_', ' ').toUpperCase()}
            </span>
          </div>
          <div className='info-item'>
...
const ManualOverrideForm: React.FC<{
  ...
  const [selectedAction, setSelectedAction] = useState<ResolutionAction>(
    'PAUSE_CAMPAIGN' as ResolutionAction,
  );
