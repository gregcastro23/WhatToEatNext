 ...
 */
export function getRegionalCuisines(
  primaryCuisine: PrimaryCuisineType,
): string[] {
 ...
 */
export function getPrimaryCuisine(
  regionalCuisine: string,
): PrimaryCuisineType | undefined {
 ...
 */
export function isValidPrimaryCuisine(
  cuisineName: string,
): cuisineName is PrimaryCuisineType {
...
export function normalizeCuisineName(cuisineName: string): string {
  ...
  if (isRegionalCuisine(cuisineName)) {
    return (
      cuisineName.charAt(0).toUpperCase() + cuisineName.slice(1).toLowerCase()
    );
  }
 ...
 */
export function isPrimaryCuisineType(
  value: string,
): value is PrimaryCuisineType {
