...
declare global {
  namespace Astrology {
    ...
    interface TypeGuards {
      ...
      isZodiacSignType(sign: string): sign is ZodiacSignType;
    ...
    interface CompatibilityCalculator {
      ...
      calculateOverallCompatibility(
        state1: AstrologicalState,
        state2: AstrologicalState,
      ): number;
    }
...
export interface EnhancedIngredient {
  ...
  culinaryProperties: {
    ...
    flavorProfile: Array<
      "sweet" | "sour" | "salty" | "bitter" | "umami" | "spicy" | "astringent"
    >;
...
export type ZodiacSignType = Astrology.ZodiacSignType;
