...
import type { AlchemicalProperties, LunarPhase } from "./alchemy";
...
export interface Recipe {
  ...
  ingredientAlchemicalSummary?: IngredientAlchemicalSummary;
...
export const _validateRecipe = (recipe: Partial<Recipe>): boolean => {
 ...
 // Add this import
// ...
export const validateSeason = (season: string | Season): boolean => VALID_SEASONS.includes(season.toLowerCase() as Season);
