...
exports.validateRecipe =
  ...
  exports.normalizeElementalProperties =
    void 0;
...
var normalizeElementalProperties = function (properties) {
  const sum = Object.values(properties).reduce(function (acc, val) {
    return acc + val;
  }, 0);
  if (sum === 0) {
...
var validateIngredient = function (ingredient) {
  ...
  if (ingredient.seasonality) {
    ...
    const normalizedSeasons = ingredient.seasonality.map(function (s) {
      return s.toLowerCase();
    });
    const validSeasons_1 = seasonalConstants_1.VALID_SEASONS.map(function (s) {
      return s.toLowerCase();
    });
    if (
      !normalizedSeasons.every(function (s) {
        return validSeasons_1.includes(s);
      })
    ) {
      return false;
    }
...
var validateRecipe = function (recipe) {
  ...
  if (
    ...
    !(0, exports.validateElementalProperties)(recipe.elementalProperties)
  ) {
    return false;
  }
  ...
  if (recipe.season) {
    ...
    const normalizedSeasons = recipe.season.map(function (s) {
      return s.toLowerCase();
    });
    const validSeasons_2 = seasonalConstants_1.VALID_SEASONS.map(function (s) {
      return s.toLowerCase();
    });
    if (
      !normalizedSeasons.every(function (s) {
        return validSeasons_2.includes(s);
      })
    ) {
      return false;
    }
