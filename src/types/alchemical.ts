...
export type AlchemicalAction =
  | {
      ...
      payload: Partial<AlchemicalState>;
    }
  | { type: AlchemicalDispatchType.RESET_STATE }
  | {
      type: AlchemicalDispatchType.SET_ELEMENT;
  ...
  | {
      type: AlchemicalDispatchType.SET_SEASONAL_STATE;
      payload: { season: string };
    }
  | {
  ...
  | {
      type: AlchemicalDispatchType.SET_ELEMENTAL_STATE;
      payload: Record<string, number>;
    }
  | { type: AlchemicalDispatchType.SET_ZODIAC_ENERGY; payload: string }
  | { type: AlchemicalDispatchType.SET_LUNAR_ENERGY; payload: string }
  | {
      type: AlchemicalDispatchType.SET_PLANETARY_ENERGY;
      payload: string | string[];
    }
  | {
      type: AlchemicalDispatchType.SET_ASTROLOGICAL_STATE;
      payload: Partial<AstrologicalState>;
    }
  ...
  | {
      type: AlchemicalDispatchType.SET_ALCHEMICAL_VALUES;
      payload: Record<string, number>;
    }
