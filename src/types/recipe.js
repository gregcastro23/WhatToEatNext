import { validateElementalProperties as validateElementalPropertiesFromValidators, validateIngredient as validateIngredientFromValidators, validateRecipe as validateRecipeFromValidators } from "./validators.js";

// Validation utilities
export function validateElementalProperties(properties) {
    if (!properties)
        return false;
...
export function validateSeasonality(seasonality) {
...
export const validateElementalPropertiesExt = validateElementalPropertiesFromValidators;
export const validateIngredientExt = validateIngredientFromValidators;
export const validateRecipeExt = validateRecipeFromValidators;
