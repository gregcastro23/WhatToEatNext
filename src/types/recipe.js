...
const validateElementalProperties = function (properties) {
  ...
  if (
    !requiredElements.every(function (element) {
      return typeof properties[element] === 'number';
    })
  ) {
    return false;
  }
  const total = Object.values(properties).reduce(function (sum, val) {
    return sum + val;
  }, 0);
...
const validateSeasonality = function (seasonality) {
  ...
  return seasonality.every(function (season) {
    return (0, exports.validateSeason)(season);
  });
};
...
const validateIngredient = function (ingredient) {
  ...
  if (!(0, exports.validateElementalProperties)(ingredient.elementalProperties)) return false;
