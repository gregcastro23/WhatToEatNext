  ...
  async runPhase2UnusedVariables() {
    ...
    try {
      ...
      if (fs.existsSync(removerPath)) {
        ...
        execSync(`node ${removerPath} --auto-fix --max-files=${this.options.maxFiles}`, {
          stdio: 'inherit',
        });
      } else {
  ...
  async runPhase3TypeScriptErrors() {
    ...
    try {
      ...
      if (fs.existsSync(fixerPath)) {
        ...
        execSync(`node ${fixerPath} --max-files=${this.options.maxFiles} --auto-fix`, {
          stdio: 'inherit',
        });
      } else {
  ...
  async runPhase4ExplicitAnyElimination() {
    ...
    try {
      ...
      if (fs.existsSync(anyFixerPath)) {
        ...
        execSync(`node ${anyFixerPath} --max-files=${this.options.maxFiles} --auto-fix`, {
          stdio: 'inherit',
        });
      } else {
