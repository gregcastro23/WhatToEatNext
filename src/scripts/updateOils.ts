...
const COMMON_INGREDIENTS = [
  'olive oil', 'coconut oil', 'avocado oil', 'sesame oil', 'walnut oil', 
  'flaxseed oil', 'grapeseed oil', 'peanut oil'
];
...
const DEFAULT_ELEMENTAL_PROPERTIES = { Water: 0.1, Fire: 0.5, Air: 0.3, Earth: 0.1 };
