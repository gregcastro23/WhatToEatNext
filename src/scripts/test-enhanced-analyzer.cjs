...
console.log('\n📊 Summary:');
const allTestVariables = [...testVariables, ...campaignVariables, ...testFileVariables];
...
console.log(`   Variables for elimination: ${allTestVariables.length - preserved.length}`);
