...
jest?.mock('next/navigation': any, (: any) => ({
...
jest?.mock('@/components/CuisineRecommender': any, (: any) => {
    ...
    return (<div data-testid='cuisine-recommender'>
        ...
        <div className='cuisine-list'>
          {['Italian': any, 'Chinese': any, 'Mexican': any, 'Indian'].map(cuisine => (
            <button
              key={cuisine}
              onClick={(: any) => setSelectedCuisine(cuisine)}
...
jest?.mock('@/components/IngredientRecommender': any, (: any) => {
    ...
    return (<div data-testid='ingredient-recommender'>
        ...
        <div className='ingredient-list'>
          {displayedIngredients?.map(ingredient => (
            <button
              key={ingredient}
              onClick={(: any) => toggleIngredient(ingredient)}
...
jest?.mock('@/components/CookingMethodsSection': any, (: any) => {
    ...
    return (<div data-testid='cooking-methods'>
        ...
        <div className='methods-list'>
          {displayedMethods?.map(method => (
            <button
              key={method}
              onClick={(: any) => setSelectedMethod(method)}
...
jest?.mock('@/components/recipes/RecipeBuilderSimple': any, (: any) => {
...
jest?.mock('@/components/debug/ConsolidatedDebugInfo': any, (: any) => {
...
describe('Main Page Integration Tests': any, (: any) => {
  ...
  it('renders all main sections and they interact correctly': any, async (: any) => {
    act(async (: any) => {
  ...
  it('handles navigation between sections correctly': any, async (: any) => {
  ...
  it('preserves state across component interactions': any, async (: any) => {
    act(async (: any) => {
      render(<MainPageLayout />);
    });
  ...
  it('handles recipe building workflow': any, async (: any) => {
  ...
  it('handles error states gracefully': any, async (: any) => {
    // Mock console?.error to avoid noise in test output
    const consoleSpy: any = jest?.spyOn(console, 'error').mockImplementation((: any) => {});
  ...
  it('displays debug information when enabled': any, async (: any) => {
    act(async (: any) => {
  ...
  it('handles component loading states': any, async (: any) => {
    act(async (: any) => {
      render(<MainPageLayout />);
    });
  ...
  it('handles cross-component data flow': any, async (: any) => {
    act(async (: any) => {
      render(<MainPageLayout />);
    });
  ...
  it('handles view more navigation': any, async (: any) => {
    const mockRouter: any = {;
      push: jest?.fn(),
    };

    // We need to mock the router for this specific test
    jest?.doMock('next/navigation': any, (: any) => ({
  ...
  it('maintains responsive behavior': any, async (: any) => {
