...
jest.mock('@/components/IngredientRecommender', () => {
  return function MockIngredientRecommender({ maxDisplayed = 8  }: { maxDisplayed?: any }) {
...
describe('Main Page E2E Workflows', () => {
  ...
  const mockNavigationState = { saveState: jest.fn(), getState: jest.fn(() => ({ }));
  };

  const mockScrollPreservation: any = { restoreScrollPosition: jest.fn()};
