...
const cookingMethodsPath = 'src/app/test/migrated-components/cooking-methods-section/page.tsx';
...
const cuisineSectionPath = 'src/app/test/migrated-components/cuisine-section/page.tsx';
