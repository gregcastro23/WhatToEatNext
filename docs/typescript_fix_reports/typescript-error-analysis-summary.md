...
1. **src/**tests**/linting/DomainSpecificRuleValidation.test.ts**: 70 errors (TS18046)
...
4. **src/utils/**tests**/buildQualityMonitor.test.ts**: 56 errors (TS2339)
5. **src/services/campaign/unintentional-any-elimination/PilotCampaignAnalysis.ts**: 53 errors (TS2345)
6. **src/**tests**/linting/TestFileRuleValidation.test.ts**: 52 errors (TS18046)
7. **src/utils/**tests**/typescriptCampaignTrigger.test.ts**: 46 errors (TS2339)
8. **src/**tests**/linting/ESLintConfigurationValidation.test.ts**: 44 errors (TS18046)
9. **src/services/campaign/unintentional-any-elimination/**tests**/IntegrationWorkflows.test.ts**: 44 errors (TS18046)
...
- src/**tests**/linting/DomainSpecificRuleValidation.test.ts: 70 errors (dominant: TS18046)
...
- src/utils/**tests**/buildQualityMonitor.test.ts: 56 errors (dominant: TS2339)
- src/services/campaign/unintentional-any-elimination/PilotCampaignAnalysis.ts: 53 errors (dominant: TS2345)
- src/**tests**/linting/TestFileRuleValidation.test.ts: 52 errors (dominant: TS18046)
- src/utils/**tests**/typescriptCampaignTrigger.test.ts: 46 errors (dominant: TS2339)
- src/**tests**/linting/ESLintConfigurationValidation.test.ts: 44 errors (dominant: TS18046)
- src/services/campaign/unintentional-any-elimination/**tests**/IntegrationWorkflows.test.ts: 44 errors (dominant: TS18046)
...
_Generated by TypeScript Error Analysis Script_
