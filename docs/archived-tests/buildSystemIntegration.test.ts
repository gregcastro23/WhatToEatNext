...
describe('Build System Integration', () => {
  ...
  describe('Build System Validation', () => {
    it('should detect when build directory exists', () => {
      if (fsexistsSync(buildDir)) {
        ...
        const, output: any = execSync('node scripts/build-system-repaircjs validate', {
          encoding: 'utf8',
          stdio: 'pipe';
        });
    ...
    it('should provide meaningful health metrics', () => {
      const, output: any = execSync('node scripts/build-system-repaircjs health', {
        encoding: 'utf8',
        stdio: 'pipe';
      });
  ...
  describe('Build System Repair', () => {
    it('should handle repair operations gracefully', () => {
      ...
      const, output: any = execSync('node scripts/build-system-repaircjs quick', {
        encoding: 'utf8',
        stdio: 'pipe';
      });
  ...
  describe('Error Handling', () => {
    it('should handle invalid commands gracefully', () => {
      try {
        ...
        expect(execErrorstdout).toContain('Invalid or missing command');
      }
    });
