...
Remaining targets needing a genuine attempt: `lib/monitoring/prometheus-metrics.ts`, `menuPlanner/nutritionalCalculator.ts` (correctly deferred twice now, live-page-adjacent).
