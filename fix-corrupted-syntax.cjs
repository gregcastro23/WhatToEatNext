...
class CorruptedSyntaxFixer {
  ...
  async fixCorruptedSyntax(filePath) {
    try {
      ...
      const functionFixes = [
        ...
        {
          pattern:
            /static\s+\{\s*Fire:\s*0\.25,\s*Water:\s*0\.25,\s*Earth:\s*0\.25,\s*Air:\s*0\.25\s*\}:\s*ElementalProperties\s*\{/g,
          replacement:
        ...
        {
          pattern:
            /\(\s*\{\s*Fire:\s*0\.25,\s*Water:\s*0\.25,\s*Earth:\s*0\.25,\s*Air:\s*0\.25\s*\}\s*\)/g,
          replacement:
            "(defaultElements: ElementalProperties = { Fire: 0.25, Water: 0.25, Earth: 0.25, Air: 0.25 })",
        },

        // Fix corrupted return statements
        {
          pattern:
            /return\s+\{\s*Fire:\s*0\.25,\s*Water:\s*0\.25,\s*Earth:\s*0\.25,\s*Air:\s*0\.25\s*\};/g,
          replacement:
        ...
        {
          pattern:
            /=\s+\{\s*Fire:\s*0\.25,\s*Water:\s*0\.25,\s*Earth:\s*0\.25,\s*Air:\s*0\.25\s*\}/g,
        ...
        {
          pattern:
            /\(\(\) => \(\{\s*Fire:\s*0\.25,\s*Water:\s*0\.25,\s*Earth:\s*0\.25,\s*Air:\s*0\.25\s*\}\)\)\(/g,
          replacement:
  ...
  fixSpecificCorruptions(content) {
    ...
    fixed = fixed.replace(/static\s+\{\s*[^}]*\}\s*:\s*\w+\s*\{/g, (match) => {
